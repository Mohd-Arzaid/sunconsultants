      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            العاملة وضمان تلبية الطلب المحلي والدولي. المضخات ومصاعد السوائل ضرورية
            جداً لموارد المياه والزراعة والبناء والطاقة والصناعة والعديد من القطاعات
            الأخرى. المعدات المعطلة يمكن أن تعرض السلامة للخطر وتعطل العمليات وتخلق
            خسائر مالية إذا لم يتم إنتاجها وفقاً للمواصفات الصحيحة مع ضوابط الجودة
            الموجودة.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
            ...
            <li>تسرب وتآكل</li>
            <li>
              حوادث ناجمة عن مخاطر السلامة والخسائر الاقتصادية
            </li>
          </ul>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            لشهادة جودة وسلامة المنتجات. للسيطرة على التركيبات والآلات الحيوية، جعل
            BIS الحصول على شهادة المخطط X إلزامياً منذ 16 مارس 2022 بموجب لوائح
            تقييم المطابقة BIS، 2018.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              يضيف قوة قانونية لمنح استخدام علامة BIS للمضخات من قبل المصنعين كدليل
              على الشهادة.
            </li>
          </ul>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            أعلنت وزارة الصناعات الثقيلة OTR 2024، التي توجب أن جميع المضخات ومصاعد
            السوائل تلتزم بشهادة المخطط X.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
            ...
            <li>
              تمنح ميزة تنافسية مقارنة بالمنتجات غير المعتمدة.
            </li>
          </ul>
          ...
          {/* Conclusion Section */}
          <p className="text-gray-600 text-base font-geist mb-4">
            <span className="font-medium text-[#1e1e1e]">الخلاصة:</span>{" "}
            شهادة BIS المخطط X للمضخات ومصاعد السوائل مع OTR 2024 سيتم تطبيقها؛
            معلماً في توحيد معايير الصناعة الهندية.
          </p>
