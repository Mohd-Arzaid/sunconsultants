  ...
  return (
    <div className="relative w-full">
      <Helmet>
        ...
        <meta
          name="description"
          content="Sertifikasi BIS Skema X untuk pompa dan elevator cairan di bawah Peraturan Teknis Omnibus 2024 mewajibkan semua jenis pompa dan elevator cairan harus sesuai dengan Sertifikasi Skema X sebelum September 2026"
        />

        {/* Meta Keywords */}
        <meta
          name="keywords"
          content="Sertifikasi BIS untuk Pompa, Sertifikasi BIS Skema X untuk Pompa, Sertifikasi Skema X untuk Pompa, BIS untuk Pompa, Sertifikasi BIS untuk Pompa dan Elevator Cairan, OTR untuk Pompa"
        />
        <meta name="author" content="Sun Certifications India" />
        <meta
          name="publisher"
          content="Dhruv Aggarwal, Kepala Operasi di Sun Certification India"
        />
        ...
        <meta
          property="og:title"
          content="Sertifikasi BIS Skema X untuk Pompa dan Elevator Cairan di India | Panduan Lengkap"
        />
        <meta
          property="og:description"
          content="Pelajari semua tentang Sertifikasi BIS Skema X untuk Pompa dan Elevator Cairan di India. Memahami kepatuhan OTR 2024, proses Lisensi BIS, persyaratan tanda ISI dan cara mendapatkan sertifikasi sebelum tenggat waktu September 2026"
        />
        <meta
          property="og:url"
          content="https://bis-certifications.com/sertifikasi-bis-skema-x-untuk-pompa-dan-elevator-cairan"
        />
      ...
      <div className="relative ">
        <div className="w-full max-w-[768px] px-4 pb-12  pt-8 md:pt-16 md:pb-16 mx-auto">
          ...
          <div className="text-center mt-[16px] text-base md:text-[20px] leading-normal md:leading-[28px] font-geist text-[#52525b]">
            ...
            atau gunakan salah satu opsi di bawah ini. Kami biasanya merespons
            dalam 24 jam.
          </div>
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <div className="relative">
                  ...
                  <button className="flex items-center justify-center h-7 px-2 py-1.5 gap-x-1 text-[13px] md:text-[15px] whitespace-nowrap font-medium font-geist border rounded-full transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 absolute right-1 top-1 border-none bg-white">
                    <div className="text-[#2a5075]">Beritahu</div>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 my-4">
              <div className="flex items-center gap-3 p-3 bg-white/50 rounded-lg border border-[#1A8781]/10 hover:border-[#1A8781]/20 transition-colors duration-200">
                <p className="font-geist text-[14px] md:text-[18px] text-[#42434d]">
                  <span className="font-medium">Pengalaman:</span> 10+ tahun dan
                  1000+ proyek terkelola
                </p>
              </div>

              <div className="flex items-center gap-3 p-3 bg-white/50 rounded-lg border border-[#1A8781]/10 hover:border-[#1A8781]/20 transition-colors duration-200">
                <p className="font-geist text-[14px] md:text-[18px] text-[#42434d]">
                  Penerima penghargaan dari berbagai organisasi India dan
                  internasional
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                ...
                >
                  ...
                  <span className="font-geist text-[14px] md:text-[18px] text-[#42434d]">
                    <span className="font-medium">LinkedIn:</span> Hubungkan
                    dengan saya
                  </span>
                </a>
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          meluncurkan sertifikasi Scheme X, yang memerlukan setiap pompa dan
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          proses untuk mendapatkan Lisensi BIS untuk Pompa di bawah Scheme X
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          perolehan Sertifikasi Scheme X sejak 16 Maret 2022 di bawah Peraturan
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          memperoleh Lisensi BIS yang valid untuk Pompa di bawah Scheme X.
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          akses mudah ke pasar teratur India dengan mematuhi standar Scheme X.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          menerima lisensi untuk menerapkan merek BIS di bawah Scheme X.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          Sertifikasi BIS Scheme X untuk Pompa dan Elevator Cairan dengan OTR
...
const PumpsAndLiquidElevatorsPageMainContentRightIndonesian = () => {
  ...
  const currentPageName =
    "SchemeX Product - BIS Certification for Pumps & Liquid Elevators (Indonesian)";
    ...
    <div className="flex flex-col gap-6 w-full md:w-[360px] ">
      <div className="w-full md:w-[360px] md:sticky md:top-[128px] md:self-start  p-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="mt-3 text-sm text-gray-600 font-geist">
          Tinggalkan detail Anda di bawah ini dan ahli kami akan menghubungi
          Anda kembali dalam 24 jam untuk membahas kebutuhan kepatuhan peraturan
          Anda.
        </p>
