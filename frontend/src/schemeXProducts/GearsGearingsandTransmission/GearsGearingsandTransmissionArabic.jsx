...
const GearsGearingsandTransmissionMetaTags = () => {
  const title = "شهادة BIS المخطط X للتروس وأنظمة التروس وعناصر النقل";
  const description =
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          يجب على جميع المصنعين، المحليين والأجانب، تلبية متطلبات شهادة المخطط X
          بحلول 1 سبتمبر 2026 وفقاً لما حدده الأمر وأنشأته وزارة الصناعات
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>فشل التروس مما يؤدي إلى التلف وتوقف مكلف</li>
          <li>مخاطر صحية في النقل والصناعات الثقيلة</li>
          <li>نقل الطاقة وتشتت الطاقة غير فعال</li>
          <li>إمكانية وصول محدودة للمناقصات العامة وفرص المشتريات</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>يحق استخدام علامة معيار BIS بعد اعتماد المنتج</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            السلامة والموثوقية: تجنب الفشل غير المراقب من تطبيقات الأنظمة
            الحيوية.
          </li>
          <li>
          ...
          <li>
            الامتثال القانوني: لا توجد عقوبات مع OTR للتروس وأنظمة التروس وأجزاء
            النقل.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          ...
          <li>
            تدقيق المصنع: يأتي BIS لإجراء تدقيق مراقبة الجودة في موقع الإنتاج.
          </li>
          <li>
            تقديم الوثائق: شارك التفاصيل الفنية ووثائق الاختبار ودليل الجودة.
          </li>
          <li>
            منح الترخيص: بعد فحص BIS للوثائق للتأكد من الدقة، يمنح الشهادة ويسمح
            باستخدام علامة المعيار.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>حظر بيع وتصنيع العناصر غير المعتمدة</li>
