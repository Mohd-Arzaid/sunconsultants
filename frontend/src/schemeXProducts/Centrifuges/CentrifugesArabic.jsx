    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          والتعدين. تعمل هذه الآلات بالدوران، والدوران السريع يفصل الخلائط، وهذا
          الفصل ضروري للمعالجة الدقيقة والآمنة والسريعة.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          في هذا المنشور، سنناقش ما هي شهادة BIS المخطط X لأجهزة الطرد المركزي،
          ما هو OTR لأجهزة الطرد المركزي، وكيفية الحصول على ترخيص BIS لأجهزة
          الطرد المركزي مع علامة BIS الرسمية لأجهزة الطرد المركزي.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          عدم وجود BIS لأجهزة الطرد المركزي يمكن أن يؤدي إلى استخدام أجهزة طرد
          مركزي منخفضة الجودة أو غير معتمدة والتي يمكن أن تؤدي إلى:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          أجهزة الطرد المركزي المعتمدة من BIS مع علامة BIS لأجهزة الطرد المركزي
          تعني السلامة والجودة والثقة.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>اختبار المنتج الكافي والتدقيق والتحقق من الامتثال أمر ضروري</li>
          <li>
            يسمح للمصنعين بالتقدم بطلب للحصول على تسجيل BIS بناءً على الشهادة
            لأجهزة الطرد المركزي المذكورة أعلاه.
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          تم الإعلان عن OTR لأجهزة الطرد المركزي من قبل وزارة الصناعات الثقيلة
          في عام 2024، والتي تتطلب شهادة المخطط X.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          الموعد النهائي: يُطلب من جميع المصنعين والمستوردين الحصول على ترخيص
          BIS صالح لأجهزة الطرد المركزي بموجب المخطط X بحلول 1 سبتمبر 2026.
          "سيؤدي هذا إلى منع أجهزة الطرد المركزي غير المعتمدة من البيع أو
          الاستيراد أو المشاركة في المناقصات في جميع أنحاء البلاد"، حسب قول
          مسؤول حكومي.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            ثقة المستهلك: علامة BIS لأجهزة الطرد المركزي تخبر العملاء عن جودة
            المنتج ومتانته.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          الهندية المناسبة (رمز IS) للجودة والسلامة وكفاءة الطاقة.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            تحديد المعيار ذي الصلة: الرجوع إلى رمز IS ذي الصلة لنوع جهاز الطرد
            المركزي الخاص بك.
          </li>
          <li>
          ...
          <li>
            الامتثال المستمر: تقوم BIS بالتفتيش وإجراء عمليات تدقيق غير مجدولة
            للامتثال للمعايير.
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          الشركات المصنعة التي ليس لديها جميع طرازات أجهزة الطرد المركزي معتمدة
          بشهادة BIS لأجهزة الطرد المركزي بحلول 1 سبتمبر 2026 تواجه مخاطر:
        </p>

        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>حظر البيع/الاستيراد لأجهزة الطرد المركزي غير المعتمدة</li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          تطبيق شهادة BIS المخطط X لأجهزة الطرد المركزي في OTR 2024 هو خطوة لجلب
          السلامة والكفاءة والجودة إلى قطاع الصناعة والمختبرات في الهند.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          الطرد المركزي، ووضع علامة BIS لأجهزة الطرد المركزي على منتجاتهم، مما
          يظهر أن منتجاتهم تلبي نظام التنظيم في السوق المحلي ومتطلبات العملاء.
        </p>
