    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Centrifuges zijn vitale machines die veel worden gebruikt in
          laboratorium-, farmaceutische, voedselverwerkings-, biotechnologie-,
          petrochemische en mijnbouwindustrieën. Deze machines werken door
          rotatie, en snelle rotatie scheidt mengsels, deze scheiding is
          cruciaal voor juiste, veilige en snelle verwerking.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          Met bredere toepassingen in verschillende industrieën is het
          essentieel om de betrouwbaarheid en veiligheid van centrifuges te
          verbeteren. Om kwaliteitscontroleparameters voor centrifuges te
          handhaven, heeft BIS een BIS Certificeringsschema geïntroduceerd dat
          bekend staat als Schema X Certificering voor Centrifuges.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          In dit bericht zullen we bespreken wat BIS Schema X Certificering voor
          Centrifuges is, wat OTR voor Centrifuges is, en hoe u een BIS Licentie
          voor Centrifuges kunt verkrijgen met het officiële BIS-merk voor
          Centrifuges.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          lage kwaliteit of niet-gecertificeerde Centrifuges die kunnen
          resulteren in:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          BIS-gecertificeerde Centrifuges met het BIS-merk voor Centrifuges
          impliceren veiligheid, kwaliteit en vertrouwen.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          certificeringsschema onder de BIS Conformiteitsbeoordelingsregeling,
          2018.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            Van toepassing op alle soorten centrifuges die worden aangetroffen
            in industriële en R&D-laboratoria
          </li>
          <li>
          ...
          <li>
            Stelt fabrikanten in staat om BIS-registratie aan te vragen op basis
            van certificering voor de bovengenoemde Centrifuges.
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          Deadline: Alle fabrikanten en importeurs zijn verplicht om een geldige
          BIS Centrifuges Licentie onder Schema X te verkrijgen op 1 september
          2026. "Dit zal niet-gecertificeerde centrifuges stoppen van verkoop,
          import of deelname aan aanbestedingen in het hele land," zei een
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Veiligheid & Naleving: Voorkomt ongevallen door mechanische schade
            bij hoge snelheden.
          </li>
          <li>
            Kwaliteit & Betrouwbaarheid: Gecertificeerde Centrifuges presteren
            met hoge nauwkeurigheid en precisie.
          </li>
          <li>
          ...
          <li>
            Consumentenvertrouwen: Het BIS-merk voor Centrifuges informeert
            klanten over productkwaliteit en duurzaamheid.
          </li>
          <li>
            Concurrentievoordeel: Gecertificeerde BIS-merken/fabrikanten worden
            de voorkeur gegeven in gereguleerde markten en voor
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Schema X-accreditatie voor Centrifuges omvat verschillende soorten
          zoals:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          Algemene Principes voor Ontwerp - Risicobeoordeling en
          Risicovermindering). Alle variëteiten moeten voldoen aan de relevante
          Indiase Normen (IS-code) voor kwaliteit, veiligheid en
          energie-efficiëntie.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Identificatie van Relevante Normen: Verwijzen naar de relevante
            IS-code voor uw type Centrifuge.
          </li>
          <li>
            Producttests: Uitvoeren van vereiste prestatietests en
            veiligheidstests volgens industriestandaarden, in
            BIS-geaccrediteerde laboratoria.
          </li>
          <li>
          ...
          <li>
            Continue Naleving: BIS controleert en voert onaangekondigde audits
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Fabrikanten die niet alle centrifuge-modellen hebben gecertificeerd
          met BIS Certificering voor Centrifuges op 1 september 2026 lopen het
          risico:
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          ...
          <li>
            Inbeslagname van niet-conforme apparatuur en monetaire sancties
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Implementatie van BIS Schema X Certificering voor Centrifuges in OTR
          2024 is een stap om veiligheid, efficiëntie en kwaliteit te brengen in
          de industriële en laboratoriumsector in India.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Fabrikanten, Importeurs en Exporteurs profiteren van dit proces door
          BIS Certificering voor Centrifuges te verkrijgen, door BIS Licentie
          voor Centrifuges te verkrijgen, en door het BIS-merk voor Centrifuges
          op hun producten te plaatsen, wat aantoont dat hun producten voldoen
          aan lokale marktreguleringssystemen en klantvereisten.
        </p>
