import {
  ...
  const MachineToolsMetaTags = () => {
    ...
    const ogTitle =
      "شهادة BIS المخطط X لأدوات الآلات في الهند | دليل كامل";
    const ogDescription =
      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            والخرسانة وأسمنت الأسبستوس والزجاج المعدني المماثل وأدوات الآلات الأخرى.
            الامتثال للشهادة لا يلبي فقط متطلبات السلامة الوطنية، بل يزيد بشكل
            كبير من مصداقية وقدرة تسويق المنتج.
          </p>
  
          {/* Introduction Paragraph 2 */}
          <p className="text-gray-600 text-base font-geist mb-4">
            شهادة المخطط X هذه هي متطلب بموجب سلامة الآلات والمعدات الكهربائية (أمر
            اللائحة الفنية الشاملة، 2024). هذه اللائحة تشهد أن مصنعي الآلات والمعدات
            الكهربائية يجب أن يكون لديهم علامة معيار على معداتهم. الشهادة تشمل إعداد
            الملفات الفنية وتدقيق المصنع وفحص المنتج المستقل والترخيص، والموعد النهائي
            هو 1 سبتمبر 2026.
          </p>
  
          {/* Introduction Paragraph 3 */}
          <p className="text-gray-600 text-base font-geist mb-6">
            تغطي هذه المدونة جميع المعلومات المطلوبة المتعلقة بشهادة المخطط X لجميع
            أنواع أدوات الآلات لمعالجة الحجر والسيراميك والخرسانة وأسمنت الأسبستوس
            أو المعادن المماثلة (أو) وتجميعاتها/التجميعات الفرعية/مكوناتها، أهميتها،
            نطاقها، عملية الشهادة، المزايا، والوثائق المطلوبة.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            والخرسانة وأسمنت الأسبستوس أو المعادن المماثلة (أو) وتجميعاتها/التجميعات
            الفرعية/مكوناتها.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            أصدرت وزارة الصناعات الثقيلة أمر اللائحة الفنية الشاملة (OTR) الذي يجعل
            شهادة BIS المخطط X إلزامية لأدوات الآلات.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>
              ضمان الجودة: دقة مُتحقق منها، متانة الأدوات المعتمدة.
            </li>
            <li>
              الوصول إلى السوق – مهم للدخول إلى أعمال القطاع العام والخاص.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            ...
            <li>
              اختبار المنتج – اختبار الأداء والسلامة والمتانة في مختبر معتمد من BIS.
            </li>
            <li>
              تدقيق المصنع – تدقيق مراقبة جودة إنتاج المعدات الكهربائية.
            </li>
            <li>
              الوثائق: يجب توفير التقارير الفنية والدليل وإثبات الامتثال.
            </li>
            <li>
              منح الترخيص – BIS يمنح الترخيص (الشهادة) ويسمح باستخدام علامة المعيار.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
            <li>
              حظر إنتاج واستيراد وتجارة السلع غير المعتمدة
            </li>
