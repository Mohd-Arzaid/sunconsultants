        ...
        <div className="w-fit font-inter">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>열처리 장비용 BIS 인증</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          가장 중요한 응용 분야 중 하나입니다. 이들은 풀림, 담금질, 경화, 템퍼링
          등의 작업을 통해 금속의 물리적 및 기계적 특성을 변경하는 장치입니다.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          장비용 OTR 및 열처리 장비용 BIS 마크가 포함된 열처리 장비용 BIS
          라이센스 취득 절차를 설명합니다.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          Scheme X - 열처리 장비는 인도 정부 철강부와 일치하며, 인도의 BIS
          적합성 평가 규정 2018에 따른 필수 인증 제도입니다.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>대부분의 유형의 열처리 및 가열 장비에 사용 가능</li>
          <li>제품 테스트, 공장 현장 점검 및 지속적인 준수 감사 포함</li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          중공업부는 2024년 열처리 장비용 종합 기술 규정(OTR)을 도입했으며, 이에
          따라 Scheme X 준수가 필수화되었습니다.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          마감일: 모든 생산자 및 수입업체는 2026년 9월 1일까지 열처리 장비용
          유효한 BIS 라이센스를 취득해야 합니다. 이 날짜 이후에는 비인증 열처리
          장비가 판매, 수입 또는 공공 입찰에 참여할 자격이 없습니다.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>운영 안전성: 과열, 불균등한 처리 및 장비 고장으로부터 보호</li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          코드)을 준수해야 합니다. 성능 특성, 재료 등급 및 에너지 절약 기능은 각
          장비 유형에 대한 관련 인도 표준(IS 코드)을 준수해야 합니다.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            BIS 인정 실험실에서 테스트: 성능, 안전성 및 효율성 테스트를
            수행합니다.
          </li>
          <li>공장 검사: BIS가 품질 관리 시스템 및 생산 시설을 검사합니다.</li>
          <li>
            신청 및 문서화: 결과, 수행된 테스트, 기술 사양 및 품질 매뉴얼을
            제공합니다.
          </li>
          <li>
            BIS 라이센스 발급: 승인으로 열처리 장비용 BIS 마크 사용이
            가능해집니다.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          표준 마크를 사용하는 프로세스는 단순히 준수에 관한 것이 아니라, 안전한
          제품과 이해할 수 있는 신뢰할 수 있는 제품을 확립하는 것이며, 규제된
          시장 하에서 시장에서 경쟁력 있는 제품 사고를 얻는 것입니다.
        </p>
