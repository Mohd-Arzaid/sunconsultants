    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>يمكن استخدامه على معظم أنواع معدات المعالجة الحرارية والأفران</li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          BIS صالح لمعدات المعالجة الحرارية بحلول 1 سبتمبر 2026. بعد هذا
          التاريخ، معدات المعالجة الحرارية غير المعتمدة لن تكون مؤهلة للبيع أو
          الاستيراد أو تقديم العطاءات في المناقصات العامة.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          الطاقة يجب أن تتوافق مع المعايير الهندية ذات الصلة (رمز IS) لكل نوع من
          المعدات.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            تحديد المعيار ذي الصلة: الرجوع إلى رمز IS ذي الصلة لنوع معدات
            المعالجة الحرارية الخاصة بك.
          </li>
          <li>
            الاختبار في مختبر معترف به من BIS: إجراء اختبارات الأداء والسلامة
            والكفاءة.
          </li>
          <li>تفتيش المصنع: يفحص BIS نظام مراقبة الجودة ومرافق الإنتاج.</li>
          <li>
          ...
          <li>
            الامتثال المستمر: يتم إجراء التدقيق والتفتيش بانتظام للحفاظ على
            معايير الجودة.
          </li>
        </ul>
