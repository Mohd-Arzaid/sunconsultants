    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Warmtebehandelingsapparatuur is een van de meest kritieke toepassingen
          in industrieën zoals automotive, luchtvaart, gieten, smeden en zware
          engineering. Dit zijn apparaten die de fysieke en mechanische
          eigenschappen van metalen veranderen door bewerkingen zoals gloeien,
          koelen, harden, temperen, enz.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          Gezien het belang heeft het Bureau of Indian Standards (BIS) BIS
          Certificering voor Warmtebehandelingsapparatuur verplicht gesteld
          onder Schema X Certificering. Dit zorgt ervoor dat zowel Indiase als
          wereldwijde fabrikanten voldoen aan strikte Indiase normen voordat ze
          apparatuur op de markt brengen in het land.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          In dit bericht zullen we het belang uitleggen van BIS Schema X
          Certificering voor Warmtebehandelingsapparatuur, OTR voor
          Warmtebehandelingsapparatuur en het proces om een BIS Licentie te
          verkrijgen voor Warmtebehandelingsapparatuur met het BIS Merk voor
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          BIS Certificering garandeert niet alleen dat apparatuur goed en veilig
          functioneert volgens industriële prestatie-eisen, maar ook voldoet aan
          milieucriteria.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          Schema X - Warmtebehandelingsapparatuur, in overeenstemming met het
          Ministerie van Staal, Regering van India, is een verplicht
          certificeringsschema onder de BIS India
          Conformiteitsbeoordelingsregeling, 2018.
        </p>

        <h3 className="text-lg font-geist font-medium text-[#1e1e1e] mb-3">
          Schema X Certificering voor Warmtebehandelingsapparatuur:
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            Toepasbaar op de meeste soorten warmtebehandelingsapparatuur en
            verbrandingsapparatuur
          </li>
          <li>
            Omvat producttesten, fabrieksvloerinspectie en audit voor
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Het Ministerie van Zware Industrie heeft in 2024 de Omnibus Technische
          Regeling (OTR) voor Warmtebehandelingsapparatuur uitgegeven, waarbij
          naleving van Schema X verplicht is.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Deadline: Alle fabrikanten en importeurs moeten een geldige BIS
          Licentie verkrijgen voor Warmtebehandelingsapparatuur op 1 september
          2026. Na deze datum zal niet-gecertificeerde
          Warmtebehandelingsapparatuur niet in aanmerking komen voor verkoop,
          import of het indienen van offertes in openbare aanbestedingen.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Operationele Veiligheid: Beschermt tegen oververhitting, ongelijke
            behandeling en apparatuurschade.
          </li>
          <li>
            Productbetrouwbaarheid: Zorgt ervoor dat behandelde items voldoen
            aan specificaties voor hardheid, duurzaamheid en taaiheid
          </li>
          <li>
            Energie-efficiëntie: Gecertificeerde apparatuur wordt getest op
            optimaal energieverbruik, wat de operationele kosten verlaagt.
          </li>
          <li>
          ...
          <li>
            Wereldwijde Voordelen: Wereldwijde merken kunnen gemakkelijk toegang
            krijgen tot de Indiase markt door een BIS Licentie te verkrijgen
            voor Warmtebehandelingsapparatuur.
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          BIS Schema X Certificering voor Warmtebehandelingsapparatuur omvat een
          groot aantal machines zoals:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          Elk type moet voldoen aan relevante Indiase Normen (IS-code) zoals IS
          16819:2018/ISO 12100:2010. Prestatiekenmerken, materiaalkwaliteit en
          energiebesparingsfuncties moeten voldoen aan relevante Indiase Normen
          (IS-code) voor elk type apparatuur.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Identificeer Relevante Normen: Raadpleeg de relevante IS-code voor
            uw type Warmtebehandelingsapparatuur.
          </li>
          <li>
          ...
          <li>
            Fabrieksinspectie: BIS controleert kwaliteitscontrolesystemen en
            productiefaciliteiten.
          </li>
          <li>
            Aanvraag & Documentatie: Verstrek resultaten, uitgevoerde testen, en
            technische specificaties en kwaliteitshandboeken.
          </li>
          <li>
            Uitgifte van BIS Licentie voor Warmtebehandelingsapparatuur:
            Goedkeuring staat gebruik toe van het BIS Merk voor
            Warmtebehandelingsapparatuur.
          </li>
          <li>
            Voortdurende Naleving: Regelmatige audits en inspecties worden
            uitgevoerd om kwaliteitsnormen te handhaven.
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Als OTR Warmtebehandelingsapparatuur niet wordt nageleefd op 1
          september 2026:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          De verplichte implementatie van Schema X Certificering voor
          Warmtebehandelingsapparatuur onder OTR 2024 is een belangrijke
          mijlpaal in het verhogen van de normen van de Indiase industrie.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Voor fabrikanten, importeurs en exporteurs van
          Warmtebehandelingsapparatuur, is het proces om BIS Certificering te
          verkrijgen voor Warmtebehandelingsapparatuur, om een BIS Licentie voor
          Warmtebehandelingsapparatuur te verkrijgen en het BIS Standaardmerk
          voor Warmtebehandelingsapparatuur te gebruiken niet alleen over
          naleving, het gaat om het bouwen van veilige en betrouwbare producten
          die concurrerend zijn op de markt en toegang krijgen tot gereguleerde
          markten.
        </p>
