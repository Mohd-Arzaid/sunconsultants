import {
  ...
  const CompressorsMetaTags = () => {
    ...
    const ogTitle =
      "شهادة BIS المخطط X للضاغطات في الهند | دليل كامل";
    const ogDescription =
      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            الضاغطات هي معدات مهمة في مختلف الصناعات مثل التبريد، التدفئة
            والتهوية وتكييف الهواء، البتروكيماويات، التصنيع، معالجة الأغذية
            وتطبيقات الأدوية. الصناعة الهندية سريعة النمو تتطور بسرعة وجودة
            وسلامة الضاغطات أصبحت مصدر قلق رئيسي.
          </p>
  
          {/* Introduction Paragraph 2 */}
          <p className="text-gray-600 text-base font-geist mb-4">
            لضمان نفس الشيء، نفذ مكتب المعايير الهندية (BIS) شهادة BIS للضاغطات
            بموجب شهادة المخطط X. تضمن هذه الشهادة أن كل ضاغط يتم إدخاله إلى
            أراضي الهند يلتزم بمعايير السلامة والأداء والكفاءة المحددة.
          </p>
  
          {/* Introduction Paragraph 3 */}
          <p className="text-gray-600 text-base font-geist mb-6">
            في هذا الدليل، نقدم شهادة BIS المخطط X للضاغطات و OTR للضاغطات،
            وكذلك كيفية حصول المصنعين على ترخيص BIS للضاغطات لاستخدام علامة BIS
            للضاغطات في الهند.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
            ...
            <li>
              إنتاج طاقة مهدر مقابل فواتير مرافق طاقة عالية
            </li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              يعرض اختبار الطرف الثالث، تفتيش المصنع وفحص الامتثال الدوري
            </li>
            <li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            أمر اللائحة الفنية الشاملة (OTR) للضاغطات الذي أصدرته وزارة
            الصناعات الثقيلة في عام 2024 يتطلب شهادة المخطط X للضاغطات.
          </p>
  
          <p className="text-gray-600 text-base font-geist mb-6">
            الموعد النهائي للامتثال: بحلول 1 سبتمبر 2026، يُطلب من جميع
            المصنعين والمستوردين الحصول على ترخيص BIS صالح للضاغطات بموجب المخطط
            X. أي عدم امتثال سيؤدي إلى حظر كامل على بيع واستيراد الضاغطات غير
            المعتمدة في الهند.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            تقنيات الضاغطات المختلفة يجب أن تتوافق مع المعايير الهندية الخاصة
            بكل منها، والتي تحدد متطلبات الأداء واستهلاك الطاقة وجودة المواد
            والسلامة.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>
              تحديد المعيار المعمول به: ابحث عن رمز IS المناسب لضاغطك.
            </li>
            <li>
            ...
            <li>
              إصدار ترخيص BIS للضاغطات: عند القبول، يُمنح المصنعون الحق في
              استخدام علامة BIS للضاغطات.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
            <li>
              البيع/الاستيراد للضاغطات غير المختبرة غير مسموح
            </li>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            المصنعون والمستوردون والمصدرون الذين يمرون بعملية الحصول على شهادة
            BIS للضاغطات، وتأمين شهادة BIS للضاغطات يحصلون على الحق في أن يكونوا
            جزءاً من هذا السوق من خلال ضمان أن المنتجات التي يقدمونها للمستهلكين
            الهنود تعتبر آمنة للاستخدام ولديها مخاطر بيئية أقل وجودة جيدة.
          </p>
