      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <div className="mb-6">
          <img
            ...
            alt="BIS Scheme X Certification For Metal Cutting Machine Tools"
            title="BIS Scheme X license metal cutting machines tools"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Metal cutting is the workhorse fabricating technology underpinning
          India&apos;s engine, Automotive, aerospace and manufacturing
          industries. These machines are from CNC lathes and milling machines to
          laser cutters and will also help keep production high and costs low in
          industries all over. As demand for fine quality machinery has
          increased in India the government has made BIS Certification of Metal
          Cutting Machine compulsory to ensure quality and safety.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          As per the BIS (Bureau of Indian Standard) Scheme X Certification for
          Metal Cutting Machines, both foreign and Indian manufacturers must
          meet Indian Standards before they can be sold in the Indian market.
          This is a way for the machine to be put into use safely, as well as
          ensures customer confidence.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          This post provides information regarding the scheme X certification
          for Metal Cutting Machines, the 2024 OTR for Metal Cutting Machines
          requirement, and the procedure of acquiring a BIS License for Metal
          Cutting Machines in order to affix the BIS mark for Metal Cutting
          Machines.
        </p>
