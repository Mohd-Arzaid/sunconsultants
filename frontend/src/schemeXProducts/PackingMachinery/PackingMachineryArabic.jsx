import {
  ...
  const PackingMachineryMetaTags = () => {
    const title =
      "شهادة BIS المخطط X لآلات التعبئة والتغليف وتجميعاتها";
    const description =
      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            في هذه المقالة، سنشرح أهمية شهادة المخطط X لآلات التعبئة والتغليف،
            دور OTR لآلات التعبئة والتغليف وعملية الحصول على ترخيص BIS وعلامة معيار
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            علامة BIS على آلات التعبئة والتغليف تضمن للمشترين الجودة والسلامة
            وطول العمر.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            تقييم المطابقة BIS 2018 والامتثال لهذا إلزامي للمصنعين الهنود والأجانب.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>
              مناسب لأي آلة تعبئة وتغليف (يدوية، شبه آلية وآلية)
            </li>
            <li>
              يتطلب اختبار المنتج ومدقق للمصنع ومراقبة الجودة
            </li>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            الموعد النهائي: يجب أن تكون جميع آلات التعبئة والتغليف مزودة بشهادة BIS
            المخطط X ويجب أن تحصل جميع آلات التعبئة والتغليف على ترخيص BIS لآلات
            التعبئة والتغليف بحلول 1 سبتمبر 2026. "سيوقف هذا آلات التعبئة والتغليف
            غير المعتمدة من البيع أو الاستيراد أو المشاركة في المناقصات في جميع أنحاء
            البلاد،" كما قال مسؤول حكومي.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              ضمان الجودة: يحافظ على عمل الآلات بسلاسة وكفاءة.
            </li>
            <li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            ذات الصلة (رمز IS) بما في ذلك IS 16819:2018/ISO 12100:2010 (سلامة الآلات
            المبادئ العامة للتصميم - تقييم المخاطر وتقليل المخاطر).
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            المصنعون الذين لا يملكون جميع نماذج آلات التعبئة والتغليف المعتمدة بشهادة
            BIS لآلات التعبئة والتغليف بحلول 1 سبتمبر 2026 يواجهون مخاطر:
          </p>
  
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
            <li>
              حظر البيع/الاستيراد لآلات التعبئة والتغليف غير المعتمدة
            </li>
