  ...
  return (
    <div className="relative w-full">
      <Helmet>
        ...
        <meta
          property="og:url"
          content="https://bis-certifications.com/certification-bis-schema-x-pour-appareillage-et-commande-jusqu-a-1000-volts"
        />
        ...
        <link
          rel="canonical"
          href="https://bis-certifications.com/certification-bis-schema-x-pour-appareillage-et-commande-jusqu-a-1000-volts"
        />
      </Helmet>
