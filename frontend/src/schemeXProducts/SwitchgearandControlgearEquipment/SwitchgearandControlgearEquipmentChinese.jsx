...
const SwitchgearandControlgearEquipmentMetaTags = () => {
  const title = "BIS方案X认证适用于高达1000伏的开关和控制设备";
  const description =
  ...
  const ogTitle = "印度高达1000伏的开关和控制设备BIS方案X认证 | 完整指南";
  const ogDescription =
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          重工业部根据2024年综合技术法规，已对2026年9月1日起在印度销售、进口和生产的所有开关和控制设备（≤
          1000V）实施强制性BIS认证。为了解决不合规和不安全的电气设备，并提高市场上提供的产品标准，BIS根据方案X认证，已对这些在1000伏或以下运行的设备制定了强制性认证。
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>需要在BIS认可的设施进行实验室测试</li>
          <li>包括生产系统和质量审核</li>
          <li>认证后授予在产品上使用标准标志的权利</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>电气安全：保护免受短路、过载和潜在火灾危险。</li>
          <li>法规合规：开关和控制设备OTR的强制性要求。</li>
          <li>市场接受度：注册产品可被所有政府和私人项目接受。</li>
          <li>
            客户信任：开关和控制设备上的BIS标准标志为客户提供质量和安全保障。
          </li>
          <li>竞争优势：提升品牌声誉并为新业务打开大门。</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          ...
          <li>产品测试：在BIS认可的实验室进行安全、性能和耐用性测试。</li>
          <li>工厂审核：BIS检查员验证工厂和质量控制系统。</li>
          <li>提交文件：所有详细规格、测试报告和合规支持文件。</li>
          <li>颁发BIS许可证：如果获得批准，BIS颁发使用标准标志的许可证。</li>
          <li>持续合规：定期对标准进行审核和产品测试，确保认证保持有效。</li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          在OTR
          2024中实施开关和控制设备BIS方案X认证是确保印度安全、可靠和高效电力管理的一步。
        </p>
