      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            Dieselgeneratoren worden gebruikt op commerciële, industriële, ziekenhuis-,
            infrastructuurprojecten, woningbouwprojecten en op vele andere plaatsen
            als secundaire stroombron. Als economische activa met de verantwoordelijkheid
            om continuïteit van stroomvoorziening te garanderen, is het belangrijk dat
            machines veilig, efficiënt en voldoen aan nationale normen.
          </p>
  
          {/* Introduction Paragraph 2 */}
          <p className="text-gray-600 text-base font-geist mb-4">
            In een poging om dit te doen, valt BIS Certificering voor Dieselgeneratoren
            onder Schema X Certificering van het Bureau of Indian Standards (BIS).
            Dit schema is ingevoerd om ervoor te zorgen dat zowel nationale als
            wereldwijde fabrikanten voldoen aan strikte en strenge Indiase Normen
            voordat ze hun producten in India verkopen.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            Dieselgeneratoren kunnen eenvoudig voldoen aan Schema X certificering die
            fabrikanten in staat stelt om veilige, betrouwbare en milieuvriendelijke
            producten te verkopen voor gebruik in India.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>Alle fabrikanten - Indiaas of buitenlands - Verplichte vereiste</li>
            <li>
              Van toepassing op alle soorten dieselgeneratoren met verschillende
              capaciteiten
            </li>
            <li>
              Omvat producttests in door BIS geautoriseerde laboratoria
            </li>
            <li>
              Fabrieksaudit, Werkplaatsbezoeken en Productieprocesinspecties,
              om onafhankelijk fabrieksinspecties op locatie uit te voeren om
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            Het Ministerie van Zware Industrie heeft een kennisgeving uitgegeven voor
            OTR voor Dieselgeneratoren in 2024.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            productie, verkoop of import van niet-gecertificeerde dieselgeneratoren
            worden verboden in India.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              Markttoegang: OTR voor Dieselgeneratoren - Verplichte certificering om
              te verkopen in India
            </li>
            <li>
              Klantvertrouwen: Het BIS Standaardmerk zorgt voor hoge betrouwbaarheid
              en veiligheid.
            </li>
            <li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
            ...
            <li>
              Geluidsarme Dieselgeneratorsets voor Commercieel (Stedelijke Toepassingen
              en Gebruik)
            </li>
          </ul>
  
          <p className="text-gray-600 text-base font-geist mb-6">
            Elk subtype moet voldoen aan de van toepassing zijnde Indiase Normen (IS-code)
            zoals IS 16819:2018 / ISO 12100:2010 (Machineveiligheid Algemene Principes
            Ontwerp - Risicobeoordeling & Risicovermindering). Elk type moet voldoen aan
            zijn eigen Indiase Normen.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            ...
            <li>
              Fabrieksaudit: BIS-functionarissen controleren productiekwaliteitscontroleprocessen.
            </li>
            <li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            Het niet naleven van BIS Certificering voor Dieselgeneratoren van OTR voor
            Dieselgeneratoren kan resulteren in:
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            BIS Schema X Certificering voor Dieselgeneratoren in overeenstemming met
            OTR voor Dieselgeneratoren (2024) is een belangrijke mijlpaal in de reis
            naar verbetering van productveiligheid, betrouwbaarheid en efficiëntie
            in de Indiase back-up stroomindustrie.
          </p>
  
          <p className="text-gray-600 text-base font-geist mb-6">
            Voor fabrikanten/importeurs is Schema X certificering voor Dieselgeneratoren
            niet alleen een juridische vereiste, maar ook een concurrentievoordeel dat
            geloofwaardigheid, naleving en marktvertrouwen weerspiegelt.
          </p>
