...
const DieselGeneratorMetaTags = () => {
  ...
  const canonicalUrl =
    "https://bis-certifications.com/shahadat-bis-mukhatat-x-lil-mawalid-al-dizil";
  const author = "Sun Certifications India";
  const publisher =
    "Dhruv Aggarwal, Head of Operations at Sun Certification India";
  const ogTitle = "شهادة BIS المخطط X لمولدات الديزل في الهند | دليل كامل";
  const ogDescription =
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          ومشاريع البنية التحتية ومشاريع الإسكان وفي أماكن أخرى كثيرة كمصدر طاقة
          ثانوي. كأصل اقتصادي مع مسؤولية ضمان استمرارية إمدادات الكهرباء، من
          المهم أن تكون الآلات آمنة وفعالة وتلبي المعايير الوطنية.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          في محاولة للقيام بذلك، تم تضمين شهادة BIS لمولدات الديزل في شهادة
          المخطط X من مكتب المعايير الهندية (BIS). تم تطبيق هذا المخطط لضمان أن
          المصنعين الوطنيين والعالميين على حد سواء يلبون المعايير الهندية
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>فشل العداد (ميكانيكي وكهربائي) مما يؤدي إلى نقص الإمداد</li>
          <li>مخاطر عالية للحريق ومخاطر السلامة على الوحدات غير الممتثلة</li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>ينطبق على جميع أنواع مولدات الديزل بسعات مختلفة</li>
          <li>يتضمن اختبار المنتج في مختبرات معتمدة من BIS</li>
          <li>
            تدقيق المصنع، زيارة الورشة وفحص عملية الإنتاج، لإجراء تفتيش المصنع
            في الموقع بشكل مستقل لضمان معايير الجودة والسلامة.
          </li>
          <li>يقدم ترخيصاً لاستخدام علامة معيار BIS عند الترخيص</li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          أصدرت وزارة الصناعات الثقيلة إشعاراً لـ OTR لمولدات الديزل في عام
          2024.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>ثقة العملاء: علامة معيار BIS تضمن موثوقية عالية وسلامة.</li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
          ...
          <li>مجموعات مولدات ديزل صامتة للتجارية (تطبيقات واستخدامات حضرية)</li>
        </ul>

        <p className="text-gray-600 text-base font-geist mb-6">
          يجب أن يلتزم كل نوع فرعي بالمعايير الهندية المعمول بها (رمز IS) مثل IS
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          <li>تحديد المعيار المعمول به: اكتشف رمز IS لنوع المولد.</li>
          <li>
            اختبار المنتج: قم بإجراء اختبارات السلامة والأداء والانبعاثات في
            مختبر معترف به من BIS.
          </li>
          <li>تدقيق المصنع: يفحص مسؤولو BIS عمليات مراقبة الجودة التصنيعية.</li>
          <li>تقديم الوثائق: قدم المواصفات ونتائج الاختبار ووثائق الامتثال.</li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          الفشل في الامتثال لشهادة BIS لمولدات الديزل من OTR لمولدات الديزل يمكن
          أن يؤدي إلى:
        </p>

        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>حظر بيع واستيراد وتصنيع المعدات غير المعتمدة.</li>
