    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          المولدات والمحركات والمولدات البديلة كآلات كهربائية دوارة هي أنواع
          مهمة من الآلات المستخدمة في أنشطة حيوية مختلفة مثل تشغيل الصناعات
          وإنتاج الطاقة وحتى تلبية احتياجات البنية التحتية لتكنولوجيا المعلومات
          وغيرها على المستوى العالمي. تعمل هذه الآلات معاً في قطاعات مثل الطاقة
          والنقل والتصنيع والمجمعات التجارية لأنها تحول الطاقة الميكانيكية إلى
          كهرباء أو العكس. هذه الآلات مهمة جداً وبالتالي، جودتها وموثوقيتها
          وسلامتها مهمة. في الهند، تعامل BIS مع هذه المشكلة من خلال شهادة المخطط
          X للآلات الكهربائية الدوارة وتجميعاتها ومكوناتها جنباً إلى جنب مع
          المعدات الكهربائية الأخرى.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          في أمر اللائحة الفنية الشاملة 2024، أعلنت وزارة الصناعات الثقيلة أن
          جميع المصنعين، الأجانب والمحليين، الذين ينتجون الآلات الدوارة وجميع
          المعدات ذات الصلة الأخرى، يجب أن يمتثلوا لشهادة المخطط X بحلول 1
          سبتمبر 2026. تنص هذه اللائحة على جميع أنواع الآلات الكهربائية الدوارة
          بما في ذلك المولدات والمولدات البديلة والمحركات المتزامنة وغير
          المتزامنة، وكذلك جميع التجميعات والتجميعات الفرعية ومكونات الآلات.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          تناقش هذه المقالة الأهمية والنطاق وإجراءات الشهادة والمزايا والوثائق
          ذات الصلة الأخرى لشهادة المخطط X لجميع أنواع الآلات الكهربائية
          الدوارة.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          شهادة BIS المخطط X للآلات الكهربائية الدوارة هي مخطط تنظيمي حكومي
          بموجب لوائح تقييم المطابقة BIS، 2018. إنها تشهد على البضائع للمعايير
          الهندية قبل دخولها السوق الهندي.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          أعلنت وزارة الصناعات الثقيلة OTR للآلات الكهربائية الدوارة في عام
          2024، التي تتطلب شهادة المخطط X.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          "سيوقف هذا الآلات الكهربائية الدوارة غير المعتمدة من البيع أو
          الاستيراد أو المشاركة في المناقصات في جميع أنحاء البلاد،" كما قال
          مسؤول حكومي.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            السلامة والامتثال: تجنب المخاطر الكهربائية والميكانيكية بمعايير
            صارمة.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
          ...
          <li>أنواع خاصة من الآلات الدوارة المستخدمة في الصناعة والمرافق</li>
        </ul>

        <p className="text-gray-600 text-base font-geist mb-6">
          يجب أن تلبي جميع هذه الأنواع المعايير الهندية المعمول بها (رمز IS) مثل
          IS 16819:2018/ISO 12100:2010 (سلامة الآلات المبادئ العامة للتصميم -
          تقييم المخاطر وتقليل المخاطر). يجب أن تلبي جميع الأصناف المعايير
          الهندية (رمز IS) المناسبة للجودة والسلامة وكفاءة الطاقة.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            الطلب والوثائق: توفير المتطلبات الفنية ودليل الجودة وتقارير
            الاختبار.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          المصنعون الذين لا يمتلكون جميع نماذج الآلات الكهربائية الدوارة
          المعتمدة بشهادة BIS للآلات الكهربائية الدوارة بحلول 1 سبتمبر 2026
          يواجهون مخاطر:
        </p>

        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>حظر البيع/الاستيراد للآلات الكهربائية الدوارة غير المعتمدة</li>
