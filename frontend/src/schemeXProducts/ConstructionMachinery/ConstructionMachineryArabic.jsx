...
const ConstructionMachineryMetaTags = () => {
  const title = "شهادة BIS المخطط X لآلات البناء، الحفر، والتعدين";
  const description =
  ...
  const canonicalUrl =
    "https://bis-certifications.com/shahadat-bis-mukhatat-x-lil-alat-albina";
  const author = "Sun Certifications India";
  const publisher =
    "Dhruv Aggarwal, Head of Operations at Sun Certification India";
  const ogTitle = "شهادة BIS المخطط X لآلات البناء في الهند | دليل كامل";
  const ogDescription =
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          أنشأ مكتب المعايير الهندية (BIS) شهادة BIS الإلزامية بموجب المخطط X
          لآلات البناء لتوفير ضمان الجودة والخدمة والسلامة. يضمن هذا أن الأجهزة
          تتوافق مع المعايير الهندية قبل أن تكون متاحة للبيع أو الاستيراد في
          الهند.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          في هذه المقالة، سوف تتعلم عن شهادة BIS المخطط X لآلات البناء، متطلبات
          OTR لآلات البناء، وعملية الحصول على ترخيص BIS لآلات البناء وكذلك علامة
          BIS لآلات البناء.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            اختبار المنتج الإلزامي، زيارة المصنع الإلزامية ومراجعة الامتثال يجب
            إجراؤها بانتظام
          </li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          ...
          لآلات البناء بموجب المخطط X قبل 01 سبتمبر 2026. اعتباراً من هذا
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            الدخول إلى السوق العالمي: ترخيص BIS لآلات البناء يمكن أن يكون مفيداً
            للشركات الأجنبية للوصول السهل إلى السوق الهندي.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          <li>
            تحديد المعيار المعمول به: ابحث عن رمز IS لنوع آلة البناء الخاصة بك.
          </li>
          <li>
            اختبار المنتج: قم بإجراء اختبارات السلامة والأداء في مختبر معترف به
            من BIS.
          </li>
          <li>
          ...
          <li>الطلب والوثائق: قدم التقارير والمواصفات والدليل للمراجعة.</li>
          <li>
            ترخيص BIS لآلات البناء: بعد الموافقة، يُسمح للمصنعين بوضع علامة BIS
            لآلات البناء.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>حظر بيع واستيراد المعدات غير المعتمدة</li>
          <li>غرامات كبيرة واحتجاز المنتجات</li>
          <li>الإقصاء من المشاريع والجوائز الحكومية</li>
          <li>إمكانية تلف السمعة غير المحدود لسنوات قادمة</li>
        </ul>
