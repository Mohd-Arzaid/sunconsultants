        ...
        <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
            ...
            <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
                ...
                <p className="text-gray-600 text-base font-geist mb-4">
                    Gears, gear systems, and transmission components are the heart of many
                    industries. Spanning applications from automotive and aerospace to
                    construction equipment and engineering machinery, this system
                    contributes to smooth power transfer, accurate movement and excellent
                    mechanical performance.
                </p>

                {/* Introduction Paragraph 2 */}
                <p className="text-gray-600 text-base font-geist mb-4">
                    In order to improve the safety, reliability, and efficiency, the
                    Bureau of Indian Standards (BIS) has made it mandatory to get BIS
                    Certification for Gears, Gearbox, and Transmission Elements under the
                    Scheme X. This certificate is proof to regular citizens and foreign
                    nations that the manufacturer has met the Indian Standards of quality
                    and safety while manufacturing or importing in India.
                </p>

                {/* Introduction Paragraph 3 */}
                <p className="text-gray-600 text-base font-geist mb-6">
                    This article delves into the significance of the BIS Scheme X
                    Certification for Gears, Gearing, and transmission Elements, the 2024
                    OTR mandate, and how to get certified.
                </p>
