import {
  ...
  const PublicWorksAndMechanicalMetaTags = () => {
    const title =
      "شهادة BIS المخطط X للأشغال العامة والمعدات الميكانيكية";
    const description =
      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            الصناعية، أصدرت وزارة الصناعات الثقيلة أمر اللائحة الفنية الشاملة (OTR)،
            2024. ينص هذا الأمر على أن جميع أنواع الآلات للأشغال العامة وبناء
            المباني والمعدات الميكانيكية الأخرى، بما في ذلك تلك غير المذكورة صراحة
            في أقسام فرعية أخرى من الفصل 84، مطلوبة للحصول على شهادة BIS بموجب
            المخطط X.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            العامة وبناء البنية التحتية، المعدات الميكانيكية بوظائف فردية، تجميعاتها،
            التجميعات الفرعية، أهمية ونطاق المخطط الذي يتم الحديث عنه كثيراً، عملية
            الشهادة والمزايا، والوثائق التي يجب تقديمها.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
            <li>
              بناء البنية التحتية العامة (الطرق، الجسور، إمدادات المياه)
            </li>
            <li>مشاريع الهندسة والبناء الثقيل</li>
            <li>خدمات المدينة والمرافق</li>
            <li>
              المرافق الصناعية التي تتطلب رفع أو معالجة الآلات
            </li>
          </ul>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            تقييم المطابقة BIS، 2018. إنها وسيلة محددة وأداة تنظيمية لضمان أن الآلات
            الصناعية والبنية التحتية تتوافق مع المعايير الهندية.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              تدقيق المصنع وتفتيش الامتثال الروتيني مدرج في العملية
            </li>
            <li>
              يمنح الحق في استخدام علامة معيار BIS بعد الشهادة
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>
              سلامة المنتج: منع الانهيار بسبب المشاكل الميكانيكية والعمليات الموثوقة.
            </li>
            <li>
            ...
            <li>
              تقليل المسؤولية: تقليل التعرض القانوني والعلامة التجارية المحتملة
              مع المنتجات المعتمدة.
            </li>
          </ul>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            تقييم المخاطر وتقليل المخاطر). يجب إنتاج جميع هذه الأشكال وفقاً للمعايير
            الهندية المعمول بها للسلامة والأداء والجودة.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            <li>
              تحديد المعيار ذي الصلة: اختر رمز IS المعمول به لآلتك.
            </li>
            <li>
            ...
            <li>
              الوثائق: قدم نموذج الطلب والتقارير الفنية ودليل الجودة
            </li>
            <li>
              إصدار الترخيص: يمنح BIS الشهادة ويسمح باستخدام علامة معيار BIS.
            </li>
            <li>
              الامتثال المستمر: هناك اختبارات وتدقيق مستمرة لضمان الامتثال المستمر.
            </li>
          </ul>
