...
const CranesMetaTags = () => {
  ...
  const canonicalUrl =
    "https://bis-certifications.com/bis-schema-x-certificering-voor-kranen";
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Kranen worden voornamelijk gebruikt voor het tillen en transporteren
          van materialen en in productie, bouw, productie en mijnbouw. Omdat hun
          functie kritisch kan zijn voor veiligheid, kunnen ongeschikte of
          slechtkwaliteitskranen leiden tot slippen en vallen, apparatuurschade
          of kostbare verliezen.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          Gezien deze gevaren heeft het Bureau of Indian Standards (BIS) BIS
          Certificering voor Kranen verplicht gemaakt onder Schema X
          Certificering. Dit zorgt ervoor dat kranen die in India worden
          gebruikt veilig, betrouwbaar, efficiënt en van wereldklasse kwaliteit
          zijn.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          In deze blog begeleiden we u over het belang van BIS Schema X
          Registratie voor Kranen, de juridische aspecten van OTR voor Kranen,
          en hoe u BIS Licentie voor Kranen kunt verkrijgen en het BIS
          Standaardmerk voor Kranen kunt markeren.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Zonder BIS voor Kranen kunnen niet-gecertificeerde apparatuur leiden
          tot:
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          ...
          <li>
            Werknemers en infrastructuur blootgesteld aan veiligheidsgevaren
          </li>
        </ul>

        <p className="text-gray-600 text-base font-geist mb-6">
          Het BIS-merk voor Kranen geeft consumenten en regelgevers vertrouwen
          dat het product voldoet aan strikte Indiase kwaliteits- en
          veiligheidsnormen.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Schema X Certificering voor Kranen onder BIS is verplicht volgens de
          BIS Conformiteitsbeoordelingsregeling, 2018, die productcertificering
          vereist voor kritieke machines.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Verbeterde Veiligheid: Gecertificeerde kranen minimaliseren
            mechanisch falen en ongevallen.
          </li>
          <li>
            Marktvoordelen: Overheidsinstanties en particuliere bedrijven geven
            voorkeur aan BIS-gecertificeerde kranen in e-tenders en grote
            projecten.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Kranen die onder Schema X certificering vallen, bestaan uit
          verschillende soorten, bijvoorbeeld:
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Elke variant moet voldoen aan de relevante Indiase Normen (IS-code)
          zoals IS 4573:2020 voor Specificatie van Aangedreven Mobiele Kranen en
          IS/ISO 15442:2012 voor Kranen - Veiligheidsvereisten voor laadkranen.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Soorten apparatuur moeten voldoen aan relevante Indiase normen
          (IS-code) voor ontwerp, laadvermogen, veiligheid en prestaties.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          <li>
            Identificatie van Relevante IS-normen: Identificeer de van
            toepassing zijnde Indiase Normen voor uw type kraan.
          </li>
          <li>
          ...
          <li>
            Aanvraag & Documentatie: Presenteer technische rapporten,
            testresultaten en kwaliteitshandleidingen.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          mijlpaal zijn die veiligheid, betrouwbaarheid zal verbeteren en
          algemene industriestandaarden in India zal bieden.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Voor fabrikanten, importeurs, exporteurs van Kranen is het belangrijk
          om BIS Licentie voor Kranen te hebben en kunnen aanvragen via het
          online aanvraagportaal voor BIS Kraanregistratie om te voldoen aan
          normen, consumentenvertrouwen op te bouwen, en ook om potentiële
          conflicten met BIS of de Indiase regering te vermijden.
        </p>
