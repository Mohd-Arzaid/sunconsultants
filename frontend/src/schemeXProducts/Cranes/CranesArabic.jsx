...
const CranesMetaTags = () => {
  ...
  const canonicalUrl =
    "https://bis-certifications.com/shahadat-bis-mukhatat-x-lil-rafaat";
  const author = "Sun Certifications India";
  const publisher =
    "Dhruv Aggarwal, Head of Operations at Sun Certification India";
  const ogTitle = "شهادة BIS المخطط X للرافعات في الهند | دليل كامل";
  const ogDescription =
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          تُستخدم الرافعات بشكل أساسي لرفع ونقل المواد وكذلك في التصنيع والبناء
          والإنتاج والتعدين. نظراً لأن وظائفها يمكن أن تكون حرجة للسلامة،
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          نظراً لهذه المخاطر، جعل مكتب المعايير الهندية (BIS) شهادة BIS للرافعات
          إلزامية بموجب شهادة المخطط X. يضمن هذا أن الرافعات المستخدمة في الهند
          آمنة وموثوقة وفعالة وعالية الجودة على مستوى عالمي.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          في هذه المدونة، سنرشدك حول أهمية تسجيل BIS المخطط X للرافعات، الجوانب
          القانونية لـ OTR للرافعات، وكيفية الحصول على ترخيص BIS للرافعات وكذلك
          وضع علامة معيار BIS للرافعات.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>اختبار المنتج، تدقيق المصنع وتقييم الامتثال المستمر إلزامي</li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          الموعد النهائي: يحتاج جميع مصنعي/مستوردي الرافعات إلى الحصول على ترخيص
          BIS للرافعات بموجب المخطط X في موعد أقصاه 01 سبتمبر 2026. بعد ذلك، لا
          يمكن تسويق أو استيراد أو استخدام الرافعات غير المعتمدة في المناقصات
          العامة في الهند.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            الدخول إلى السوق العالمي: للمصنعين الأجانب، ترخيص BIS للرافعات يسمح
            بالاختراق بدون عوائق إلى السوق الهندي المنظم.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          ...
          <li>تفتيش المصنع: تقوم BIS بتفتيش موقع الإنتاج ونظام الجودة.</li>
          <li>
            الطلب والوثائق: قدم التقارير الفنية، نتائج الاختبار، ودليل الجودة.
          </li>
          <li>
            ترخيص BIS على الرافعات: بعد الموافقة، يحصل المصنعون على الحق المميز
            لتطبيق علامة BIS للرافعات.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-6">
          بالنسبة لمصنعي ومستوردي ومصدري الرافعات، من المهم الحصول على ترخيص BIS
          للرافعات ويمكن التقدم من خلال بوابة التطبيق عبر الإنترنت لتسجيل BIS
          للرافعات للامتثال للمعايير، بناء ثقة المستهلك، وأيضاً لتجنب النزاعات
          المحتملة مع BIS أو الحكومة الهندية.
        </p>
