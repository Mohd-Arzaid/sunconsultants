...
const MetalCuttingMachinesMetaTags = () => {
  const title = "شهادة BIS المخطط X لآلات قطع المعادن وتجميعاتها";
  const description =
  ...
  const ogTitle = "شهادة BIS المخطط X لآلات قطع المعادن في الهند | دليل كامل";
  const ogDescription =
    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          قطع المعادن هو تقنية تصنيع أساسية تدعم صناعات الآلات والسيارات
          والطيران والتصنيع الهندية. تتراوح هذه الآلات من المخرطة CNC وآلة الطحن
          إلى قواطع الليزر وستساعد أيضاً في الحفاظ على الإنتاج عالياً والتكاليف
          منخفضة في الصناعات في جميع أنحاء العالم. مع زيادة الطلب على الآلات
          عالية الجودة في الهند، جعلت الحكومة شهادة BIS لآلات قطع المعادن
          إلزامية لضمان الجودة والسلامة.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          وفقاً لشهادة BIS (مكتب المعايير الهندية) المخطط X لآلات قطع المعادن،
          يجب على المصنعين الأجانب والهنود على حد سواء تلبية المعايير الهندية
          قبل أن يتم بيعها في السوق الهندي. هذه طريقة لضمان استخدام الآلات
          بأمان، وكذلك ضمان ثقة العملاء.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          ...
          <li>فشل الآلة وفقدان الإنتاج وقت التشغيل مقابل وقت التوقف.</li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          شهادة BIS المخطط X لآلات قطع المعادن هي بموجب لوائح تقييم المطابقة
          BIS، 2018 التي تم وضعها لضمان أن المنتجات تلبي معايير الجودة المطلوبة
          التي هي حاجة حالية لمعدات الصناعة.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            ينطبق على أنواع مختلفة من آلات قطع المعادن المعلن عنها بموجب
            المعايير الهندية
          </li>
          <li>يتضمن اختبارات المختبر وتفتيش المصنع وتدقيق روتيني</li>
          <li>يخول استخدام علامة BIS لآلات قطع المعادن.</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>موثوقية المنتج: الآلات معتمدة للدقة والمتانة والأداء المتسق.</li>
          <li>
          ...
          <li>الامتثال القانوني: متوافق مع OTR لآلات قطع المعادن وBIS.</li>
          <li>الميزة العالمية: وصول أسهل للمصنعين الأجانب إلى السوق الهندي.</li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          ...
          <li>
            اختبار المنتج: قدم الآلة للاختبار في مختبر BIS المعترف به من
            الحكومة.
          </li>
          <li>
