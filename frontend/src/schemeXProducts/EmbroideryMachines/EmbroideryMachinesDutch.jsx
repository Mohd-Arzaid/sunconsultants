    ...
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          De borduursector is een belangrijk onderdeel van de Indiase textiel-
          en kledingindustrie die waardetoegevoegde stoffen produceert voor
          mode, huis en export. Gecomputeriseerde multi-kop borduurmachines of
          industriële machines zijn essentieel voor het bereiken van hoge
          kwaliteit in borduurproducten omdat ze efficiëntie en precisie bieden
          in borduurwerk.
        </p>

        {/* Introduction Paragraph 2 */}
        <p className="text-gray-600 text-base font-geist mb-4">
          Om veiligheid, stabiliteit en prestaties te waarborgen, heeft BIS
          (Bureau of Indian Standards) verplichte certificering voor
          Borduurmachines ingevoerd onder het BIS Schema X certificeringsschema.
          Dit zorgt ervoor dat alleen machines die voldoen aan Indiase Normen
          worden toegestaan op de Indiase markt.
        </p>

        {/* Introduction Paragraph 3 */}
        <p className="text-gray-600 text-base font-geist mb-6">
          In dit artikel bespreken we het belang van BIS Schema X Goedkeuring
          voor Borduurmachines, de regelgeving onder OTR (Textielregeling) voor
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Het Kader voor BIS Schema X Certificering voor Borduurmachines is
          gebaseerd op parameters genoemd onder de BIS
          Conformiteitsbeoordelingsregeling, 2018 (die is ontwikkeld voor
          naleving in kwaliteitsmanagement onder leveranciers van industriële
          apparatuur).
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          ...
          <li>
            Maakt het mogelijk om het BIS-merk onder licentie voor
            Borduurmachines te plaatsen op gecertificeerde producten
          </li>
        </ul>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          Regeling (OTR) 2024 voor Borduurmachines geïntroduceerd die
          certificering verplicht stelt voor alle machines die onder de
          categorie borduurmachines vallen.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Deadline: Alle fabrikanten en importeurs zijn verplicht om BIS
          Licentie voor Borduurmachines te verkrijgen die in India zullen worden
          verkocht of geïmporteerd op 1 september 2026 om boetes of vervolging
          te voorkomen. Daarna kunnen niet-gecertificeerde borduurmachines niet
          worden verhandeld of gebruikt voor commerciële doeleinden in India.
        </p>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
          <li>
            Productveiligheid & Betrouwbaarheid: Certificeerbare machines
            presteren volgens verwachte normen en veiligheid.
          </li>
          <li>
          ...
          <li>
            Regelgevingsnaleving: Voldoet aan OTR voor Borduurmachines en
            voorkomt boetes.
          </li>
          <li>
            Exportvoordelen: Indiase kopers krijgen gemoedsrust met
            gecertificeerde machines en internationale bedrijven krijgen
            eenvoudigere toegang tot India.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
          <li>
            Identificatie van Relevante Normen: Zoek de relevante IS-code voor
            uw borduurmachinemodel.
          </li>
          <li>
            Producttests: Machines worden getest in BIS-geaccrediteerde
            laboratoria voor veiligheid en prestaties.
          </li>
          <li>
          ...
          <li>
            BIS Licentie voor Borduurmachines: Na acceptatie hebben fabrikanten
            de optie om hun producten te markeren met het BIS-merk.
          </li>
          <li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Gevolgen van het niet hebben van BIS Certificering voor
          Borduurmachines onder OTR voor Borduurmachines vanaf 1 september 2026:
        </p>

        <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
          <li>
            Beperkingen op verkoop/import van niet-gecertificeerde machines
          </li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Implementatie van BIS Schema X Certificering voor Borduurmachines in
          OTR voor Borduurmachines (2024) is een belangrijke stap voor de
          Indiase textiel- en borduursector.
        </p>

        <p className="text-gray-600 text-base font-geist mb-6">
          Vanuit het perspectief van Fabrikanten en Importeurs van
          Borduurmachines is het verkrijgen van BIS Registratie voor
          Borduurmachines en het plaatsen van het BIS-merk voor Borduurmachines
          niet alleen naleving van juridische vereisten maar heeft ook
          buitengewone ondersteuning voor productkwaliteit, marktvertrouwen &
          concurrentievoordeel voor de snelgroeiende textielindustrie in India.
        </p>
