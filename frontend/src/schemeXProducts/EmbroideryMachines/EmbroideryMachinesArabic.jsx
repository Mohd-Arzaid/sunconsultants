import {
  ...
  const EmbroideryMachinesMetaTags = () => {
    ...
    const ogTitle =
      "شهادة BIS المخطط X لآلات التطريز في الهند | دليل كامل";
    const ogDescription =
      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            فقط الآلات التي تتوافق مع المعايير الهندية مسموح لها بالدخول إلى
            السوق الهندي.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-4">
            ...
            <li>إنتاج المنسوجات المنزلية (الستائر، أغطية الأسرة، أكياس الوسائد)</li>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              يتضمن الاختبار وفحص السلامة والتحقق من الكفاءة
            </li>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            ...
            BIS لآلات التطريز التي سيتم بيعها أو استيرادها في الهند بحلول 1
            سبتمبر 2026 لتجنب الغرامات أو الملاحقة القضائية. بعد ذلك، لا يمكن
            تداول أو استخدام آلات التطريز غير المعتمدة للأغراض التجارية في الهند.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            ...
            <li>
              تفتيش المصنع: يأتي مدققو BIS إلى المصنع لتقييم مراقبة الجودة.
            </li>
            <li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            عواقب عدم وجود شهادة BIS لآلات التطريز بموجب OTR لآلات التطريز اعتباراً
            من 1 سبتمبر 2026:
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-1 mb-6">
            ...
            <li>
              عدم الأهلية للعقود الحكومية والتصدير الكبير
            </li>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            من منظور مصنعي ومستوردي آلات التطريز للحصول على تسجيل BIS لآلات التطريز
            ووضع علامة BIS لآلات التطريز ليس فقط امتثالاً للمتطلبات القانونية بل
            أيضاً لدعم استثنائي لجودة المنتج وثقة السوق والميزة التنافسية لصناعة
            النسيج في الهند المتزايدة باستمرار.
          </p>
