      ...
      <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
        ...
        <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            محولات أشباه الموصلات للطاقة تمكن من تنفيذ وتعديل الطاقة الكهربائية بشكل
            فعال من شكل إلى آخر في تطبيقات متنوعة. تشمل هذه التطبيقات الطاقة
            المتجددة والمركبات الكهربائية وأتمتة الصناعة والإلكترونيات الاستهلاكية.
            تعمل كأساس للأجهزة والمعدات الكهربائية والإلكترونية. بسبب الأهمية
            والأهمية المتزايدة لهذه الأجهزة في قطاع الطاقة والصناعة في البلاد، دمج
            مكتب المعايير الهندية (BIS) شهادة محولات أشباه الموصلات للطاقة تحت
            إطار شهادة المخطط X.
          </p>
          ...
          <p className="text-gray-600 text-base font-geist mb-6">
            سيساعد هذا المقال في تقديم المعلومات اللازمة حول الوثائق المتعلقة بشهادة
            المخطط X لجميع التجميعات الفرعية والمكونات و/أو أنواع محولات أشباه
            الموصلات للطاقة، النطاق والأهمية، عملية الشهادة، المزايا، ومعلومات أخرى.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            ...
            <li>
              يغطي مقدمة شاملة حول أجهزة أشباه الموصلات للطاقة، تصميم بوابة القيادة،
              والمكونات السلبية.
            </li>
            <li>اختبار المنتج إلزامي في مختبر معتمد من BIS</li>
            <li>
              الاستبعاد من أعمال المدينة، والمشاريع والمناقصات الحكومية.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            ...
            <li>
              يتطلب شهادة القوة والسلامة من مختبر معتمد من BIS
            </li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            ...
            الموصلات للطاقة من قبل وزارة الصناعات الثقيلة. هذا الأمر OTR يجعل شهادة
            المخطط X إلزامية لهذا المنتج لضمان الجودة والسلامة للمستهلكين.
          </p>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-6">
            <li>
              سلامة المنتج: تقليل مخاطر ارتفاع درجة الحرارة والحوادث النارية والدوائر
              القصيرة.
            </li>
            <li>
            ...
            <li>
              ثقة العملاء: علامة معيار BIS تظهر الموثوقية والسلامة والجودة.
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
            ...
            <li>
              تفتيش المصنع: فحص نظام ضمان الجودة في موقع الإنتاج من قبل مسؤولي BIS.
            </li>
            <li>
              الطلب والوثائق: توفير المتطلبات الفنية ودليل الجودة وتقرير الاختبار.
            </li>
            <li>
              إصدار ترخيص BIS لمحولات أشباه الموصلات للطاقة: يمكنك وضع علامة BIS بعد
              الموافقة.
            </li>
            <li>
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            المصنعون الذين لا يملكون جميع نماذج محولات أشباه الموصلات للطاقة المعتمدة
            بشهادة BIS لمحولات أشباه الموصلات للطاقة بحلول 1 سبتمبر 2026 يواجهون
            مخاطر:
          </p>
