// Product table data - extracted for better code splitting
// This data will be loaded only when the BISFMProductTable component is actually used
...
export const productTableData = [
  {
    ...
    notification: {
      title: "1. คำสั่งซีเมนต์ (การควบคุมคุณภาพ) พ.ศ. 2546",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 191(E).pdf",
      linkText: "S.O. No. 191(E) วันที่ 17 ก.พ. 2546",
    },
  },
  {
    id: 2,
  ...
  },
  {
    ...
    sno: 6,
    isNumber: "IS 3466",
    product: "ปูนซีเมนต์ก่ออิฐ",
  },
  {
    id: 7,
    sno: 7,
    isNumber: "IS 455",
    product: "ปูนซีเมนต์ปอร์ตแลนด์สแล็ก",
  },
  {
    id: 8,
    sno: 8,
    isNumber: "IS 6452",
    product: "ปูนซีเมนต์อลูมินาสูงสำหรับโครงสร้าง",
  },
  {
    id: 9,
    sno: 9,
    isNumber: "IS 6909",
    product: "ปูนซีเมนต์ซัลเฟตสูง",
  },
  {
    id: 10,
    sno: 10,
  ...
  },
  {
    ...
    sno: 11,
    isNumber: "IS 8042",
    product: "ปูนซีเมนต์ปอร์ตแลนด์ขาว",
  },
  {
    id: 12,
    sno: 12,
  ...
  },
  {
    ...
    sno: 13,
    isNumber: "IS 8229",
    product: "ปูนซีเมนต์บ่อน้ำมัน",
  },
  {
    id: 14,
    sno: 14,
    isNumber: "IS 16415: 2015",
    product: "ปูนซีเมนต์คอมโพสิต-ข้อกำหนด",
  },
  {
    id: 15,
    sno: 15,
  ...
  },
  {
    ...
    product: "ปูนซีเมนต์ทนไฟอลูมินาสูง",
  },
  {
    id: 17,
    sno: 17,
    ...
    product:
      "เบรกเกอร์วงจรทำงานด้วยกระแสตกค้างสำหรับใช้ในบ้านและใช้ที่คล้ายกัน-ส่วนที่ 1 เบรกเกอร์วงจรที่ไม่มีระบบป้องกันกระแสเกินในตัว (RCCBs)",
    notification: {
      title:
        "2. คำสั่งสายไฟฟ้า สายเคเบิล เครื่องใช้ไฟฟ้าและอุปกรณ์ป้องกันและอุปกรณ์เสริม (การควบคุมคุณภาพ) พ.ศ. 2546",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 189 (E).pdf",
      linkText: "หมายเลข 189(E) วันที่ 17 ก.พ. 2546",
      amendments: [
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 165 (E).pdf",
          text: "S.O. 165(E) วันที่ 5 ก.พ. 2547",
        },
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 1172 (E).pdf",
          text: "S.O. 1172 (E) วันที่ 22 ส.ค. 2548",
        },
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No 512 (E).pdf",
          text: "S.O. 512(E) วันที่ 19 ก.พ. 2552",
        },
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No 2058 (E).pdf",
          text: "S.O. 2058(E) วันที่ 7 ส.ค. 2552",
        },
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No 2604 (E).pdf",
          text: "S.O. 2604 (E) วันที่ 19 ต.ค. 2553",
        },
      ],
    },
  },
  {
    ...
    product:
      "เบรกเกอร์วงจรทำงานด้วยกระแสตกค้างสำหรับใช้ในบ้านและใช้ที่คล้ายกัน-ส่วนที่ 2 เบรกเกอร์วงจรที่มีระบบป้องกันกระแสเกินในตัว (RCVOs)",
  },
  {
    id: 19,
    sno: 19,
    isNumber: "IS 13010",
    product: "มิเตอร์วัตต์-ชั่วโมง AC ระดับ 0.5, 1 และ 2",
  },
  {
    id: 20,
    sno: 20,
    isNumber: "IS 13779",
    product: "มิเตอร์วัตต์-ชั่วโมง AC แบบสแตติก ระดับ 1 และ 2",
  },
  {
    id: 21,
    sno: 21,
    isNumber: "IS 14697",
    product:
      "มิเตอร์วัตต์-ชั่วโมงและ VAR-ชั่วโมง AC แบบสแตติกที่ทำงานด้วยหม้อแปลง ระดับ 0.2S และ 0.5S",
  },
  {
    id: 22,
    sno: 22,
    ...
    product:
      "หลอดไฟแบบมีบัลลาสต์ในตัวสำหรับบริการแสงสว่างทั่วไป – ส่วนที่ 1: ข้อกำหนดด้านความปลอดภัย และ ส่วนที่ 2: ข้อกำหนดด้านประสิทธิภาพ",
  },
  {
    id: 23,
    sno: 23,
    isNumber: "IS 302 (Part 2/Sec 3)",
    product: "ความปลอดภัยของเครื่องใช้ไฟฟ้าในบ้านและที่คล้ายกัน – เตารีดไฟฟ้า",
  },
  {
    id: 24,
    sno: 24,
    ...
    product:
      "ความปลอดภัยของเครื่องใช้ไฟฟ้าในบ้านและที่คล้ายกัน– เครื่องทำน้ำร้อนแบบจุ่มไฟฟ้า",
  },
  {
    id: 25,
    sno: 25,
    isNumber: "IS 302 (Part 2/Sec 202)",
    product: "ความปลอดภัยของเครื่องใช้ไฟฟ้าในบ้านและที่คล้ายกัน –เตาไฟฟ้า",
  },
  {
    id: 26,
    sno: 26,
    ...
    product:
      "ความปลอดภัยของเครื่องใช้ไฟฟ้าในบ้านและที่คล้ายกัน-เครื่องทำความร้อนในห้อง",
  },
  {
    id: 27,
    sno: 27,
    isNumber: "IS 3854",
    product: "สวิตช์สำหรับใช้ในบ้านและใช้ที่คล้ายกัน",
  },
  {
    id: 28,
    sno: 28,
    isNumber: "IS 418",
    product: "หลอดไฟฟ้าทั่วไปแบบไส้ทังสเตน (สูงสุด 100 W)",
  },
  {
    id: 29,
    sno: 29,
    isNumber: "IS 694",
    product: "สายเคเบิลฉนวน PVC สำหรับแรงดันใช้งานสูงสุด 1100V",
  },
  {
    id: 30,
    sno: 30,
    isNumber: "IS 8828 *",
    product:
      "อุปกรณ์เสริมไฟฟ้า-เบรกเกอร์วงจรสำหรับป้องกันกระแสเกินสำหรับการติดตั้งในบ้านและที่คล้ายกัน",
  },
  {
    id: 31,
    sno: 31,
    ...
    product:
      "สายเคเบิลฉนวนอีลาสโตเมอร์ (ส่วนที่ 1): สำหรับแรงดันใช้งานสูงสุด 1100 V",
  },
  {
    id: 32,
    sno: "32",
    ...
    notification: {
      ...
      linkText: "SO 516(E), วันที่ 25 พ.ค. 2530",
    },
  },
  {
    id: 33,
    sno: " ",
    isNumber: "อาหารและผลิตภัณฑ์ที่เกี่ยวข้อง",
    product: "อาหารและผลิตภัณฑ์ที่เกี่ยวข้อง",
    isDeNotified: true,
  ...
  },
  {
    ...
    sno: " ",
    isNumber: "IS 15757",
    product: "สูตรอาหารเสริมสำหรับทารก",
    isDeNotified: true,
    notification: {
      title:
        "ความปลอดภัยอาหารและมาตรฐาน การห้ามและจำกัดการขาย ข้อบังคับ พ.ศ. 2554",
      links: [
        {
      ...
      deNotification: {
        ...
        text: "ความปลอดภัยอาหารและมาตรฐาน (การห้ามและจำกัดการขาย) ข้อบังคับแก้ไขเพิ่มเติมครั้งที่ 1 พ.ศ. 2567",
      },
    },
  },
  {
    ...
    sno: " ",
    isNumber: "IS 11536",
    product: "อาหารเสริมที่ทำจากธัญพืชแปรรูป",
    isDeNotified: true,
  },
  {
    id: 36,
  ...
  },
  {
    ...
    sno: " ",
    isNumber: "IS 1166",
    product: "นมข้นจืด นมข้นพร่องมันเนยบางส่วนและนมข้นพร่องมันเนย",
    isDeNotified: true,
  },
  {
    id: 38,
    sno: " ",
    isNumber: "IS 12176",
    product: "นมข้นหวานที่ผ่านการฆ่าเชื้อด้วยอุณหภูมิสูงพิเศษ",
    isDeNotified: true,
  },
  {
    id: 39,
    ...
    notification: {
      ...
      linkText: "ความปลอดภัยอาหารและมาตรฐาน",
    },
  },
  {
    id: 40,
    ...
    notification: {
      links: [
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/Food%20Products/FSSAI%20Regulation%202011.pdf",
          linkText: "การห้ามและจำกัดการขาย ข้อบังคับ พ.ศ. 2554",
        },
        {
      ...
      additionalLinks: [
        {
          ...
          linkText:
            "ความปลอดภัยอาหารและมาตรฐาน (การห้ามและจำกัดการขาย) ข้อบังคับแก้ไขเพิ่มเติมครั้งที่ 1 พ.ศ. 2565 วันที่ 31/08/2022",
        },
      ],
      deNotification: {
        link: "https://www.bis.gov.in/wp-content/uploads/2024/11/De-notification-FoodProducts.pdf",
  ...
  },
  {
    ...
    product: "อาหารสำหรับวัตถุประสงค์ทางการแพทย์พิเศษสำหรับทารก",
    isDeNotified: true,
  },
  {
    id: 44,
    sno: " ",
    isNumber: "IS 14542",
    product: "นมผงพร่องมันเนยบางส่วน",
    isDeNotified: true,
  },
  {
    id: 45,
    sno: " ",
    isNumber: "IS 14543",
    product: "น้ำดื่มบรรจุภัณฑ์ (อื่นๆ นอกเหนือจากน้ำแร่ธรรมชาติบรรจุภัณฑ์)",
    isDeNotified: true,
  },
  {
    id: 46,
    sno: " ",
    isNumber: "IS 1656",
    product: "อาหารเสริมที่ทำจากนมและธัญพืช",
    isDeNotified: true,
  },
  {
    id: 47,
  ...
  },
  {
    ...
    notification: {
      ...
      linkText:
        "พระราชบัญญัตินมทดแทนสำหรับทารก ขวดนมและอาหารทารก (การควบคุมการผลิต การจัดหาและการจำหน่าย) พ.ศ. 2535",
    },
  },
  {
    id: 49,
  ...
  },
  {
    ...
    sno: "35",
    isNumber: "IS 10109",
    product: "เตาน้ำมันแรงดัน แบบหัวเตาเยื้อง",
    notification: {
      title: "6. คำสั่งเตาน้ำมันแรงดัน (การควบคุมคุณภาพ) พ.ศ. 2540",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 451 (E).pdf",
      linkText: "SO 451(E) วันที่ 16 มิ.ย. 2540",
    },
  },
  {
    id: 52,
    sno: "36",
    isNumber: "IS 2787",
    product: "เตาน้ำมันแรงดันหลายหัวเตา",
    notification: {
      title: "6. คำสั่งเตาน้ำมันแรงดัน (การควบคุมคุณภาพ) พ.ศ. 2540",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 451 (E).pdf",
      linkText: "SO 451(E) วันที่ 16 มิ.ย. 2540",
  ...
  },
  {
    id: 54,
    sno: " ",
    isNumber: "อุปกรณ์เสริมยานยนต์",
    product: "อุปกรณ์เสริมยานยนต์",
    isSectionHeader: true,
  },
  {
    id: 55,
    sno: "38",
    isNumber: "IS 13098",
    product: "ยานพาหนะ – ท่อยางสำหรับยางลม",
    notification: {
      title:
        "7. คำสั่งยางลมและท่อยางสำหรับยานพาหนะ (การควบคุมคุณภาพ) พ.ศ. 2552",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 2953 (E).pdf",
      linkText: "S.O. No. 2953(E) วันที่ 19-11-2009",
      amendments: [
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 1057 (E).pdf",
          text: "S.O. No. 1057 (E) วันที่ 11-05-2010",
        },
        {
          link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 2758 (E).pdf",
          text: "S.O. No. 2758 (E) วันที่ 9-11-2010",
        },
      ],
    },
  },
  {
    ...
    sno: "39",
    isNumber: "IS 15627",
    product: "ยานพาหนะ – ยางลมสำหรับยานยนต์สองล้อและสามล้อ",
    notification: {
      title:
        "7. คำสั่งยางลมและท่อยางสำหรับยานพาหนะ (การควบคุมคุณภาพ) พ.ศ. 2552",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 2953 (E).pdf",
  ...
  },
  {
    ...
    sno: "40",
    isNumber: "IS 15633",
    product: "ยานพาหนะ-ยางลมสำหรับรถยนต์โดยสาร – แบบเฉียงและแบบเรเดียล",
    notification: {
      title:
        "7. คำสั่งยางลมและท่อยางสำหรับยานพาหนะ (การควบคุมคุณภาพ) พ.ศ. 2552",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 2953 (E).pdf",
  ...
  },
  {
    ...
    sno: "41",
    isNumber: "IS 15636",
    product: "ยานพาหนะ-ยางลมสำหรับยานพาหนะพาณิชย์-แบบเฉียงและแบบเรเดียล",
    notification: {
      title:
        "7. คำสั่งยางลมและท่อยางสำหรับยานพาหนะ (การควบคุมคุณภาพ) พ.ศ. 2552",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/SO No. 2953 (E).pdf",
  ...
  },
  {
    id: 59,
    sno: " ",
    isNumber: "ถังแก๊ส วาล์วและเครื่องควบคุม",
    product: "ถังแก๊ส วาล์วและเครื่องควบคุม",
    isSectionHeader: true,
  },
  {
    id: 60,
    ...
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
    },
  },
  {
    id: 61,
  ...
  },
  {
    ...
    product:
      "ถังแก๊สเหล็กคาร์บอนต่ำเชื่อมที่มีความจุน้ำเกิน 5 ลิตรสำหรับก๊าซที่ทำให้เป็นของเหลวได้ความดันต่ำ ส่วนที่ 4 ถังแก๊สสำหรับก๊าซพิษและกัดกร่อน",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    product:
      "ถังแก๊สเหล็กคาร์บอนต่ำเชื่อมที่มีความจุน้ำเกิน 5 ลิตรสำหรับก๊าซที่ทำให้เป็นของเหลวได้ความดันต่ำ ส่วนที่ 1 ถังแก๊สสำหรับก๊าซปิโตรเลียมเหลว (LPG)",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    product:
      "ถังแก๊สเหล็กคาร์บอนต่ำเชื่อมที่มีความจุน้ำเกิน 5 ลิตรสำหรับก๊าซที่ทำให้เป็นของเหลวได้ความดันต่ำ ส่วนที่ 2 ถังแก๊สสำหรับก๊าซที่ทำให้เป็นของเหลวได้อื่นๆ นอกเหนือจาก LPG",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    sno: "47",
    isNumber: "IS 3224",
    product: "อุปกรณ์วาล์วสำหรับถังแก๊สอัด ยกเว้นถังแก๊สปิโตรเลียมเหลว",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    sno: "48",
    isNumber: "IS 3745",
    product: "การเชื่อมต่อวาล์วแบบ Yoke สำหรับถังแก๊สทางการแพทย์ขนาดเล็ก",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    isNumber: "IS 7142",
    product:
      "ถังแก๊สเหล็กคาร์บอนต่ำเชื่อมสำหรับก๊าซที่ทำให้เป็นของเหลวได้ความดันต่ำที่มีความจุน้ำไม่เกิน 5 ลิตร",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    product:
      "ถังแก๊สเหล็กไร้รอยต่อที่เติมใหม่ได้ ส่วนที่ 1 ถังแก๊สเหล็กที่ทำให้เป็นมาตรฐาน",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    sno: "53",
    isNumber: "IS 7312",
    product: "ถังแก๊สอะเซทิลีนเหล็กเชื่อมและไร้รอยต่อ",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    isNumber: "IS 8737",
    product:
      "อุปกรณ์วาล์วสำหรับใช้กับถังแก๊สปิโตรเลียมเหลวที่มีความจุน้ำมากกว่า 5 ลิตร ส่วนที่ 2 อุปกรณ์วาล์วสำหรับถัง LPG ที่ผลิตใหม่",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    isNumber: "IS 8776",
    product:
      "อุปกรณ์วาล์วสำหรับใช้กับถังแก๊สปิโตรเลียมเหลว (LPG) ที่มีความจุน้ำสูงสุด 5 ลิตร",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    ...
    isNumber: "IS 9798",
    product:
      "เครื่องควบคุมแรงดันต่ำสำหรับใช้กับส่วนผสมแก๊สปิโตรเลียมเหลว (LPG)",
    notification: {
      title: "8. พระราชบัญญัติวัตถุระเบิด พ.ศ. 2427 กฎระเบียบถังแก๊ส พ.ศ. 2559",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/S.O 1081 (E).pdf",
      linkText: "G.S.R. No. 1081(E) วันที่ 22-11-2016",
  ...
  },
  {
    id: 75,
    sno: " ",
    isNumber: "อุปกรณ์ทางการแพทย์",
    product: "อุปกรณ์ทางการแพทย์",
    isSectionHeader: true,
  },
  {
    id: 76,
    ...
    product: "เทอร์โมมิเตอร์คลินิก: ส่วนที่ 1 แบบก้านแข็ง",
    notification: {
      title: "9. เทอร์โมมิเตอร์คลินิก (การควบคุมคุณภาพ) พ.ศ. 2544",
  ...
  },
  {
    ...
    product: "เทอร์โมมิเตอร์คลินิก: ส่วนที่ 2 แบบสเกลปิด",
    notification: {
      title: "9. เทอร์โมมิเตอร์คลินิก (การควบคุมคุณภาพ) พ.ศ. 2544",
      link: "https://www.bis.gov.in/MandatoryProducts/QCOrder/GSR No. 843 (E).pdf",
      linkText: "GSR No. 843(E) dated 9 Nov. 2001",
  ...
  },
  {
    ...
    product: "อุปกรณ์เอกซเรย์ทางการแพทย์เพื่อการวินิจฉัย",
    notification: {
      title: "10. อุปกรณ์เอกซเรย์ทางการแพทย์เพื่อการวินิจฉัย",
  ...
  },
  {
    id: 79,
    sno: " ",
    isNumber: "ผลิตภัณฑ์เหล็กและเหล็กหล่อ",
    product: "ผลิตภัณฑ์เหล็กและเหล็กหล่อ",
    isSectionHeader: true,
  },
  {
    id: 80,
    ...
    product:
      "ลวดเหล็กคาร์บอนดึงเย็นสำหรับคอนกรีตอัดแรง: ส่วนที่ 1 ลวดดึงเย็นที่คลายความเค้น",
    notification: {
      title: "11. คำสั่งเหล็กและผลิตภัณฑ์เหล็ก (การควบคุมคุณภาพ) พ.ศ. 2567",
  ...
  },
  {
    ...
    product: "ลวดเหล็กคาร์บอนดึงเย็นสำหรับคอนกรีตอัดแรง ส่วนที่ 2: ลวดดึงเย็น",
    notification: {
      title: "11. คำสั่งเหล็กและผลิตภัณฑ์เหล็ก (การควบคุมคุณภาพ) พ.ศ. 2567",
      link: "https://www.bis.gov.in/wp-content/uploads/2024/02/Steel-Steel-Product-QCO-2024.pdf",
      linkText: "S.O. 574(E) dated on 5th February, 2024",
  ...
  },
  {
    ...
    product: "ลวดมีรอยบากสำหรับคอนกรีตอัดแรง",
    notification: {
      title: "11. คำสั่งเหล็กและผลิตภัณฑ์เหล็ก (การควบคุมคุณภาพ) พ.ศ. 2567",
      link: "https://www.bis.gov.in/wp-content/uploads/2024/02/Steel-Steel-Product-QCO-2024.pdf",
      linkText: "S.O. 574(E) dated on 5th February, 2024",
  ...
  },
  {
    ...
    product: "สายลวดคลายความเค้นไม่เคลือบสำหรับคอนกรีตอัดแรง",
    notification: {
      title: "11. คำสั่งเหล็กและผลิตภัณฑ์เหล็ก (การควบคุมคุณภาพ) พ.ศ. 2567",
      link: "https://www.bis.gov.in/wp-content/uploads/2024/02/Steel-Steel-Product-QCO-2024.pdf",
      linkText: "S.O. 574(E) dated on 5th February, 2024",
