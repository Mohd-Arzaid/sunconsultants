...
const RefinedZincBlogBreadcrumb = () => {
    return (
                            ...
                            <BreadcrumbList className="flex-nowrap">
                                ...
                                <BreadcrumbItem className="flex-shrink-0">
                                    <BreadcrumbPage className="whitespace-nowrap">
                                        BIS Certification for Refined Zinc under IS 209:2024
                                    </BreadcrumbPage>
...
const RefinedZincBlogMainContent = () => {
    return (
        ...
        <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
            ...
            <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
                ...
                <h1 className="text-xl md:text-2xl font-playfair font-bold text-[#1e1e1e] mb-4">
                    BIS Certification for Refined Zinc under IS 209:2024: Everything Manufacturers Need to Know
                </h1>
                ...
                <p className="text-gray-600 text-base font-geist mb-4">
                    ...
                    is now compulsory to continue manufacturing, selling, or distributing refined zinc in the Indian market.
                </p>
                ...
                {/* Next Section */}
                <h2 className="text-xl font-geist font-bold text-[#1e1e1e] mb-4">
                    Why Refined Zinc Need BIS Certification Now
                </h2>

                <p className="text-gray-600 text-base font-geist mb-4">
                    The introduction of IS 209:2024 underlines the government&apos;s intention to streamline product quality across industries.
                </p>
                ...
                <p className="text-gray-600 text-base font-geist mb-6">
                    The BIS Notification about this change emphasizes that no manufacturer can market refined zinc without a BIS license after 17th October 2025.
                </p>
                ...
                <p className="text-gray-600 text-base font-geist mb-6">
                    The BIS requires manufacturers to test refined zinc at BIS-recognized laboratories. The results must meet the criteria under IS 209:2024.
                </p>
                ...
                <p className="text-gray-600 text-base font-geist mb-4">
                    Once everything is verified, BIS grants the certification, allowing you to continue producing and selling refined zinc in India.
                </p>

                <p className="text-gray-600 text-base font-geist mb-6">
                    This structured BIS Certificate Process ensures only high-quality refined zinc reach the market.
                </p>
                ...
                {/* Key Points */}
                <ul className="list-disc list-inside text-base font-geist text-gray-600 space-y-2 mb-4">
                    <li>BIS Notification states that Refined Zinc must comply with IS 209:2024 from 17th October 2025.</li>
                ...
                <p className="text-gray-600 text-base font-geist mb-4">
                    The mandatory BIS Certification for Refined Zinc under IS 209:2024 is a crucial step in ensuring product quality and consumer safety. From understanding What is BIS Certificate to navigating the BIS Certificate Process and managing the Cost of BIS Certification, every manufacturer must stay informed and prepared.
                </p>
                ...
                <div className="mt-8 rounded-xl overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
                    <iframe
                        src="/BIS-Product-Pdf/IS-209-2024-Sun-Certifications-India.pdf"
                        title="BIS Certificate for Refined Zinc - IS 209:2024 PDF"
...
const RefinedZincBlogContentRight = () => {
