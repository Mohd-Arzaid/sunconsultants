...
const USABlogMetaData = () => {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://bis-certifications.com/bis-certification-in-usa",
        },
        headline: "BIS Certification in USA",
        description:
            "BIS Certification in USA is a legal requirement for the manufacturers looking to export their products to India, ensuring that their products meet the required safety and quality standards.",
        author: {
            "@type": "Person",
            name: "Dhruv Aggarwal",
