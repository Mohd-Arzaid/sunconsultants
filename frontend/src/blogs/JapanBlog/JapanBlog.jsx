...
const JapanBlogMetaData = () => {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://bis-certifications.com/bis-certification-in-japan",
        },
        headline: "BIS Certification in Japan",
        description:
            "BIS Certification in Japan is a strategic advantage that builds brand credibility, ensures customer trust, and unlocks access to one of the world's largest market.",
        author: {
            "@type": "Person",
            name: "Dhruv Aggarwal",
