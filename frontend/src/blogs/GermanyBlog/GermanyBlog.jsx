...
const GermanyBlogMetaData = () => {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://bis-certifications.com/bis-certification-in-germany",
        },
        headline: "BIS Certification in Germany",
        description:
            "BIS certification in Germany could be a critical factor for the manufacturers looking to export their products in India, helping manufacturers gain market access.",
        author: {
            "@type": "Person",
            name: "Dhruv Aggarwal",
