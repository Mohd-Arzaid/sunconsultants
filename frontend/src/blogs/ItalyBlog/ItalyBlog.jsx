...
const ItalyBlogMetaData = () => {
    ...
    const articleSchema = {
        ...
        mainEntityOfPage: {
            "@type": "WebPage",
            "@id": "https://bis-certifications.com/bis-certification-in-italy",
        },
        headline: "BIS Certification in Italy",
        description:
            "BIS Certification in Italy is mandatory for manufacturers exporting specific goods to India, managed via the Foreign Manufacturers Certification Scheme (FMCS).",
        author: {
            "@type": "Person",
            name: "Dhruv Aggarwal",
