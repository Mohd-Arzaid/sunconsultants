...
const AboutAuthor = () => {
    return (
        <section className="">
            <div className="relative overflow-hidden bg-gradient-to-br from-[#F9F7F2] via-white to-[#F9F7F2] border border-gray-200 rounded-xl p-6 md:p-8 shadow-md hover:shadow-lg transition-all duration-300 group">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2">
                                ...
                                >
                                    ...
                                    <span className="font-geist text-[14px] md:text-[18px] text-[#42434d]">
                                        <span className="font-medium">LinkedIn:</span> Connect with me
                                    </span>
                                </a>
                                ...
                                >
                                    ...
                                    <span className="font-geist text-[14px] md:text-[18px] text-[#42434d]">
                                        <span className="font-medium">Contact:</span> admin@indiancertifications.com
                                    </span>
                                </a>
                            </div>
                        </div>
