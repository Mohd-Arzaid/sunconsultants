...
const ServiceContentRightNABL = ({ whatsappMode = false }) => {
    ...
    return (
        <div className="flex flex-col gap-6 w-full md:w-[360px] ">
            ...
            <FreeCallBack whatsappMode={whatsappMode} />
        </div>
    );
};
...
const FreeCallBack = ({ whatsappMode = false }) => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (whatsappMode) {
            ...
            const whatsappUrl = `https://wa.me/+918010505057?text=${encodeURIComponent(
                message
            )}`;
...
export default ServiceContentRightNABL;