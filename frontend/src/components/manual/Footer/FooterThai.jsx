          ...
          <div className="flex justify-center w-full">
            <div className="flex gap-6 flex-wrap items-center justify-center">
              <a
                ...
                aria-label="ติดต่อเราผ่าน WhatsApp"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                aria-label="โทรหาเราที่ +91 80105 05057"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="เยี่ยมชมหน้า LinkedIn ของเรา"
              >
                <svg
                  stroke="currentColor"
                  fill="currentColor"
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <div className="relative">
                  ...
                  <button className="flex items-center justify-center h-7 px-2 py-1.5 gap-x-1 text-[13px] md:text-[15px] whitespace-nowrap font-medium font-geist border rounded-full transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 absolute right-1 top-1 border-none bg-white">
                    <div className="text-[#2a5075]">แจ้งเตือนฉัน</div>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row  items-center mt-6 md:mt-4 mb-4 gap-4 md:gap-0 md:justify-between">
            <div className="flex gap-3 flex-wrap items-center justify-center">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="เยี่ยมชมโปรไฟล์ GitHub ของเรา"
              >
              ...
              <a
                href="mailto:admin@bis-certifications.com?body=สวัสดี"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <span className="text-[#2a5075] font-geist text-[13px] md:text-base text-center">
              ลิขสิทธิ์ © 2025 Sun Certifications India. สงวนลิขสิทธิ์ทั้งหมด
            </span>
