...
import { Globe, Clock, Phone, User, Mail, MessageCircle, SendHorizontal, PhoneCall } from "lucide-react";
...
const AboutContact = () => {
    ...
    useEffect(() => {
        ...
        setFormData((prev) => ({ ...prev, pageUrl: window.location.href, pageName: getPageName() }));
    }, []);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`${BASE_URL}/contact/submit-contact`, formData);
                        ...
                        <div className="mt-6 md:mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                            <div className="flex items-center justify-center sm:justify-start gap-4 md:gap-5">
                                ...
                                <div className="flex flex-col">
                                    <span className="font-geist text-base md:text-lg text-[#1e1e1e] font-medium">Global Reach</span>
                                    <span className="font-geist text-sm text-gray-600">20+ countries</span>
                                </div>
                            </div>
                            <div className="flex items-center justify-center sm:justify-start gap-4 md:gap-5">
                                <div className="w-11 h-11 rounded-full bg-[#1A8781]/15 border border-[#1A8781]/30 flex items-center justify-center">
                                ...
                                <div className="flex flex-col">
                                    <span className="font-geist text-base md:text-lg text-[#1e1e1e] font-medium">Fast Response</span>
                                    <span className="font-geist text-sm text-gray-600">Within 24 hours</span>
                                </div>
                            </div>
                    ...
                    <div className="p-6 md:p-10 bg-white/90 backdrop-blur-sm">
                        ...
                        <div className="md:hidden">
                            ...
                            <p className="text-sm text-gray-600 font-geist mb-5">
                                We simplify compliance so you can focus on growth. Share your details and our team will get back within 24 hours.
                            </p>
                        ...
                        <div className="hidden md:block bg-white/90 backdrop-blur-sm rounded-2xl p-5">
                            <form onSubmit={handleFormSubmit} className="flex flex-col gap-4">
                                <div>
                                    <label htmlFor="fullName" className="block font-geist text-sm md:text-base text-[#1e1e1e] mb-1">
                                        Full Name
                                    </label>
                                    <input
                                        id="fullName"
                                ...
                                <div>
                                    <label htmlFor="email" className="block font-geist text-sm md:text-base text-[#1e1e1e] mb-1">
                                        Email Address
                                    </label>
                                    <input
                                        id="email"
                                ...
                                <div>
                                    <label htmlFor="phoneNumber" className="block font-geist text-sm md:text-base text-[#1e1e1e] mb-1">
                                        Phone Number
                                    </label>
                                    <input
                                        id="phoneNumber"
                                ...
                                <div>
                                    <label htmlFor="message" className="block font-geist text-sm md:text-base text-[#1e1e1e] mb-1">
