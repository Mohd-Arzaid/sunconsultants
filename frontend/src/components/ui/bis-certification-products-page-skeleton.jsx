...
const BISCertificationProductsPageSkeleton = () => {
  return (
            ...
            <div className="relative p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] overflow-hidden">
              ...
              <div className="relative space-y-6">
                ...
                <div className="space-y-2">
                  <Skeleton className="h-6 md:h-7 w-full max-w-[90%] rounded-md" />
                  <Skeleton className="h-6 md:h-7 w-full max-w-[75%] rounded-md" />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6 md:mt-8 overflow-x-auto rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075]">
                    {/* Table Header */}
                    <div className="grid grid-cols-2 gap-4 p-4 bg-gradient-to-br from-blue-100/50 to-indigo-100/50">
                    ...
                    {[1, 2, 3, 4, 5, 6, 7, 8].map((row) => (
                      <div
                        key={row}
                        className="grid grid-cols-2 gap-4 p-4 border-b border-gray-200/30"
                      >
            ...
            <div className="mt-16 md:mt-24 grid grid-cols-2 md:grid-cols-4 gap-x-3 md:gap-x-10 px-4 md:px-0 gap-y-12 md:gap-y-24">
              {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
                ...
                >
                  ...
                  <Skeleton className="h-4 md:h-5 w-3/4 mx-auto mt-8 md:mt-28 rounded-md" />
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex w-max gap-6 py-4">
            {[1, 2, 3, 4, 5].map((index) => (
              ...
              >
                {/* YouTube Video Thumbnail Area Skeleton */}
...
export default BISCertificationProductsPageSkeleton;
