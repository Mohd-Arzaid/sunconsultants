  ...
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        ...
        เกณฑ์มาตรฐานคุณภาพสำหรับผลิตภัณฑ์ที่ขายในอินเดีย การรับรองเครื่องหมาย
        ISI เป็นหนึ่งในใบรับรองที่มีชื่อเสียงที่สุดที่ได้รับภายใต้ BIS
      </p>
      <p className="service-left-content-paragraph">
        สำหรับผู้ผลิตในประเทศ การได้รับใบรับรอง BIS ISI Mark
        ไม่ได้เป็นเพียงการได้รับใบรับรองการปฏิบัติตามกฎระเบียบเท่านั้น
        แต่ยังเกี่ยวกับการได้รับการยอมรับในตลาด ความมั่นใจในแบรนด์
        และการปกป้องทางกฎหมาย เครื่องหมาย ISI
        ถูกยอมรับอย่างแพร่หลายและเสริมสร้างความน่าเชื่อถือในอินเดีย
      ...
      <p className="service-left-content-paragraph">
        ...
        ผู้ผลิตในประเทศ โดยเน้นถึงความสำคัญ ข้อกำหนด ข้อดี
        และกระบวนการทั้งหมดของการได้รับใบรับรอง
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        การรับรองในอินเดียภายใต้กระทรวงการแข่งขันและ สาธารณะ
        ในฐานะหน่วยงานกำกับดูแล มันกำหนดและรักษามาตรฐานของ
        คุณภาพและการบังคับใช้ในอุตสาหกรรมต่างๆ ตามที่กำหนดภายใต้ พระราชบัญญัติ
        BIS ปี 1986
      </p>
      <p className="service-left-content-paragraph">
      ...
      <p className="service-left-content-paragraph">
        ...
        การยืนยันว่าผลิตภัณฑ์ตรงตามข้อกำหนดพื้นฐานของมาตรฐานคุณภาพ ที่กำหนดโดย
        BIS ในเรื่องความปลอดภัย คุณภาพ ประสิทธิภาพ และ ความน่าเชื่อถือ{" "}
      </p>
      <p className="service-left-content-paragraph">
        ...
        เป็นเครื่องมือสำหรับความไว้วางใจระหว่าง ผู้บริโภคและผู้ผลิต
        และเครื่องหมายนี้เกินมาตรฐาน
      </p>
      <p className="service-left-content-paragraph">
        ตัวอย่างผลิตภัณฑ์บางส่วนที่ต้องการการรับรอง ISI บังคับคือ ดังนี้:{" "}
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        การรับรองเพื่อใช้เครื่องหมายมาตรฐาน (ISI Mark) ภายใต้โครงการ I ตาราง I
        ของสำนักมาตรฐานอินเดีย ผลิตภัณฑ์ที่เก็บไว้ภายใต้
      ...
      <p className="service-left-content-paragraph">
        <strong>เครื่องหมาย ISI :</strong>{" "}
        สัญลักษณ์คุณภาพหรือเครื่องหมายมาตรฐานที่
      ...
      <p className="service-left-content-paragraph">
        การรับรอง BIS ISI Mark มีค่าสำคัญสำหรับ ผู้ผลิตในประเทศ เช่น:
      </p>
      ...
      <p className="service-left-content-paragraph">
        <strong>2. ความไว้วางใจของผู้บริโภค:</strong> ผลิตภัณฑ์ที่มีป้ายกำกับ
        ISI เครื่องหมายโดยทั่วไปถือว่าปลอดภัยและมีประสิทธิภาพ นี่
      ...
      <p className="service-left-content-paragraph">
        ...
        สิ่งของมากมายที่ถูกห้ามอย่างเคร่งครัดหากบุคคลไม่มี ใบรับรอง ISI
        ที่ถูกต้อง ในกรณีดังกล่าว เครื่องหมาย ISI ทำหน้าที่เป็น
      ...
      <p className="service-left-content-paragraph">
        <strong>6. การส่งเสริมการส่งออก:</strong> ผลิตภัณฑ์ที่ได้รับการรับรอง
        ISI
      ...
      <p className="service-left-content-paragraph">
        ...
        การรับรองรับประกันความปลอดภัยของผู้บริโภคจากความเสี่ยงใดๆ อันตราย
        อุบัติเหตุ หรือประสิทธิภาพผลิตภัณฑ์ที่ไม่ดี
      </p>

      <p className="service-left-content-paragraph">
        <strong>8. การควบคุมคุณภาพ:</strong>{" "}
        ความต้องการในการดำเนินการอย่างต่อเนื่อง
...
const DocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        ตามข้อบังคับ 11 ของ BIS (การประเมินการปฏิบัติตาม) ข้อบังคับ 2018
        ไม่มีข้อสงสัยว่าใบอนุญาตสามารถระงับหรือยกเลิกได้สำหรับ
  ...
  return (
    <div id="conclusion" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        ...
        ช่วยในการสร้างชื่อเสียงเชิงบวกและบรรลุความยั่งยืน การเติบโตในธุรกิจ
        หากปฏิบัติตามมาตรฐาน BIS ก็จะมี
        การรับประกันที่ผ่านการรับรองสูงสุดว่าผลิตภัณฑ์น่าเชื่อถือและพร้อมสำหรับ
        ขาย
      </p>

      <p className="service-left-content-paragraph">
        โดยสรุป เครื่องหมาย ISI ได้กลายเป็นมากกว่าแค่กฎหมาย การปฏิบัติตามกฎหมาย
        มันกลายเป็นเครื่องหมายของการรับประกันในสภาพแวดล้อมทางธุรกิจ
      ...
      <p className="service-left-content-paragraph">
        ...
        ผลิตภัณฑ์อื่นๆ สำหรับขาย การรับรอง BIS ISI รับประกันว่าผลิตภัณฑ์ของคุณ
