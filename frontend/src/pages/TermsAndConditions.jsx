  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Read the Terms and Conditions for Sun Certifications India's BIS certification and regulatory compliance services."
        />
        <link
          rel="canonical"
          href="https://bis-certifications.com/terms-and-conditions"
        />
        <meta
          property="og:url"
          content="https://bis-certifications.com/terms-and-conditions"
        />
      </Helmet>
        ...
        <div className="bg-white pt-10">
          <div className="max-w-[88rem] mx-auto px-4 md:px-12">
            ...
            <p className="mt-3 max-w-3xl mx-auto text-lg text-center md:text-xl text-neutral-500 font-geist leading-relaxed">
              ...
              services. By accessing or using Sun Certifications India, you
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-10 md:mb-12">
              <p className="text-lg md:text-xl text-neutral-600 font-geist leading-relaxed">
                These Terms and Conditions govern your use of Sun Certifications
                India&apos;s services and website. By using our services, you
            ...
            <div className="mb-10 md:mb-12">
              ...
              <ul className="space-y-3 ml-4 md:ml-6">
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 rounded-full bg-neutral-700 mr-3 mt-3 shrink-0"></span>
                  <span className="text-base md:text-lg text-neutral-600 font-geist leading-relaxed">
                    To impersonate or attempt to impersonate Sun Certifications
                    India, a Sun Certifications India employee, another user, or
            ...
            <div className="mb-10 md:mb-12">
              ...
              <p className="text-base md:text-lg text-neutral-600 font-geist leading-relaxed">
                ...
                functionality are and will remain the exclusive property of Sun
                Certifications India and its licensors. The Service is protected
                by copyright, trademark, and other laws of both India and
                ...
                written consent of Sun Certifications India.
              </p>
            </div>
            ...
            <div className="mb-10 md:mb-12">
              ...
              <p className="text-base md:text-lg text-neutral-600 font-geist leading-relaxed">
                In no event shall Sun Certifications India, nor its directors,
                ...
                information stored therein; (iii) any interruption or cessation
                of transmission to or from the Service; (iv) any bugs, viruses,
                trojan horses, or the like that may be transmitted to or through
                our Service by any third party; (v) any errors or omissions in
                any content or for any loss or damage incurred as a result of
                the use of any content posted, emailed, transmitted, or
                otherwise made available through the Service; and/or (vi) any
                user content or defamatory, offensive, or illegal conduct of any
                third party.
              </p>
            </div>
            ...
            <div className="text-center mt-12 md:mt-16 p-8 md:p-12 bg-gradient-to-r from-neutral-50 to-neutral-100 rounded-lg border border-neutral-200">
              ...
              <p className="text-base md:text-lg text-neutral-600 font-geist leading-relaxed mb-6">
                We&apos;re here to help clarify any concerns about our terms and
                conditions.
              </p>
              <Link
                to="/contact"
