...
const productsData = [
  ...
  {
    id: 8,
    product: "入力電力200W以上の内蔵アンプ付き光学ディスクプレーヤー",
    isNumber: "IS 616:2017",
    date: "03 July 2013",
  },
  {
  ...
  {
    id: 46,
    product: "結晶シリコン地上用太陽光発電（PV）モジュール（Siウェーハベース）",
    isNumber:
  ...
  {
    id: 47,
    product: "薄膜地上用太陽光発電（PV）モジュール（a-Si、CiGs、CdTe）",
    isNumber:
  ...
  {
    id: 60,
    product: "出力電圧48V（最大）のスタンドアロンスイッチモード電源（SMPS）",
    isNumber: "IS 13252 (Part 1) : 2010",
    date: "01 April 2021",
  },
  {
    ...
    <section className="w-full pb-12 product-table-section">
      <div className="max-w-[88rem] mx-auto px-4 md:px-12">
        ...
        <p className="font-geist text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-loose mb-8">
          以下の表は、インドでBIS
          CRS登録が必要な製品と、適用されるインド規格（IS）番号および実施日をリストアップしています。
        </p>
...
const CRSRegistrationJapaneseServiceFaq = () => {
  ...
  const allFaqs = [
    ...
    {
      id: "item-13",
      question: "13. 必須製品についてBIS登録を取得しないとどうなりますか？",
      answer:
    ...
    },
    {
      id: "item-14",
      question:
        "14. 1つのBIS証明書で複数のモデルやブランドをカバーできますか？",
      answer:
    ...
    <div className="flex-1">
      <div className="flex flex-col gap-[20px] md:gap-[40px]">
        <div className="flex flex-col gap-2">
          ...
          <p className="service-left-content-paragraph">
            インド製品の性能と安全性は、インドにとって重要な問題です。BIS
            CRS認証は、電子機器およびIT製品がインド規格に準拠していることを保証し、消費者を非準拠および粗悪な製品から保護するのに役立ちます。
          </p>
        </div>
...
const CRSRegistrationJapaneseMainContentLeftELabellingSection = () => {
  return (
    <div id="elabelling" className="flex flex-col scroll-mt-20">
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="font-geist text-sm md:text-lg text-left tracking-wide leading-loose max-w-full">
                  製品ボックスまたは外部パッケージングにはBIS
                  CRSロゴと登録詳細を表示する必要があります。
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium font-geist text-sm md:text-lg text-left border-r border-gray-200 bg-gray-50 tracking-wide leading-loose max-w-full">
      ...
      <p className="service-left-content-paragraph">
        全体のBIS
        CRS登録は、ルールと文書の量に関して非常に技術的で包括的です。インド規格、最近のQCO、テストレポートの構造、ポータルインターフェースのワークフローに対する徹底的な理解がない場合、申請者は遅延、却下、または長期間の積極的な非準拠という後続の行動において大幅に損失を被る可能性があります。ここでSun
        Certifications
        Indiaが信頼できる信頼できるパートナーとして、強制認証スキームのあらゆる詳細で申請者を支援します。
      </p>
    </div>
  );
};
...
const CRSRegistrationJapaneseMainContentLeftRegistrationSection = () => {
  return (
    <div id="registration" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS
        CRS登録は、BIS登録ポータルを通じた完全オンラインプロセスです。文書のアップロードを含む手順だけではありません。技術的な性質の特別な注意、規制の理解、およびインド規格（IS）への完全な準拠も必要です。
      </p>

      <p className="service-left-content-paragraph">
        BIS
        CRSプロセス、現在は認証・登録システム（CRS）と呼んでいますが、BIS認証の旅がどのように展開するかを以下に示します。
      </p>
      ...
      <PointsListWithoutHeading
        points={["BIS登録番号", "ブランド名", "製品のモデル", "IS規格コード"]}
      />
...
const CRSRegistrationJapaneseMainContentLeftDocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS
        CRS登録申請の記入は完全にデジタルですが、承認を得るためには完全に完成した文書が必要です。文書タイプ、不適切な形式、間違ったファイルタイプなどのあらゆる側面に従わない細かなミスや失敗は、申請が却下されたり遅延したりする原因となる可能性があります。
      </p>
...
const CRSRegistrationJapaneseMainContentLeftEligibilitySection = () => {
  return (
    <div id="eligibility" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        インドでは、強制登録スキーム（CRS）の下でのBIS証明書は、インド標準局が定めた要件を満たす製造業者のみに付与されます。これにより、真正な製造業者のみが登録し、製品にBIS
        CRSロゴを貼付する特権を得ることが保証されます。
      </p>
...
const CRSRegistrationJapaneseMainContentLeftOverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        インドの生産者、またはインド市場に参入しようとしている外国企業の場合、BIS
        CRSのステップを知ることは必須です。これにより以下が可能になります：
      </p>
...
const CRSRegistrationJapaneseMetaTags = () => {
  ...
  return (
    <Helmet>
      ...
      <meta
        name="description"
        content="BIS登録とは、CRS制度の下で適用されるインド規格に準拠した電子・IT製品について、BISからライセンスを取得することです。"
      />
      <meta
        name="keywords"
        content="BIS証明書, BIS登録プロセス, BIS登録, BISオンライン登録プロセス, 電子製品のBIS認証, インドのBIS登録プロセス, 電子製品のBIS登録, 強制登録制度"
      />
