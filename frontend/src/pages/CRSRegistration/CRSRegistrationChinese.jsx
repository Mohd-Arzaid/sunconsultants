    ...
    <div className="flex-1">
      <div className="flex flex-col gap-[20px] md:gap-[40px]">
        <div className="flex flex-col gap-2">
          <h2 className="service-left-content-heading-two">BIS注册是什么？</h2>
          ...
          <p className="service-left-content-paragraph">
            印度产品的性能和安全对印度来说是一个重要问题。BIS
            CRS认证保证电子和IT产品符合印度标准，并有助于保护消费者免受不合规和劣质产品的侵害。
          </p>
        </div>
...
const CRSRegistrationMainContentLeftOverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        如果您是印度的生产商，或试图进入印度市场的外国公司，了解BIS
        CRS步骤是必须的。它可以帮助您：
      </p>
...
const CRSRegistrationMainContentLeftEligibilitySection = () => {
  return (
    <div id="eligibility" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        在印度，强制注册计划（CRS）下的BIS证书只能授予符合印度标准局规定要求的制造商。这是为了确保只有真正的制造商才能获得注册并在其产品上粘贴BIS
        CRS标志的特权。
      </p>

      <div className="service-left-content-heading-three">资格标准清单</div>
      ...
      <div className="service-left-content-heading-three">AIR的职责：</div>
      ...
      <div className="service-left-content-heading-three">真实场景：</div>
...
const CRSRegistrationMainContentLeftDocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        填写BIS
        CRS注册申请完全是数字化的，但是，它仍然需要完全完成的文件才能获得批准。每一个细微的错误和未能遵守任何方面，如文件类型、格式不当或错误的文件类型，都可能导致申请被拒绝或延迟。
      </p>
...
const CRSRegistrationMainContentLeftRegistrationSection = () => {
  return (
    <div id="registration" className="flex flex-col scroll-mt-20">
      {/* Registration */}
      <div className="flex w-full items-center gap-3">
        <span className="service-left-content-index-heading">注册流程</span>
        <Separator className="service-left-content-separator" />
      </div>

      <h2 className="service-left-content-heading-two">BIS CRS注册流程</h2>

      <p className="service-left-content-paragraph">
        BIS
        CRS注册是通过BIS注册门户完全在线进行的流程。它不仅仅是包括上传文件的程序。它还需要特别注意技术性质、对法规的理解以及对印度标准（IS）的完全合规。
      </p>
      ...
      <div className="service-left-content-heading-three">步骤2：文件准备</div>
      ...
      <PointsListWithoutHeading
        points={["如果BIS官员对他们进行的评估结果满意，将颁发BIS证书"]}
      />

      <p className="service-left-content-paragraph">您的证书将包括：</p>

      <PointsListWithoutHeading
        points={["BIS注册号", "品牌名称", "产品型号", "IS标准代码"]}
      />

      <PointsListWithoutHeading
        points={["您的产品标签必须包含或具有证书详情的电子标签。"]}
      />
      ...
      <h3 className="service-left-content-heading-three">大致时间表</h3>
...
const CRSRegistrationMainContentLeftFeesSection = () => {
  return (
    <div id="fees" className="flex flex-col scroll-mt-20">
      {/* Fees */}
      <div className="flex w-full items-center gap-3">
        <span className="service-left-content-index-heading">注册费用</span>
        <Separator className="service-left-content-separator" />
      </div>
      ...
      <h3 className="service-left-content-heading-three">CRS注册费用结构</h3>
...
const CRSRegistrationMainContentLeftELabellingSection = () => {
  return (
    <div id="elabelling" className="flex flex-col scroll-mt-20">
      ...
      <div className="service-left-content-heading-three">
        BIS关于电子标签的指南：电子标签（BIS CMD 3/8:1/6975.
        日期：2015年12月3日）
      </div>

      <h3 className="service-left-content-heading-three">电子标签的要求：</h3>
      ...
      <p className="service-left-content-paragraph">
        整个BIS
        CRS注册在规则和文件量方面都非常技术性和详尽。如果对印度标准、最近的QCO、测试报告的结构以及门户界面中的工作流程缺乏透彻的理解，申请人可能会在后续的延迟、拒绝或长期主动不合规方面遭受重大损失。这就是太阳认证印度发挥作用的地方，提供值得信赖和可靠的合作伙伴，协助申请人处理强制认证计划的每一个细节。
      </p>
    </div>
  );
};
...
const CRSRegistrationServiceFaq = () => {
  ...
  const allFaqs = [
    ...
    {
      id: "item-13",
      question: "13. 如果我没有为强制性产品获得BIS注册会怎样？",
      answer:
