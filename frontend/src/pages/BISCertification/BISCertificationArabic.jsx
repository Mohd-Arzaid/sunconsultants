...
const OverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        شهادة BIS هي علامة الجودة الوطنية للهند الصادرة عن مكتب المعايير
        الهندية، الهيئة الوطنية للشهادة في الهند تحت وزارة شؤون المستهلك. تضمن
        شهادة BIS أن المنتج يتوافق مع المعايير الهندية (IS) فيما يتعلق بالأداء
        والسلامة والجودة، مما يسمح للمصنعين (الهنديين أو الأجانب) باستخدام
        العلامة القياسية للوصول إلى السوق، بما يتضمن الاختبارات والتدقيق.
      </p>
      <p className="service-left-content-paragraph">
  ...
  return (
    <div id="process" className="flex flex-col scroll-mt-20">
      ...
      <h2 className="service-left-content-heading-two">
        إجراءات الحصول على شهادة BIS
      </h2>

      <p className="service-left-content-paragraph">
        عادةً ما تتبع عملية الحصول على شهادة BIS للمصنعين الهنود والأجانب
        الخطوات الرئيسية التالية:
      </p>

      <PointsListWithoutHeading
        points={[
          "تحديد المعيار المطبق: تحديد المعيار الهندي (IS) المناسب للمنتج.",
          "إنشاء مرافق الاختبار: إعداد مختبر داخلي يطابق متطلبات المعيار المطبق.",
          "إنشاء حساب على بوابة BIS: يجب على المصنعين في الهند التسجيل في بوابة BIS الإلكترونية لبدء الطلب.",
          "اختبار المنتج: اختبار المنتج وفقاً لمواصفات المعيار الهندي المطبق (ISS).",
          "تقديم الطلب: تقديم طلب BIS مع تقرير الاختبار والمستندات المطلوبة.",
          "الرد على الاستفسارات: الرد على أي توضيحات أو استفسارات يطرحها مسؤولو BIS.",
          "تفتيش المصنع: يقوم مسؤول BIS بزيارة منشأة التصنيع للتحقق من الامتثال وفحص عملية الإنتاج.",
          "التحقق من العينات: أثناء التفتيش، يتم اختبار العينات في المختبر الداخلي وختمها لإعادة التحقق من قبل مسؤول BIS.",
          "إكمال التدقيق: بعد الانتهاء من التفتيش وأنشطة التحقق، يتم إغلاق/إتمام التدقيق.",
          "منح الترخيص: عند استيفاء جميع المتطلبات، يمنح BIS ترخيص شهادة الاعتماد للمصنّع.",
        ]}
      />

      <h3 className="service-left-content-heading-three mt-5">
        تكلفة شهادة BIS ورسوم الترخيص
      </h3>

      <p className="service-left-content-paragraph">
        تختلف تكلفة الحصول على شهادة BIS حسب عدة عوامل، بما في ذلك فئة المنتج،
        والمعيار الهندي (IS) المطبق، وما إذا كان المصنع داخل الهند أو خارجها.
      </p>

      <h3 className="service-left-content-heading-three mt-5">
        هيكل الرسوم لتسجيل BIS (CRS)
      </h3>

      <PointsListWithoutHeading
        points={[
          "الرسوم الحكومية: ₹53,000 + ‎18%‎ GST لكل تقرير اختبار. ويتم تحصيل ₹20,000 إضافية لكل تقرير اختبار إضافي يتم تقديمه ضمن نفس الطلب.",
          "رسوم الاختبار: وفقاً لأسعار المختبر، والتي تختلف حسب المنتج ومرفق الاختبار.",
        ]}
      />

      <p className="service-left-content-paragraph">
        ملاحظة: قد تكون الشركات المسجلة بموجب قانون MSME مؤهلة لبعض التخفيضات
        على الرسوم الحكومية.
      </p>

      <h3 className="service-left-content-heading-three mt-5">
        هيكل الرسوم لترخيص BIS (شهادة ISI)
      </h3>
      ...
      <PointsListWithoutHeading
        points={[
          "رسوم الطلب: ₹1,000",
          "رسوم الترخيص: ₹1,000",
          "رسوم التدقيق: ₹7,000 لكل يوم-فرد (man-day) لتفتيش المصنع",
          "رسوم الاختبار: حسب المنتج ومختبر الاختبار",
          "الحد الأدنى لرسوم الوسم/العلامة: يختلف حسب فئة المنتج.",
        ]}
      />

      <p className="service-left-content-paragraph">
        للمصنعين الأجانب، تُطبق رسوم إضافية ضمن مخطط اعتماد المصنعين الأجانب
        (FMCS). ويعتمد هيكل التكلفة الدقيق على الحالة المحددة والمتطلبات
        المطبقة.
      </p>
    </div>
  );
  ...
  const faqData = [
    {
      ...
      answer:
        "شهادة BIS هي شهادة ضمان الجودة الصادرة عن مكتب المعايير الهندية (BIS) لضمان امتثال المنتجات للمعايير الهندية للسلامة والأداء والجودة. وهي إلزامية لفئات منتجات مختلفة وتساعد في حماية المستهلك والامتثال التنظيمي.",
    },
    {
      question: "لماذا أحتاج إلى شهادة BIS؟",
      answer:
        "شهادة BIS ضرورية لتصنيع أو استيراد أو توزيع أو بيع منتجات معينة بشكل قانوني في الهند. وهي تطمئن المستهلكين بأن المنتج يلبي إرشادات السلامة والجودة للمعايير الهندية.",
    },
    {
      question: "ما هي علامة ISI تحت شهادة BIS؟",
      answer:
        "علامة ISI هي رمز شهادة يتم توفيره بموجب مخطط شهادة BIS. تشير إلى أن المنتج يمتثل للمعايير الهندية وتم اعتماده من قبل BIS الهندي من خلال الاختبار والتسجيل المناسبين.",
    },
    {
      question: "من يصدر تراخيص BIS في الهند؟",
      answer:
        "يتم إصدار تراخيص BIS من قبل مكتب المعايير الهندية (BIS الهندي)، وهيئة المعايير الوطنية تحت وزارة شؤون المستهلك والغذاء والتوزيع العام.",
    },
    {
      question: "ما هي أنواع مخططات شهادة BIS المختلفة؟",
      answer:
        "تشمل مخططات شهادة BIS الرئيسية مخطط علامة ISI، ومخطط التسجيل الإلزامي (CRS)، ومخطط شهادة الشركات المصنعة الأجنبية (FMCS)، ووضع العلامات للمجوهرات، وشهادة Eco Mark، وما هو المخطط X للآلات الصناعية.",
    },
    {
      question: "ما هو المخطط X تحت شهادة BIS؟",
      answer:
        "المخطط X هو عملية شهادة BIS مبسطة تنطبق على المنتجات الصناعية مثل المضخات والمحولات وأدوات الآلات والرافعات. يضمن الموافقة الأسرع دون المساس بالامتثال للمعايير الهندية.",
    },
    {
      question: "ما هي المنتجات التي تتطلب شهادة BIS في الهند؟",
      answer:
        "المنتجات مثل الأجهزة الكهربائية والإلكترونيات وأدوات المطبخ والأسمنت والصلب ومجوهرات الذهب والهواتف المحمولة والمحولات تتطلب شهادة BIS وفقًا لتفويض BIS الهندي.",
    },
    {
      question: "هل تسجيل BIS إلزامي لجميع المنتجات؟",
      answer:
        "لا، تسجيل BIS إلزامي فقط للمنتجات المدرجة في مخطط الشهادة الإلزامية. ومع ذلك، تتوفر أيضًا شهادة BIS الطوعية لتعزيز مصداقية المنتج.",
    },
    {
      question: "كم من الوقت تكون ترخيص BIS صالحًا؟",
      answer:
        "عادة ما يكون ترخيص BIS صالحًا لمدة عام إلى عامين ويجب تجديده قبل انتهاء صلاحيته لمواصلة استخدام علامة ISI أو الحفاظ على حالة تسجيل BIS.",
    },
    {
      question: "ما هي خطوات الحصول على شهادة BIS في الهند؟",
      answer:
        "تتضمن عملية شهادة BIS تحديد المعايير الهندية المعمول بها، وتقديم طلب، واختبار المنتج، وتفتيش المصنع، وإصدار شهادة BIS عند الموافقة.",
    },
    {
      question: "هل يمكن للشركات المصنعة الأجنبية التقدم للحصول على ترخيص BIS؟",
      answer:
        "نعم، بموجب مخطط شهادة الشركات المصنعة الأجنبية (FMCS)، يمكن للشركات الأجنبية التقدم للحصول على ترخيص BIS لبيع المنتجات في الهند. يجب عليهم تعيين ممثل هندي مخول (AIR).",
    },
    {
      question: "ما هو دور AIR في شهادة BIS؟",
      answer:
        "يعمل AIR (الممثل الهندي المخول) كحلقة وصل بين الشركة المصنعة الأجنبية وBIS الهندي. هم مسؤولون عن التوثيق والتواصل والامتثال لمتطلبات شهادة BIS.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "تشمل المستندات المطلوبة ترخيص الأعمال، ومواصفات المنتج، وعملية التصنيع، وتقارير اختبار المختبر، وتخطيط المصنع، ودليل الجودة، ونماذج التفويض (للشركات المصنعة الأجنبية).",
    },
    {
      question: "كم تكلفة شهادة BIS في الهند؟",
      answer:
        "تعتمد تكلفة شهادة BIS على نوع المنتج، ومتطلبات الاختبار، ونوع المخطط (ISI، CRS، FMCS)، وما إذا كان مقدم الطلب محليًا أم أجنبيًا. تشمل التكاليف رسوم الطلب، ورسوم الاختبار، ومصاريف التفتيش.",
    },
    {
      question: "هل علامة ISI إلزامية لجميع المنتجات المعتمدة من BIS؟",
      answer:
        "لا، فقط المنتجات تحت مخطط ISI مطلوبة لحمل علامة ISI. المنتجات تحت مخططات CRS أو وضع العلامات تتبع بروتوكولات وضع العلامات المختلفة وفقًا لقواعد تسجيل BIS.",
    },
    {
      question: "هل يمكنني الحصول على شهادة BIS للمنتجات الصديقة للبيئة؟",
      answer:
        "نعم، المنتجات التي تلبي المعايير البيئية يمكنها الحصول على شهادة BIS بموجب مخطط Eco Mark، والذي يضمن الامتثال للمعايير الهندية للسلامة البيئية.",
    },
    {
      question: "ما هو الفرق بين شهادة BIS وتسجيل BIS؟",
      answer:
        "تشير شهادة BIS بشكل عام إلى الموافقة بموجب مخططات ISI أو FMCS أو وضع العلامات، بينما يرتبط تسجيل BIS عادةً بمخطط CRS للمنتجات الإلكترونية.",
    },
    {
      question: "ما هو مخطط التسجيل الإلزامي (CRS)؟",
      answer:
        "CRS هو برنامج تسجيل BIS لسلع تكنولوجيا المعلومات والإلكترونيات مثل مصابيح LED والهواتف المحمولة وبنوك الطاقة. يضمن امتثال المنتج للمعايير الهندية المتعلقة بالسلامة.",
    },
    {
      question: "هل تعني علامة ISI وشهادة BIS نفس الشيء؟",
      answer:
        "ليس بالضبط. علامة ISI هي الرمز الممنوح للمنتجات المعتمدة بموجب مخطط شهادة BIS. شهادة BIS هي الوثيقة القانونية الصادرة للشركة المصنعة.",
    },
    {
      question: "هل يمكن لترخيص BIS واحد تغطية منتجات متعددة؟",
      answer:
        "لا، يلزم ترخيص BIS منفصل لكل نوع منتج وكل موقع تصنيع، حتى لو كانت المنتجات متشابهة.",
    },
    {
      question: "ماذا يحدث إذا قمت ببيع منتجات بدون شهادة BIS؟",
      answer:
        "بيع المنتجات التي تتطلب شهادة BIS بدون ترخيص BIS صالح غير قانوني في الهند ويمكن أن يؤدي إلى غرامات أو استدعاء المنتجات أو الحظر.",
    },
    {
      question: "كم من الوقت يستغرق الحصول على شهادة BIS؟",
      answer:
        "عادة ما تستغرق عملية شهادة BIS من 30 إلى 90 يومًا، اعتمادًا على نوع المنتج، ومتطلبات الاختبار، وما إذا كان مقدم الطلب محليًا أم أجنبيًا.",
    },
    {
      question: "هل يتم قبول شهادة BIS عالميًا؟",
      answer:
        "بينما شهادة BIS خاصة بالهند، فإنها تعزز المصداقية العالمية من خلال إظهار الامتثال للمعايير الهندية الصارمة. يتم قبول بعض المنتجات المعتمدة من BIS أيضًا بموجب اتفاقيات الاعتراف المتبادل.",
    },
    {
      question: "كم مرة أحتاج إلى تجديد ترخيص BIS الخاص بي؟",
      answer:
        "يجب تجديد تراخيص BIS سنويًا أو كل عامين. يجب على الشركات المصنعة الحفاظ على الامتثال للمعايير الهندية واجتياز عمليات التدقيق المراقبة لتجديد شهادة BIS الخاصة بهم.",
    },
  ];
