...
const OverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS 인증은 소비자 업무부 산하 인도의 국가 인증 기관인 인도 표준국(BIS)이 발행하는 인도의 국가 품질 마크입니다. BIS 인증은 제품이 성능, 안전성 및 품질 측면에서 인도 표준(IS)을 준수하도록 보장하며, 제조업체(인도 또는 외국)가 시장 접근을 위해 표준 마크를 사용할 수 있도록 하며, 테스트 및 감사를 포함합니다.
      </p>
      <p className="service-left-content-paragraph">
...
const BISCertificationFaq = () => {
  const faqData = [
    {
      question: "인도에서 BIS 인증이란 무엇입니까?",
      answer:
        "BIS 인증은 제품이 안전성, 성능 및 품질에 대한 인도 표준을 준수하도록 보장하기 위해 인도 표준국(BIS)에서 발급하는 품질 보증 인증입니다. 다양한 제품 카테고리에 필수이며 소비자 보호 및 규제 준수에 도움이 됩니다.",
    },
    {
      question: "BIS 인증서가 왜 필요합니까?",
      answer:
        "BIS 인증서는 인도에서 특정 제품을 합법적으로 제조, 수입, 유통 또는 판매하는 데 필수적입니다. 제품이 인도 표준의 안전성 및 품질 지침을 충족한다는 것을 소비자에게 보장합니다.",
    },
    {
      question: "BIS 인증 하에서 ISI 마크란 무엇입니까?",
      answer:
        "ISI 마크는 BIS 인증 제도 하에서 제공되는 인증 기호입니다. 제품이 인도 표준을 준수하며 적절한 테스트 및 등록을 통해 인도 BIS에 의해 인증되었음을 나타냅니다.",
    },
    {
      question: "인도에서 BIS 라이선스를 발급하는 곳은 어디입니까?",
      answer:
        "BIS 라이선스는 소비자 사무, 식품 및 공공 유통부 산하 국가 표준 기관인 인도 표준국(인도 BIS)에서 발급합니다.",
    },
    {
      question: "BIS 인증 제도의 다양한 유형은 무엇입니까?",
      answer:
        "주요 BIS 인증 제도에는 ISI 마크 제도, 강제 등록 제도(CRS), 외국 제조업체 인증 제도(FMCS), 보석용 홀마킹, 에코 마크 인증, 산업 기계용 스킴 X가 포함됩니다.",
    },
    {
      question: "BIS 인증 하에서 스킴 X란 무엇입니까?",
      answer:
        "스킴 X는 펌프, 변압기, 공작 기계 및 크레인과 같은 산업 제품에 적용되는 간소화된 BIS 인증 프로세스입니다. 인도 표준 준수를 저해하지 않으면서 더 빠른 승인을 보장합니다.",
    },
    {
      question: "인도에서 BIS 인증이 필요한 제품은 무엇입니까?",
      answer:
        "전기 제품, 전자 제품, 주방용품, 시멘트, 강철, 금 보석, 휴대폰 및 변압기와 같은 제품은 인도 BIS 지시에 따라 BIS 인증이 필요합니다.",
    },
    {
      question: "모든 제품에 BIS 등록이 필수입니까?",
      answer:
        "아니요, BIS 등록은 강제 인증 제도에 나열된 제품에만 필수입니다. 그러나 제품 신뢰성을 향상시키기 위해 자발적 BIS 인증도 사용할 수 있습니다.",
    },
    {
      question: "BIS 라이선스는 얼마나 유효합니까?",
      answer:
        "BIS 라이선스는 일반적으로 1~2년 동안 유효하며, ISI 마크를 계속 사용하거나 BIS 등록 상태를 유지하려면 만료 전에 갱신해야 합니다.",
    },
    {
      question: "인도에서 BIS 인증을 받는 단계는 무엇입니까?",
      answer:
        "BIS 인증 프로세스에는 적용 가능한 인도 표준 식별, 신청서 제출, 제품 테스트, 공장 검사 및 승인 시 BIS 인증서 발급이 포함됩니다.",
    },
    {
      question: "외국 제조업체가 BIS 라이선스를 신청할 수 있습니까?",
      answer:
        "예, 외국 제조업체 인증 제도(FMCS) 하에서 외국 기업은 인도에서 제품을 판매하기 위해 BIS 라이선스를 신청할 수 있습니다. 인도 공인 대표(AIR)를 임명해야 합니다.",
    },
    {
      question: "BIS 인증에서 AIR의 역할은 무엇입니까?",
      answer:
        "AIR(인도 공인 대표)는 외국 제조업체와 인도 BIS 사이의 연락 역할을 합니다. 문서화, 커뮤니케이션 및 BIS 인증 요구 사항 준수를 담당합니다.",
    },
    {
      question: "온라인으로 BIS 등록을 신청하려면 어떻게 해야 합니까?",
      answer:
        "공식 BIS 포털을 통해 온라인으로 BIS 등록을 신청할 수 있습니다. 프로세스에는 양식 제출, 문서 업로드, 테스트 보고서 및 수수료 지불이 포함됩니다.",
    },
    {
      question: "BIS 인증서에 필요한 서류는 무엇입니까?",
      answer:
        "필요한 서류에는 사업 라이선스, 제품 사양, 제조 프로세스, 실험실 테스트 보고서, 공장 레이아웃, 품질 매뉴얼 및 인증 양식(외국 제조업체용)이 포함됩니다.",
    },
    {
      question: "인도에서 BIS 인증 비용은 얼마입니까?",
      answer:
        "BIS 인증 비용은 제품 유형, 테스트 요구 사항, 제도 유형(ISI, CRS, FMCS) 및 신청자가 국내인지 외국인지에 따라 다릅니다. 비용에는 신청 수수료, 테스트 요금 및 검사 비용이 포함됩니다.",
    },
    {
      question: "모든 BIS 인증 제품에 ISI 마크가 필수입니까?",
      answer:
        "아니요, ISI 제도 하의 제품만 ISI 마크를 표시해야 합니다. CRS 또는 홀마킹 제도 하의 제품은 BIS 등록 규범에 따라 다른 라벨링 프로토콜을 따릅니다.",
    },
    {
      question: "친환경 제품에 대해 BIS 인증을 받을 수 있습니까?",
      answer:
        "예, 환경 표준을 충족하는 제품은 환경 안전에 대한 인도 표준 준수를 보장하는 에코 마크 제도 하에서 BIS 인증을 받을 수 있습니다.",
    },
    {
      question: "BIS 인증과 BIS 등록의 차이점은 무엇입니까?",
      answer:
        "BIS 인증은 일반적으로 ISI, FMCS 또는 홀마킹 제도 하의 승인을 의미하는 반면, BIS 등록은 전자 제품의 CRS 제도와 일반적으로 관련이 있습니다.",
    },
    {
      question: "강제 등록 제도(CRS)란 무엇입니까?",
      answer:
        "CRS는 LED 조명, 휴대폰 및 파워뱅크와 같은 IT 및 전자 제품을 위한 BIS 등록 프로그램입니다. 제품이 안전 관련 인도 표준을 준수하도록 보장합니다.",
    },
    {
      question: "ISI 마크와 BIS 인증서가 같은 의미입니까?",
      answer:
        "정확히는 아닙니다. ISI 마크는 BIS 인증 제도 하에서 인증 제품에 부여되는 기호입니다. BIS 인증서는 제조업체에게 발급되는 법적 문서입니다.",
    },
    {
      question: "하나의 BIS 라이선스로 여러 제품을 포함할 수 있습니까?",
      answer:
        "아니요, 제품이 유사하더라도 각 제품 유형 및 각 제조 위치에 대해 별도의 BIS 라이선스가 필요합니다.",
    },
    {
      question: "BIS 인증 없이 제품을 판매하면 어떻게 됩니까?",
      answer:
        "유효한 BIS 라이선스 없이 BIS 인증이 필요한 제품을 판매하는 것은 인도에서 불법이며 벌금, 제품 리콜 또는 금지 조치로 이어질 수 있습니다.",
    },
    {
      question: "BIS 인증을 받는 데 얼마나 걸립니까?",
      answer:
        "BIS 인증 프로세스는 일반적으로 30~90일이 소요되며, 제품 유형, 테스트 요구 사항 및 신청자가 국내인지 외국인지에 따라 다릅니다.",
    },
    {
      question: "BIS 인증이 전 세계적으로 인정됩니까?",
      answer:
        "BIS 인증은 인도에 특정되어 있지만, 엄격한 인도 표준 준수를 보여줌으로써 글로벌 신뢰성을 향상시킵니다. 일부 BIS 인증 제품은 상호 인정 협정 하에서도 인정됩니다.",
    },
    {
      question: "BIS 라이선스를 얼마나 자주 갱신해야 합니까?",
      answer:
        "BIS 라이선스는 매년 또는 격년으로 갱신해야 합니다. 제조업체는 인도 표준을 준수하고 감시 감사를 통과하여 BIS 인증서를 갱신해야 합니다.",
    },
  ];
