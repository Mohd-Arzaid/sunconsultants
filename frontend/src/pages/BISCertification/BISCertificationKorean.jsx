      ...
      <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
        ...
        <article className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
          ...
          <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
            BIS 인증은 인도에서 제품 품질과 안전을 보장합니다. 많은 제품에 필수이며 테스트, 문서화 및 승인이 필요합니다.
          </p>
  ...
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        예를 들어, 독일의 제조업체가 독특한 전자 장치를 발명하고 빠르게 변화하는 인도 시장에서 판매할 계획이라고 가정해보자. 이 장치는 독특하고 안전하며 유럽에서도 승인을 받았다. 그러나 이 장치가 인도 항구로 반입될 때 세관 직원들이 이 장치를 보류한다. 질문은 "왜일까?"이다. 답은 이 장치가 BIS 인증을 받아야 한다는 것이며, 이는 인도에서 전자 제품을 판매하기 위한 중요한 부분이다.
      </p>

      <p className="service-left-content-paragraph">
        많은 글로벌 및 인도 제조업체들이 매년 같은 상황을 겪는다. 인도 소비자들에게 제품의 BIS 마크는 단순한 로고가 아니라 제품이 품질, 안전성 및 신뢰성에 대해 테스트되었다는 신뢰의 표시이다. 사업에 있어서 이것은 전 세계에서 가장 큰 시장 중 하나로의 관문이다.
      </p>

      <p className="service-left-content-paragraph">
        이 기사는 BIS 인증, 그 필요성, 절차, 혜택, 제도, 비용, 그리고 외국 및 국내 제조업체 모두에게 제공되는 시스템과 그 네비게이션에 대한 모든 질문에 답할 것이다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        BIS 인증은 소비자 업무부 산하 인도의 국가 인증 기관인 인도 표준국(BIS)이 제공하는 품질 보증 및 안전 인증이다. BIS 인증은 제품이 성능, 안전성 및 품질 측면에서 인도 표준(IS)을 준수하도록 보장한다.
      </p>
      <p className="service-left-content-paragraph">
        제품이 이러한 품질 표준 요구사항을 충족하면 인도 표준국은 BIS 라이센스 또는 BIS 인증서를 발급하며, 이는 제품이 ISI 마크(국내 제도의 경우) 또는 고유 등록 번호가 있는 CRS 마크(BIS 필수 등록 제도 하에서)를 표시할 자격이 있음을 의미한다.
      </p>
      <p className="service-left-content-paragraph">
        많은 인도 제조업체 및 수입업체에게 BIS 인증을 받는 것은 필수이다. 여기에는 전기 제품, 시멘트 및 강철 제품, 포장된 음용수, 휴대폰, LED 조명, 파워뱅크와 같은 전자 제품, 귀금속 주얼리(품질 보증을 통해) 및 기타 많은 제품이 포함된다. 이러한 필수 제품의 제조업체 및 수입업체는 BIS 승인 없이는 인도에서 합법적으로 제품을 판매하거나 유통할 수 없다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        인도 표준국(BIS)은 1947년에 설립된 인도 표준 기관(ISI)을 인수하여 1986년에 설립되었다. BIS는 이제 인도의 표준에 대한 품질 수호자로 간주되며 그들의 관행을 국제 수준에 맞추고 인도 조건에 필요한 수정을 했다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        현재 BIS는 여러 산업에 걸쳐 인도 사용자를 위한 수천 개의 도구 및 기계의 안전성, 신뢰성 및 표준화를 보장한다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        인도 시장은 거대하고 끊임없이 변화하며 가격 변동에 민감하다. 그러나 이러한 개방성은 시장을 저렴하고 불안전한 상품에 노출시킨다. 이러한 맥락에서 BIS 인증은 보호 장벽으로 작용한다.
      </p>
      <PointsListWithoutHeading
        points={[
      ...
      />
      <p className="service-left-content-paragraph">
        포장된 음용수에 대한 BIS 인증은 인증이 없으면 건강 문제가 발생할 수 있는 예시이다. 히터, 토스터 및 기타 전기 제품에 대한 제품 인증 표준이 부족한 것도 화재로 이어질 수 있다. 따라서 BIS 인증을 통해 정부는 이러한 문제들이 해결되도록 보장한다.
      </p>
    </div>
  );
};
...
const DocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        강력한 문서 패키지는 원활한 처리를 보장합니다. 주요 요구사항은 다음과 같습니다:
      </p>
...
const ConclusionSection = () => {
  return (
    <div id="conclusion" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS 인증을 보유하는 것은 인도에서 사업을 하는 데 필수적입니다.
        더 이상 사업에서 선택적 인증이 아닙니다. 사업 성공과 신뢰 구축에
        매우 중요합니다. BIS는 인도에서 안전과 성공에 필수적입니다. 제조업체와
        수입업체에게는 쉬우면서도 안전한 사업 설정 환경을 제공합니다. 법적 문제와
        벌금은 더 이상 걱정거리가 아닙니다. BIS 마크를 통해 소비자 신뢰가 보장됩니다.
      </p>
...
const SchemesSection = () => {
  return (
    <div id="schemes" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS는 다양한 산업 및 제품 유형을 위해 설계된 수많은 인증 제도를 보유하고 있습니다. 각 제도는 산업과 제품의 특정 요구사항을 해결하도록 설계되었습니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        기준과 관련된 인도 표준의 충족을 인증하기 위해 인도 표준국(BIS)이 발급합니다. 여기에는 공장
        감사, 제품 테스트 및 BIS 매개변수와의 규정 준수 확인이 포함됩니다.
        제품이 통과되면 제조업체는 제품에 ISI 마크를 표시할 수 있습니다. 이 마크는 제조업체의 상표이며
        고객이 진정한 ISI 인증 제품을 식별하는 데 도움이 됩니다.
      </p>

      <p className="service-left-content-paragraph">
        전자 제품, 강철, 시멘트, 플라스틱 또는 건축 자재를 위한 것이든 관계없이
        BIS 인증서를 얻는 것은 시장 접근을 얻기 위해 필수적입니다. 소비자 신뢰를 얻는 것과 달리, BIS
        인증서는 인도 제조업체의 평판을 향상시키고 정부 계약에 참여할 수 있게 하며 다양한
        다른 사업 기회를 열어줍니다. 가장 중요한 것은 BIS
        인증이 없으면 법적 벌금과 제품 리콜부터 인도에서 판매 완전 금지에 이르기까지 해로운 영향을 미칠 수 있다는 것입니다. 따라서 BIS
        규정 준수는 단순한 법적 요구사항이 아니라 소비자 신뢰를 확장하고 유지하기 위한 목표 지향적 전략입니다.
      </p>

      <p className="service-left-content-paragraph">
        인도 제조업체에게 ISI 마크 제도는 가장 권위 있는 마크입니다. 이 제도 하에서 인도 제조업체는 제품을
        BIS 인정 테스트 시설에서 테스트해야 합니다. 제조
        현장은 검사 및 테스트 대상입니다. 규정 준수 제품은 ISI 마크 사용 승인을 받습니다. 시멘트, LPG 실린더, 전선, 포장된
        음용수 등을 ISI 마크 없이 공급하는 것은 위법입니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        외국 제조업체 인증 제도(FMCS)는 인도 시장에 진입하기를 원하는 외국 기업을 위해
        인도 표준국이 개발한 제도입니다. 이 제도는 해외에서 제조된 제품의 안전성,
        품질 및 성능 보증을 보장하며 필요한 인도 표준을 준수합니다. FMCS에 따라
        인도에서 제품을 판매하기를 원하는 외국 기업은 먼저 인도 표준국 인증서 또는 라이센스를 취득해야 합니다. 인도 제조업체와 마찬가지로,
        외국 제조업체도 제품에 ISI 마크를 사용하기 위해 BIS 라이센스를 취득해야 합니다. 바람직한 ISI 마크는
        공장 및 엄격한 제품 샘플 테스트를 포함한 광범위한 평가 후 인도 표준에 대해 부여됩니다.
      </p>

      <p className="service-left-content-paragraph">
        외국 제조업체는 인도 표준국(BIS)과의 첫 접촉 지점으로 통신 및
        조정을 담당하는 인정된 인도 대리인(AIR)을 임명해야 합니다. 여기에는 신청서 제출, 심층 규정 준수 평가, 마감일 내 규정 준수를 달성하기 위한 모든
        필요한 의무의 인수가 포함됩니다. FMCS 지침을 따르는 결과, 외국 기업은
        인도 시장에 진입할 수 있을 뿐만 아니라 고객과의 평판을 획득할 수 있습니다. ISI 마크가 있는 모든 제품은 인도에서 높은 수준의 품질, 안전성 및
        신뢰성 보증을 보여줍니다.
      </p>

      <p className="service-left-content-paragraph">
        규제 카테고리에 속하는 외국 제품은 FMCS 인증 없이는 인도에 들어올 수 없습니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        제도 X 또는 종합 기술 규정은 기계 및 전기 분야의 산업 규정 준수 절차를 단순화하는 데 도움을 주기 위해 인도 표준국이 설계한 또 다른 BIS
        인증 제도입니다. 다른 인증 제도와 달리, 제도 X
        는 제품이 인도 표준을 준수하도록 보장하면서 문서화, 평가 및 승인을 줄이는 데 중점을 둡니다. 표준 마크가 있는 제품은
        탁월한 품질과 안전성을 가지며 유형 테스트, 공장 검사 및 필수 요구사항의 간단한
        인증을 거친 후 판매할 수 있습니다.
      </p>

      <p className="service-left-content-paragraph">
        제도 X는 펌프, 크레인, 변압기, 공작 기계 및 기타 중공업 제품과 같은 제품에 대한 중장비 기계 및 전기 장비 안전
        가이드라인을 다룹니다. 이것들은 가장 관련성이 높은 산업이며 신뢰성과 안전성이 필수적인 모든 분야입니다. 제도 X
        는 복잡한 BIS 인증의 시간과 비용을 단축하기 때문에 편리합니다. 이것은 품질과 안전 표준을 훼손하지 않으면서
        마케팅을 위한 더 빠른 승인과 향상된 평판을 용이하게 하기 위해 규정 준수 프로세스를 간소화하는 것을 목표로 합니다. 인도 표준국의 지속적이고
        전통적인 평판은 기업이 규정 준수 요구사항을 충족하고 경쟁력을 높이는 데 필수적인 더 쉬운 국제 무역을 가능하게 합니다.
      </p>

      <p className="service-left-content-paragraph">
        BIS 제도 X는 인도 중공업 산업에 접근하기 위해 필수입니다.
        이 새로운 제도는 이 간소화되었지만 강력한 구조를 통해 간소화되는 규정에 대한 개선된 시장 경쟁, 혁신
        및 규정 준수에 중요합니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        인도 표준국(BIS)은 인도의 IT 및 전자 제품을 규제하기 위해
        필수 등록 제도(CRS)라는 BIS 인증 프로그램을 개발했습니다. 이것은 LED 조명, 휴대폰,
        노트북, 파워뱅크 및 기타 소비자 전자 제품과 같은 고위험 제품의 안전성과 품질을 인도 표준에 대해 평가하는 데 중점을 둡니다. CRS는 ISI 제도와 달리 ISI 마크를 발급하지 않지만, 이 제도에 따라 규정을 준수하는 인증 제품에는 고유 등록 번호가 있는
        CRS 마크가 표시됩니다. 모든 전자 제품 및 IT
        제품은 BIS 인정 실험실에서 테스트되어야 하며 BIS CRS에 공식적으로 등록되어야 하며, 인도에서 판매되거나 수입되기 전에 규정 준수를 보장하는 데 사용됩니다.
      </p>

      <p className="service-left-content-paragraph">
        이 제도는 특히 급속히 성장하는 디지털 시장의 경우 인도 소비자를 불안전한,
        부적합하거나 위조된 전자 제품으로부터 보호하는 데 필수적입니다. 인도 및 외국 제조업체 모두
        CRS 인증을 취득해야 합니다. 외국 기업은 규정 준수를 보장하기 위해
        인정된 인도 대리인 AIR를 임명해야 합니다. BIS
        는 CRS 하에서 다루는 제품 목록을 지속적으로 업데이트하여
        새로운 제품 및 기술과 새로운 안전 문제를 포함합니다. 제조업체에게 CRS 하에서 BIS 등록을 취득하는 것은 추가적인
        장점입니다. 규정 준수에 도움이 될 뿐만 아니라 인도의
        전자 산업에서 고객의 신뢰, 회사의 평판 및 시장 접근을 증가시키기 때문입니다.
      </p>

      <h3 className="service-left-content-heading-three">품질 보증 제도</h3>

      <p className="service-left-content-paragraph">
        인도에서 금 및 은 주얼리의 품질 보증은
        품질 보증 제도 하에서 필수이며 주얼리의 순도와 진정성을 보장하는 인도 표준국
        (BIS)에 의해 규제됩니다. 귀금속 제품은 BIS 승인된 분석 및
        품질 보증 센터(AHC)에서 테스트된 후 품질 보증 기호로 인쇄됩니다. 이
        프로세스는 제품이 처음에 제시된 인도 표준을 충족하는 경우에만 완료됩니다. 주얼리상은 먼저
        품질 보증 주얼리를 판매할 수 있는 BIS 라이센스를 취득해야 합니다. 이것이 합법적으로 그렇게 하는 유일한 방법입니다. 주얼리상은 품질 보증 주얼리를 판매하기 위해 제품 테스트를 거치고 완료하며,
        BIS 감사 및 지속적인 규정 준수 모니터링을 해야 합니다. 이 프로세스는 결국 소비자를 보호하고
        순도, 무게 및 품질을 보장하며 주얼리 시장의 부정행위 및 사기를 제한합니다.
      </p>

      <p className="service-left-content-paragraph">
        인도 소비자에게 금과 은은 단순한 장식품이 아니라
        주요 투자이기도 하며, 이는 신뢰와 투명성을 필수적으로 만듭니다. 품질 보증
        주얼리는 국가의 일반 시민에게 판매용 모든 주얼리가 다양한 국가 기준 및 공정한 거래 관행에 대해 광범위한
        테스트를 거쳤다는 보증의 표시입니다. 주얼리상은
        품질 보증 주얼리를 통해 그들의 신뢰성과 시장 평판을 보여줄 수 있습니다. 설정된 규칙을 준수하지 못하면
        라이센스 정지를 포함할 수 있는 처벌을 받습니다. BIS 하에서 품질 보증의 경우, 이것은 원칙 기반 및 법적
        의무의 이행으로 작용합니다. 이것은 소비자 만족도를 높일 뿐만 아니라
        인도 주얼리 시장 전체를 향상시킵니다. 이것은 더 작은 소매업체뿐만 아니라 대규모 제조업체에게도 마찬가지입니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        에코 마크는 친환경 제품의 촉진을 목표로 인도 표준국
        (BIS)이 만든 혁신 중심 인정 제도입니다. 안전 및 품질 매개변수에 주로 관심을 갖는 전통적인 인증과 달리, 에코 마크는 인도 표준을 준수하고 제품의 생명 주기의 여러 단계 중 하나 이상에서
        불리한 환경 영향을 최소한 어느 정도 감소시킨 것으로 보여주는 제품에 수여됩니다. 에코 마크
        인증은 상당한 테스트 및 기준 - 배출 수준, 비독성,
        생분해율, 재활용 능력 및 시스템과의 전체적 상호작용을 포함하는 규정 준수 증명 후에만 수여됩니다. 에코 마크는 ISI 마크와 마찬가지로
        정부로부터 인증 마크 지위를 부여받은 보증의 상징이지만 환경
        지속가능성의 더 명확한 목표를 가지고 있습니다.
      </p>

      <p className="service-left-content-paragraph">
        에코 마크가 있는 BIS 라이센스는 회사가
        책임 있는 제조에 참여하고 환경을 신경 쓰고 있음을 인증합니다. 이것은 법률 준수를 보장하고
        보호적인 소비자와 지속가능성 지향적 기업과의 경쟁 우위를 만듭니다. 에코 마크
        는 산업이 녹색 관행을 신뢰하고 채택하는 데 도움이 되며 소비자가 구매하는 제품이 안전하고
        환경적으로 책임 있다고 신뢰하는 데 도움이 됩니다. 에코 마크는 BIS 하에서 환경 보호와 함께 향상된 품질 보호에 대한 인도의 비전을 지원합니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        인도 표준국(BIS)이 시작한
        관리 시스템 인증 제도(MSCS)는 국제적으로
        인정받고 인정된 관리 시스템의 구현에 대해 관련 기업을 평가하고 인정하는 단계별 절차입니다. MSCS 프레임워크는
        ISO 9001 품질 관리, ISO 14001 환경
        관리, ISO 45001 직업 건강 및 안전 관리 시스템
        및 기타와 같은 ISO 표준으로 구성됩니다. MSCS는 법적 운영,
        일관성 및 운영의 지속적인 개선에 대해 기업을 인증합니다. 인증된
        기업은 고객, 규제 기관 및 이해관계자 간의 신뢰를 구축하는 데 도움이 되는 수많은 평가 및 감사를 거치며 이것이
        안전, 품질 및 지속가능성 보장을 강화합니다.
      </p>

      <p className="service-left-content-paragraph">
        BIS는 인도의 국가 표준 기관이며 조직의 평판과 신뢰성을 인도 내외에서
        향상시키기 위한 인증 기관입니다. MSCS는 주기적 감독 및 재인증을 통해 책임감을 조성하는 것 외에도
        기업이 인도 제조 및 아트마니르바르 바랏과 같은 공공 주도 프로그램을 적극적으로 지원할 수 있게 해줍니다. 법적 의무 외에도 이 제도는
        무결성, 효율성 및 공정 거래 문화를 조성하는 데 도움이 됩니다. MSCS
        는 인증된 기업의 무역 및 투자를 장려하며 BIS
        는 국가의 품질 생태계 발전에 중요한 역할을 합니다.
      </p>
      ...
      <p className="service-left-content-paragraph">
        인도 표준국(BIS) 하에서 실험실 인정 제도
        (LRS)는 BIS 승인을 위해 제품을 테스트하고 인증하는 실험실의 신뢰성
        및 전반적인 역량을 보장하는 시스템의 핵심 부분입니다. 이러한 실험실은 기술적 지식, 인력의 품질,
        인프라 및 ISO/ IEC 17025 표준에 대한 실험실의 전반적인 역량 및 만족도를 포함한 다양한
        속성에 대해 비판적으로 평가됩니다. 이러한 실험실은 승인되면
        ISI 마크 제도 및 필수 등록 제도(CRS)와 같은 다양한 BIS 인증 프로그램의 일부로 적합성
        평가가 수행되는 제품에 대한 테스트를 수행할 수 있습니다.
        제조업체, 특히 수입업체 및 수출업체에게 LRS 승인 실험실에서 얻은 보고서는 특정 제품에 대한 법적 요구사항인 BIS 인증서를 취득하기 위한 중요한 요구사항임이 명확합니다.
      </p>

      <p className="service-left-content-paragraph">
        LRS는 테스트 결과의 형평성을 유지하고 모든 결과가 일관되고
        글로벌 기준을 기준으로 하도록 보장하면서 신뢰할 수 있고 건전한
        실험실만 인정함으로써 인도의 보증 시스템을 강화하고 있습니다. 무결성과 투명성을 유지하기 위해 BIS는 정기적인
        감사, 숙련도 테스트 및 인정된 제도 실험실의 감시를 수행합니다. 이 인증의 인정은 BIS가
        소비자로부터의 신뢰를 향상시키면서 산업에 대한 인증 프로세스를 더 효율적으로 만들 수 있게 합니다. 안전하고 규정을 준수하며 고품질 제품만이 인도 시장에 제공되기 때문입니다. BIS 인증을 받으려는 조직에게
        LRS 승인 실험실과의 협력이 규정 준수 및 시장 접근을 달성하기 위한 가장 필수적인 것입니다.
      </p>
