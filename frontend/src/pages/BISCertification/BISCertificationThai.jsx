...
const OverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        การรับรอง BIS คือเครื่องหมายคุณภาพระดับชาติของอินเดียที่ออกโดยสำนักงานมาตรฐานอินเดีย ซึ่งเป็นองค์กรรับรองระดับชาติของอินเดียภายใต้กระทรวงกิจการผู้บริโภค การรับรอง BIS รับประกันว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดีย (IS) ในด้านประสิทธิภาพ ความปลอดภัย และคุณภาพ ทำให้ผู้ผลิต (อินเดียหรือต่างประเทศ) สามารถใช้เครื่องหมายมาตรฐานเพื่อเข้าถึงตลาด ซึ่งเกี่ยวข้องกับการทดสอบและการตรวจสอบ
      </p>
      <p className="service-left-content-paragraph">
