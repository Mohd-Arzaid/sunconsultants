...
/** Injects FAQ JSON-LD into document.head (BISCertification page - Thai) */
const BISCertificationFAQSchemaInjector = () => {
  const faqSchema = useMemo(
    () => ({
      ...
      "@type": "FAQPage",
      mainEntity: [
        { "@type": "Question", name: "การรับรอง BIS ในอินเดียคืออะไร?", acceptedAnswer: { "@type": "Answer", text: "การรับรอง BIS เป็นการรับรองประกันคุณภาพที่ออกโดยสำนักงานมาตรฐานอินเดีย (BIS) เพื่อให้มั่นใจว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดียด้านความปลอดภัย ประสิทธิภาพ และคุณภาพ เป็นข้อบังคับสำหรับหมวดหมู่ผลิตภัณฑ์ต่างๆ และช่วยในการคุ้มครองผู้บริโภคและการปฏิบัติตามกฎระเบียบ" } },
        { "@type": "Question", name: "ทำไมฉันถึงต้องมีใบรับรอง BIS?", acceptedAnswer: { "@type": "Answer", text: "ใบรับรอง BIS เป็นสิ่งจำเป็นในการผลิต นำเข้า จัดจำหน่าย หรือขายผลิตภัณฑ์บางอย่างอย่างถูกกฎหมายในอินเดีย มันทำให้ผู้บริโภคมั่นใจว่าผลิตภัณฑ์เป็นไปตามแนวทางความปลอดภัยและคุณภาพของมาตรฐานอินเดีย" } },
        { "@type": "Question", name: "เครื่องหมาย ISI ภายใต้การรับรอง BIS คืออะไร?", acceptedAnswer: { "@type": "Answer", text: "เครื่องหมาย ISI เป็นสัญลักษณ์การรับรองที่ให้ภายใต้โครงการรับรอง BIS บ่งชี้ว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดียและได้รับการรับรองจาก BIS อินเดียผ่านการทดสอบและการลงทะเบียนที่เหมาะสม" } },
        { "@type": "Question", name: "ใครออกใบอนุญาต BIS ในอินเดีย?", acceptedAnswer: { "@type": "Answer", text: "ใบอนุญาต BIS ออกโดยสำนักงานมาตรฐานอินเดีย (BIS อินเดีย) องค์กรมาตรฐานแห่งชาติภายใต้กระทรวงกิจการผู้บริโภค อาหาร และการกระจายสาธารณะ" } },
        { "@type": "Question", name: "โครงการรับรอง BIS มีกี่ประเภท?", acceptedAnswer: { "@type": "Answer", text: "โครงการรับรอง BIS หลัก ได้แก่ โครงการเครื่องหมาย ISI โครงการลงทะเบียนบังคับ (CRS) โครงการรับรองผู้ผลิตต่างประเทศ (FMCS) การ hallmarking เครื่องประดับ การรับรอง Eco Mark และ Scheme X สำหรับเครื่องจักรอุตสาหกรรม" } },
        { "@type": "Question", name: "Scheme X ภายใต้การรับรอง BIS คืออะไร?", acceptedAnswer: { "@type": "Answer", text: "Scheme X เป็นกระบวนการรับรอง BIS ที่ลดความซับซ้อนสำหรับผลิตภัณฑ์อุตสาหกรรม เช่น ปั๊ม หม้อแปลง เครื่องมือกล และเครน มันรับประกันการอนุมัติที่รวดเร็วโดยไม่กระทบการปฏิบัติตามมาตรฐานอินเดีย" } },
        { "@type": "Question", name: "ผลิตภัณฑ์ใดบ้างที่ต้องมีการรับรอง BIS ในอินเดีย?", acceptedAnswer: { "@type": "Answer", text: "ผลิตภัณฑ์เช่นเครื่องใช้ไฟฟ้า อิเล็กทรอนิกส์ เครื่องใช้ในครัว ปูนซีเมนต์ เหล็ก เครื่องประดับทอง โทรศัพท์มือถือ และหม้อแปลงต้องมีการรับรอง BIS ตามคำสั่งของ BIS อินเดีย" } },
        { "@type": "Question", name: "การลงทะเบียน BIS บังคับสำหรับทุกผลิตภัณฑ์หรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ไม่ การลงทะเบียน BIS บังคับเฉพาะผลิตภัณฑ์ที่อยู่ในโครงการรับรองบังคับเท่านั้น อย่างไรก็ตาม การรับรอง BIS แบบสมัครใจก็มีเพื่อเพิ่มความน่าเชื่อถือของผลิตภัณฑ์" } },
        { "@type": "Question", name: "ใบอนุญาต BIS มีอายุนานแค่ไหน?", acceptedAnswer: { "@type": "Answer", text: "ใบอนุญาต BIS โดยทั่วไปมีอายุหนึ่งถึงสองปีและต้องต่ออายุก่อนหมดอายุเพื่อใช้เครื่องหมาย ISI ต่อหรือรักษาสถานะการลงทะเบียน BIS" } },
        { "@type": "Question", name: "ขั้นตอนในการรับการรับรอง BIS ในอินเดียคืออะไร?", acceptedAnswer: { "@type": "Answer", text: "กระบวนการรับรอง BIS รวมถึงการระบุมาตรฐานอินเดียที่ใช้ได้ การส่งใบสมัคร การทดสอบผลิตภัณฑ์ การตรวจสอบโรงงาน และการออกใบรับรอง BIS หลังการอนุมัติ" } },
        { "@type": "Question", name: "ผู้ผลิตต่างประเทศสามารถสมัครใบอนุญาต BIS ได้หรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ได้ ภายใต้โครงการรับรองผู้ผลิตต่างประเทศ (FMCS) บริษัทต่างประเทศสามารถสมัครใบอนุญาต BIS เพื่อขายผลิตภัณฑ์ในอินเดีย พวกเขาต้องแต่งตั้งตัวแทนอินเดียที่ได้รับอนุญาต (AIR)" } },
        { "@type": "Question", name: "บทบาทของ AIR ในการรับรอง BIS คืออะไร?", acceptedAnswer: { "@type": "Answer", text: "AIR (ตัวแทนอินเดียที่ได้รับอนุญาต) ทำหน้าที่เป็นผู้ประสานงานระหว่างผู้ผลิตต่างประเทศและ BIS อินเดีย พวกเขารับผิดชอบด้านเอกสาร การสื่อสาร และการปฏิบัติตามข้อกำหนดการรับรอง BIS" } },
        { "@type": "Question", name: "ฉันจะสมัครลงทะเบียน BIS ออนไลน์ได้อย่างไร?", acceptedAnswer: { "@type": "Answer", text: "คุณสามารถสมัครลงทะเบียน BIS ออนไลน์ผ่านพอร์ทัล BIS อย่างเป็นทางการ กระบวนการรวมถึงการส่งแบบฟอร์ม อัปโหลดเอกสาร รายงานการทดสอบ และการชำระค่าธรรมเนียม" } },
        { "@type": "Question", name: "ต้องใช้เอกสารอะไรบ้างสำหรับใบรับรอง BIS?", acceptedAnswer: { "@type": "Answer", text: "เอกสารที่ต้องการรวมถึงใบอนุญาตธุรกิจ ข้อมูลจำเพาะผลิตภัณฑ์ กระบวนการผลิต รายงานการทดสอบห้องปฏิบัติการ แผนผังโรงงาน คู่มือคุณภาพ และแบบฟอร์มอนุญาต (สำหรับผู้ผลิตต่างประเทศ)" } },
        { "@type": "Question", name: "การรับรอง BIS ในอินเดียมีค่าใช้จ่ายเท่าไร?", acceptedAnswer: { "@type": "Answer", text: "ค่าใช้จ่ายการรับรอง BIS ขึ้นอยู่กับประเภทผลิตภัณฑ์ ข้อกำหนดการทดสอบ ประเภทโครงการ (ISI, CRS, FMCS) และว่าผู้สมัครเป็นในประเทศหรือต่างประเทศ ค่าใช้จ่ายรวมค่าธรรมเนียมการสมัคร ค่าทดสอบ และค่าใช้จ่ายในการตรวจสอบ" } },
        { "@type": "Question", name: "เครื่องหมาย ISI บังคับสำหรับทุกผลิตภัณฑ์ที่รับรอง BIS หรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ไม่ มีเฉพาะผลิตภัณฑ์ภายใต้โครงการ ISI เท่านั้นที่ต้องมีเครื่องหมาย ISI ผลิตภัณฑ์ภายใต้โครงการ CRS หรือ Hallmarking ปฏิบัติตามโปรโตคอลการติดฉลากที่แตกต่างกันตามบรรทัดฐานการลงทะเบียน BIS" } },
        { "@type": "Question", name: "ฉันสามารถรับการรับรอง BIS สำหรับผลิตภัณฑ์ที่เป็นมิตรกับสิ่งแวดล้อมได้หรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ได้ ผลิตภัณฑ์ที่ตรงตามมาตรฐานสิ่งแวดล้อมสามารถรับการรับรอง BIS ภายใต้โครงการ Eco Mark ซึ่งรับประกันการปฏิบัติตามมาตรฐานอินเดียด้านความปลอดภัยด้านสิ่งแวดล้อม" } },
        { "@type": "Question", name: "ความแตกต่างระหว่างการรับรอง BIS กับการลงทะเบียน BIS คืออะไร?", acceptedAnswer: { "@type": "Answer", text: "การรับรอง BIS โดยทั่วไปหมายถึงการอนุมัติภายใต้โครงการ ISI, FMCS หรือ Hallmarking ในขณะที่การลงทะเบียน BIS มักเกี่ยวข้องกับโครงการ CRS สำหรับผลิตภัณฑ์อิเล็กทรอนิกส์" } },
        { "@type": "Question", name: "โครงการลงทะเบียนบังคับ (CRS) คืออะไร?", acceptedAnswer: { "@type": "Answer", text: "CRS เป็นโปรแกรมลงทะเบียน BIS สำหรับสินค้าไอทีและอิเล็กทรอนิกส์ เช่น ไฟ LED โทรศัพท์มือถือ และ power bank มันรับประกันว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดียที่เกี่ยวข้องกับความปลอดภัย" } },
        { "@type": "Question", name: "เครื่องหมาย ISI และใบรับรอง BIS หมายถึงสิ่งเดียวกันหรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ไม่ใช่เชิง แม้เครื่องหมาย ISI เป็นสัญลักษณ์ที่มอบให้ผลิตภัณฑ์ที่รับรองภายใต้โครงการรับรอง BIS ใบรับรอง BIS เป็นเอกสารทางกฎหมายที่ออกให้ผู้ผลิต" } },
        { "@type": "Question", name: "ใบอนุญาต BIS หนึ่งใบสามารถครอบคลุมหลายผลิตภัณฑ์ได้หรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ไม่ได้ ต้องมีใบอนุญาต BIS แยกสำหรับแต่ละประเภทผลิตภัณฑ์และแต่ละสถานที่ผลิต แม้ผลิตภัณฑ์จะคล้ายกัน" } },
        { "@type": "Question", name: "จะเกิดอะไรขึ้นถ้าฉันขายผลิตภัณฑ์โดยไม่มีการรับรอง BIS?", acceptedAnswer: { "@type": "Answer", text: "การขายผลิตภัณฑ์ที่ต้องมีการรับรอง BIS โดยไม่มีใบอนุญาต BIS ที่ถูกต้องเป็นสิ่งผิดกฎหมายในอินเดียและอาจนำไปสู่บทลงโทษ การเรียกคืนผลิตภัณฑ์ หรือการห้าม" } },
        { "@type": "Question", name: "ใช้เวลานานแค่ไหนในการรับการรับรอง BIS?", acceptedAnswer: { "@type": "Answer", text: "กระบวนการรับรอง BIS โดยทั่วไปใช้เวลา 30 ถึง 90 วัน ขึ้นอยู่กับประเภทผลิตภัณฑ์ ข้อกำหนดการทดสอบ และว่าผู้สมัครเป็นในประเทศหรือต่างประเทศ" } },
        { "@type": "Question", name: "การรับรอง BIS ได้รับการยอมรับทั่วโลกหรือไม่?", acceptedAnswer: { "@type": "Answer", text: "ในขณะที่การรับรอง BIS เฉพาะอินเดีย มันเพิ่มความน่าเชื่อถือระดับโลกโดยแสดงการปฏิบัติตามมาตรฐานอินเดียที่เข้มงวด ผลิตภัณฑ์ที่รับรอง BIS บางส่วนยังได้รับการยอมรับภายใต้ข้อตกลงการยอมรับซึ่งกันและกัน" } },
        { "@type": "Question", name: "ฉันต้องต่ออายุใบอนุญาต BIS บ่อยแค่ไหน?", acceptedAnswer: { "@type": "Answer", text: "ใบอนุญาต BIS ต้องต่ออายุทุกปีหรือทุกสองปี ผู้ผลิตต้องรักษาการปฏิบัติตามมาตรฐานอินเดียและผ่านการตรวจสอบเฝ้าระวังเพื่อต่ออายุใบรับรอง BIS" } },
      ],
    }),
    []
  );
  ...
  useEffect(() => {
    ...
    script.id = "biscertification-faq-schema-th";
    script.textContent = JSON.stringify(faqSchema);
    document.head.appendChild(script);
    return () => {
      const el = document.getElementById("biscertification-faq-schema-th");
      if (el) el.remove();
    };
  }, [faqSchema]);
...
const OverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      การรับรอง BIS ในอินเดีย | คู่มือฉบับสมบูรณ์ 
      ...
      <p className="service-left-content-paragraph">
        การรับรอง BIS
        คือเครื่องหมายคุณภาพระดับชาติของอินเดียที่ออกโดยสำนักงานมาตรฐานอินเดีย
        ซึ่งเป็นองค์กรรับรองระดับชาติของอินเดียภายใต้กระทรวงกิจการผู้บริโภค
        การรับรอง BIS รับประกันว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดีย (IS)
        ในด้านประสิทธิภาพ ความปลอดภัย และคุณภาพ ทำให้ผู้ผลิต
        (อินเดียหรือต่างประเทศ) สามารถใช้เครื่องหมายมาตรฐานเพื่อเข้าถึงตลาด
        ซึ่งเกี่ยวข้องกับการทดสอบและการตรวจสอบ
      </p>
      <p className="service-left-content-paragraph">
  ...
  return (
    <div id="process" className="flex flex-col scroll-mt-20">
      ...
      <h2 className="service-left-content-heading-two">
        ขั้นตอนการขอรับการรับรอง BIS
      </h2>

      <p className="service-left-content-paragraph">
        กระบวนการในการขอรับใบรับรอง BIS สำหรับทั้งผู้ผลิตในอินเดียและต่างประเทศโดยทั่วไปมีขั้นตอนสำคัญดังต่อไปนี้:
      </p>

      <PointsListWithoutHeading
        points={[
          "ระบุมาตรฐานที่ใช้บังคับ: กำหนดมาตรฐานอินเดีย (IS) ที่เกี่ยวข้องกับผลิตภัณฑ์",
          "จัดตั้งสถานที่ทดสอบ: จัดตั้งห้องปฏิบัติการภายในที่เป็นไปตามข้อกำหนดของมาตรฐานที่ใช้บังคับ",
          "สร้างบัญชีบนพอร์ทัล BIS: ผู้ผลิตในอินเดียต้องลงทะเบียนบนพอร์ทัลออนไลน์ของ BIS เพื่อเริ่มต้นการสมัคร",
          "ทดสอบผลิตภัณฑ์: ทดสอบผลิตภัณฑ์ตามข้อกำหนดมาตรฐานอินเดีย (ISS) ที่ใช้บังคับ",
          "ยื่นคำขอ: ยื่นคำขอ BIS พร้อมรายงานผลการทดสอบและเอกสารที่จำเป็น",
          "ตอบข้อซักถาม: ตอบคำชี้แจงหรือข้อซักถามที่เจ้าหน้าที่ BIS ร้องขอ",
          "ตรวจโรงงาน: เจ้าหน้าที่ BIS เข้าตรวจสถานประกอบการเพื่อยืนยันความสอดคล้องและตรวจสอบกระบวนการผลิต",
          "ยืนยันตัวอย่าง: ระหว่างการตรวจจะทดสอบตัวอย่างในห้องปฏิบัติการภายในและปิดผนึกเพื่อให้เจ้าหน้าที่ BIS ตรวจยืนยันซ้ำ",
          "ปิดการตรวจประเมิน: เมื่อการตรวจและการยืนยันเสร็จสิ้น การตรวจประเมินจะสรุปผล",
          "อนุมัติใบอนุญาต: หากเป็นไปตามข้อกำหนดทั้งหมด BIS จะอนุมัติใบอนุญาตการรับรองให้แก่ผู้ผลิต",
        ]}
      />

      <h3 className="service-left-content-heading-three mt-5">
        ค่าใช้จ่ายและค่าธรรมเนียมใบอนุญาตการรับรอง BIS
      </h3>

      <p className="service-left-content-paragraph">
        ค่าใช้จ่ายในการขอรับการรับรอง BIS แตกต่างกันตามหลายปัจจัย เช่น ประเภทสินค้า มาตรฐานอินเดีย (IS) ที่ใช้บังคับ และผู้ผลิตตั้งอยู่ในอินเดียหรือในต่างประเทศ
      </p>

      <h3 className="service-left-content-heading-three mt-5">
        โครงสร้างค่าธรรมเนียมการลงทะเบียน BIS (CRS)
      </h3>

      <PointsListWithoutHeading
        points={[
          "ค่าธรรมเนียมภาครัฐ: ₹53,000 + 18% GST ต่อรายงานผลการทดสอบ และมีค่าใช้จ่ายเพิ่ม ₹20,000 สำหรับรายงานผลการทดสอบเพิ่มเติมแต่ละฉบับที่ยื่นภายในการสมัครเดียวกัน",
          "ค่าทดสอบ: ตามอัตราของห้องปฏิบัติการ ซึ่งแตกต่างกันตามผลิตภัณฑ์และสถานที่ทดสอบ",
        ]}
      />

      <p className="service-left-content-paragraph">
        หมายเหตุ: บริษัทที่จดทะเบียนภายใต้กฎหมาย MSME อาจมีสิทธิ์ได้รับส่วนลด/ผ่อนปรนในค่าธรรมเนียมภาครัฐบางรายการ
      </p>

      <h3 className="service-left-content-heading-three mt-5">
        โครงสร้างค่าธรรมเนียมใบอนุญาต BIS (การรับรอง ISI)
      </h3>

      <PointsListWithoutHeading
        points={[
          "ค่าธรรมเนียมการสมัคร: ₹1,000",
          "ค่าธรรมเนียมใบอนุญาต: ₹1,000",
          "ค่าตรวจประเมิน: ₹7,000 ต่อคน-วัน (man-day) สำหรับการตรวจโรงงาน",
          "ค่าทดสอบ: ขึ้นอยู่กับผลิตภัณฑ์และห้องปฏิบัติการทดสอบ",
          "ค่าธรรมเนียมการทำเครื่องหมายขั้นต่ำ: แตกต่างกันตามประเภทสินค้า",
        ]}
      />

      <p className="service-left-content-paragraph">
        สำหรับผู้ผลิตต่างประเทศ จะมีค่าใช้จ่ายเพิ่มเติมภายใต้โครงการ Foreign Manufacturers Certification Scheme (FMCS) โดยโครงสร้างต้นทุนที่แน่นอนขึ้นอยู่กับกรณีเฉพาะและข้อกำหนดที่เกี่ยวข้อง
      </p>
    </div>
  );
};
