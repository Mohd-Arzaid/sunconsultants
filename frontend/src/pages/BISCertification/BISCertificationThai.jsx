...
const BISCertificationFaq = () => {
  const faqData = [
    ...
    {
      question:
        "เครื่องหมาย ISI เป็นบังคับสำหรับผลิตภัณฑ์ที่รับรอง BIS ทั้งหมดหรือไม่?",
      answer:
    ...
    {
      question:
        "ฉันสามารถรับการรับรอง BIS สำหรับผลิตภัณฑ์ที่เป็นมิตรต่อสิ่งแวดล้อมได้หรือไม่?",
      answer:
    ...
    {
      question:
        "ใบอนุญาต BIS หนึ่งใบสามารถครอบคลุมผลิตภัณฑ์หลายอย่างได้หรือไม่?",
      answer:
