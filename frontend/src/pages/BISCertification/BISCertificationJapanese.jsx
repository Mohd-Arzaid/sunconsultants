...
const OverviewSection = () => {
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        BIS認証は、消費者問題省の下にあるインドの国家認証機関であるインド標準局（BIS）が発行するインドの国家品質マークです。BIS認証は、製品が性能、安全性、品質に関してインド標準（IS）に準拠していることを保証し、製造業者（インドまたは外国）が市場アクセスのために標準マークを使用できるようにし、テストと監査を含みます。
      </p>
      <p className="service-left-content-paragraph">
  ...
  const faqData = [
    {
      ...
      answer:
        "BIS認証は、インド標準局（BIS）が発行する品質保証認証で、製品が安全性、性能、品質に関するインドの基準に準拠していることを保証します。様々な製品カテゴリーで義務付けられており、消費者保護と規制遵守に役立ちます。",
    },
    {
      question: "なぜBIS証明書が必要ですか？",
      answer:
        "BIS証明書は、インドで特定の製品を合法的に製造、輸入、流通、販売するために不可欠です。製品がインド基準の安全性と品質ガイドラインを満たしていることを消費者に保証します。",
    },
    {
      question: "BIS認証におけるISIマークとは何ですか？",
      answer:
        "ISIマークは、BIS認証スキームの下で提供される認証シンボルです。製品がインド基準に準拠しており、適切なテストと登録を通じてインドBISによって認証されたことを示します。",
    },
    {
      question: "インドでBISライセンスを発行するのは誰ですか？",
      answer:
        "BISライセンスは、消費者問題・食品・公共配給省の下にある国家標準機関であるインド標準局（インドBIS）によって発行されます。",
    },
    {
      question: "BIS認証スキームにはどのような種類がありますか？",
      answer:
        "主要なBIS認証スキームには、ISIマークスキーム、強制登録スキーム（CRS）、外国製造者認証スキーム（FMCS）、宝飾品のホールマーキング、エコマーク認証、産業機械用のスキームXが含まれます。",
    },
    {
      question: "BIS認証におけるスキームXとは何ですか？",
      answer:
        "スキームXは、ポンプ、変圧器、工作機械、クレーンなどの工業製品に適用される簡略化されたBIS認証プロセスです。インド基準への準拠を損なうことなく、より迅速な承認を保証します。",
    },
    {
      question: "インドでBIS認証が必要な製品はどれですか？",
      answer:
        "電気機器、電子機器、台所用品、セメント、鋼材、金の宝飾品、携帯電話、変圧器などの製品は、インドBISの指令に従ってBIS認証が必要です。",
    },
    {
      question: "すべての製品でBIS登録は義務ですか？",
      answer:
        "いいえ、BIS登録は強制認証スキームに記載されている製品のみが義務です。ただし、製品の信頼性を高めるために、任意のBIS認証も利用できます。",
    },
    {
      question: "BISライセンスの有効期限はどのくらいですか？",
      answer:
        "BISライセンスは通常1〜2年間有効で、ISIマークの使用を継続するか、BIS登録ステータスを維持するには、有効期限前に更新する必要があります。",
    },
    {
      question: "インドでBIS認証を取得する手順は？",
      answer:
        "BIS認証プロセスには、適用可能なインド基準の特定、申請書の提出、製品テスト、工場検査、承認後のBIS証明書の発行が含まれます。",
    },
    {
      question: "外国の製造者はBISライセンスを申請できますか？",
      answer:
        "はい、外国製造者認証スキーム（FMCS）の下で、外国企業はインドで製品を販売するためにBISライセンスを申請できます。認可インド代表者（AIR）を任命する必要があります。",
    },
    {
      question: "BIS認証におけるAIRの役割は何ですか？",
      answer:
        "AIR（認可インド代表者）は、外国製造者とインドBISの間の連絡役として機能します。文書化、コミュニケーション、BIS認証要件への遵守を担当します。",
    },
    {
      question: "BIS登録をオンラインで申請するにはどうすればよいですか？",
      answer:
        "公式BISポータルを通じてオンラインでBIS登録を申請できます。プロセスには、フォーム提出、文書のアップロード、テストレポート、手数料の支払いが含まれます。",
    },
    {
      question: "BIS証明書に必要な書類は何ですか？",
      answer:
        "必要な書類には、事業許可証、製品仕様、製造プロセス、実験室テストレポート、工場レイアウト、品質マニュアル、認可フォーム（外国製造者用）が含まれます。",
    },
    {
      question: "インドでのBIS認証の費用はいくらですか？",
      answer:
        "BIS認証の費用は、製品タイプ、テスト要件、スキームタイプ（ISI、CRS、FMCS）、申請者が国内か外国かによって異なります。費用には、申請料、テスト料、検査費用が含まれます。",
    },
    {
      question: "すべてのBIS認証製品でISIマークは義務ですか？",
      answer:
        "いいえ、ISIスキームの下にある製品のみがISIマークを表示する必要があります。CRSまたはホールマーキングスキームの下にある製品は、BIS登録基準に従って異なるラベリングプロトコルに従います。",
    },
    {
      question: "環境に優しい製品でBIS認証を取得できますか？",
      answer:
        "はい、環境基準を満たす製品は、環境安全に関するインド基準への準拠を保証するエコマークスキームの下でBIS認証を取得できます。",
    },
    {
      question: "BIS認証とBIS登録の違いは何ですか？",
      answer:
        "BIS認証は一般的にISI、FMCS、またはホールマーキングスキームの下での承認を指し、BIS登録は電子製品のCRSスキームと一般的に関連付けられています。",
    },
    {
      question: "強制登録スキーム（CRS）とは何ですか？",
      answer:
        "CRSは、LEDライト、携帯電話、パワーバンクなどのITおよび電子製品のBIS登録プログラムです。製品が安全性に関連するインド基準に準拠していることを保証します。",
    },
    {
      question: "ISIマークとBIS証明書は同じ意味ですか？",
      answer:
        "正確には違います。ISIマークは、BIS認証スキームの下で認証製品に付与されるシンボルです。BIS証明書は、製造者に発行される法的文書です。",
    },
    {
      question: "1つのBISライセンスで複数の製品をカバーできますか？",
      answer:
        "いいえ、製品が類似していても、各製品タイプと各製造場所には別々のBISライセンスが必要です。",
    },
    {
    ...
    },
    {
      ...
      answer:
        "BIS認証プロセスは通常30〜90日かかり、製品タイプ、テスト要件、申請者が国内か外国かによって異なります。",
    },
    {
      question: "BIS認証は世界的に受け入れられていますか？",
      answer:
        "BIS認証はインド固有のものですが、厳格なインド基準への準拠を示すことで世界的な信頼性を高めます。一部のBIS認証製品は、相互承認協定の下でも受け入れられています。",
    },
    {
      question: "BISライセンスをどのくらいの頻度で更新する必要がありますか？",
      answer:
        "BISライセンスは毎年または2年ごとに更新する必要があります。製造者はインド基準への準拠を維持し、監査を通過してBIS証明書を更新する必要があります。",
    },
  ];
