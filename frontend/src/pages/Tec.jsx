...
const ScopeSection = () => {
  return (
    <section id="scope" className="flex flex-col scroll-mt-20">
      ...
      {/* PRODUCTS COVERED UNDER Phase I & Phase II of MTCTE Tables */}
      <div className="mt-[16px] md:mt-[24px]">
        <Accordion type="single" collapsible className="w-full space-y-3">
          ...
          <AccordionItem value="phase-2" className="border-none">
            ...
            <AccordionContent className="pt-3 pb-0">
              <p className="font-geist text-sm md:text-base text-[#42434d] tracking-wide text-left max-w-full leading-relaxed mb-4">
                Effective from 1 October 2020, it is mandatory to obtain TEC
                certification for the products covered under MTCTE Phase 2 before
                selling them in India. Phase 2 of the MTCTE scheme encompassed a
                wide range of telecom equipment, including routers, switches,
                network interface devices, optical transport equipment, and more.
                List Of Products (Essential Requirements) Covered Under Phase-II
                of MTCTE are:
              </p>
              <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
                <TableHeader className="bg-[#F9F7F2]">
                ...
                <TableBody className="bg-white divide-y divide-gray-200">
                  {[
                    { sno: 1, product: "PON Family of Broadband Equipment", variant: "PON ONU", category: "SCS" },
                    { sno: 2, product: "PON Family of Broadband Equipment", variant: "PON ONT", category: "SCS" },
                    { sno: 3, product: "PON Family of Broadband Equipment", variant: "PON OLT", category: "SCS" },
                    { sno: 4, product: "Feedback Device", variant: "Feedback Device", category: "SCS" },
                    { sno: 5, product: "Transmission Terminal Equipment1", variant: "Multiplexing Equipment", category: "SCS" },
                    { sno: 6, product: "Transmission Terminal Equipment1", variant: "SDH Equipment", category: "SCS" },
                  ].map((item) => (
                    <TableRow key={item.sno} className="hover:bg-gray-50">
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d] font-medium">
                        {item.sno}.
          ...
          <AccordionItem value="phase-3" className="border-none">
            ...
            <AccordionContent className="pt-3 pb-0">
              <p className="font-geist text-sm md:text-base text-[#42434d] tracking-wide text-left max-w-full leading-relaxed mb-4">
                Starting from 1 October 2023, manufacturers or importers of 10
                specific telecom products will be obligated to obtain
                certification before selling them in India. Additionally,
                starting from 1 January 2024, an additional 14 products will
                come under the mandatory certification requirement.
              </p>
              <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
                <TableHeader className="bg-[#F9F7F2]">
                  <TableRow className="bg-[#1A8781]/10">
                ...
                <TableBody className="bg-white divide-y divide-gray-200">
                  {[
                    { sno: 1, product: "Equipments Operating in 2.4 GHz and 5 GHz Band", variant: "PTP PMP Wireless Access Equipment 2.4 or 5 GHz", category: "SCS" },
                    { sno: 2, product: "Equipments Operating in 2.4 GHz and 5 GHz Band", variant: "Wifi Access Points and CPE", category: "SCS" },
                    { sno: 3, product: "Equipments Operating in 2.4 GHz and 5 GHz Band", variant: "WLAN Controller Equipment", category: "SCS" },
                    { sno: 4, product: "IoT Gateway", variant: "IoT Gateway", category: "GCS" },
                    { sno: 5, product: "Tracking Device", variant: "Asset Tracking Device", category: "SCS" },
                    { sno: 6, product: "Tracking Device", variant: "Human Tracking Device", category: "SCS" },
                    { sno: 7, product: "Tracking Device", variant: "Pet Tracking Device", category: "SCS" },
                    { sno: 8, product: "Tracking Device", variant: "Vehicle Tracking Device", category: "SCS" },
                    { sno: 9, product: "Smart Electricity Meter", variant: "Smart Electricity Meter", category: "SCS" },
                    { sno: 10, product: "End Point Device for Environmental Monitoring", variant: "End Point Device for Environmental Monitoring", category: "SCS" },
                    { sno: 11, product: "Repeater for Cellular Network", variant: "GSM and WCDMA Repeater", category: "GCS" },
                    { sno: 12, product: "Repeater for Cellular Network", variant: "GSM Repeater", category: "GCS" },
                    { sno: 13, product: "Repeater for Cellular Network", variant: "GSM WCDMA and LTE Repeater", category: "GCS" },
                    { sno: 14, product: "Repeater for Cellular Network", variant: "LTE Repeater", category: "GCS" },
                    { sno: 15, product: "Repeater for Cellular Network", variant: "WCDMA and LTE Repeater", category: "GCS" },
                    { sno: 16, product: "Repeater for Cellular Network", variant: "WCDMA Repeater", category: "GCS" },
                    { sno: 17, product: "Base Station for Cellular Network", variant: "BTS for GSM", category: "GCS" },
                    { sno: 18, product: "Base Station for Cellular Network", variant: "BTS with AAS", category: "GCS" },
                    { sno: 19, product: "Base Station for Cellular Network", variant: "BTS with MSR", category: "GCS" },
                    { sno: 20, product: "Base Station for Cellular Network", variant: "eNodeB for LTE", category: "GCS" },
                    { sno: 21, product: "Base Station for Cellular Network", variant: "NodeB for WCDMA", category: "GCS" },
                    { sno: 22, product: "Compact Cellular Network", variant: "BTS CCN", category: "GCS" },
                    { sno: 23, product: "Compact Cellular Network", variant: "eNodeB CCN", category: "GCS" },
                    { sno: 24, product: "Compact Cellular Network", variant: "NodeB CCN", category: "GCS" },
                  ].map((item) => (
                    <TableRow key={item.sno} className="hover:bg-gray-50">
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d] font-medium">
                        {item.sno}.
          ...
          <AccordionItem value="phase-4" className="border-none">
            ...
            <AccordionContent className="pt-3 pb-0">
              <p className="font-geist text-sm md:text-base text-[#42434d] tracking-wide text-left max-w-full leading-relaxed mb-4">
                The date of mandatory certification for products covered under
                MTCTE Phase IV varies, with some products requiring mandatory
                TEC certification from 1 October 2023, while others will need
                certification starting from 1 January 2024.
              </p>
              <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
                <TableHeader className="bg-[#F9F7F2]">
                  <TableRow className="bg-[#1A8781]/10">
                ...
                <TableBody className="bg-white divide-y divide-gray-200">
                  {[
                    { sno: 1, product: "LAN Switch", variant: "L2 LAN Switch", category: "SCS" },
                    { sno: 2, product: "LAN Switch", variant: "L3 LAN Switch", category: "SCS" },
                    { sno: 3, product: "LAN Switch", variant: "MPLS TP CEN Switch", category: "SCS" },
                    { sno: 4, product: "LAN Switch", variant: "L2 Unmanaged Switch", category: "SCS" },
                    { sno: 5, product: "Router", variant: "BNG or BRAS Router", category: "SCS" },
                    { sno: 6, product: "Router", variant: "Cloud Control Capable Router", category: "SCS" },
                    { sno: 7, product: "Router", variant: "IPV4 Router", category: "SCS" },
                    { sno: 8, product: "Router", variant: "IPV6 Router", category: "SCS" },
                    { sno: 9, product: "Router", variant: "MPLS Router", category: "SCS" },
                    { sno: 10, product: "IP Security Equipment", variant: "Firewall Equipment", category: "SCS" },
                    { sno: 11, product: "IP Security Equipment", variant: "Intrusion Detection System Equipment", category: "SCS" },
                    { sno: 12, product: "IP Security Equipment", variant: "Intrusion Prevention System Equipment", category: "SCS" },
                    { sno: 13, product: "IP Security Equipment", variant: "Unified Threat Management Equipment", category: "SCS" },
                    { sno: 14, product: "Media Gateway", variant: "Line Media Gateway", category: "SCS" },
                    { sno: 15, product: "Media Gateway", variant: "Media Gateway", category: "SCS" },
                    { sno: 16, product: "Media Gateway", variant: "Media Gateway for CPE", category: "SCS" },
                    { sno: 17, product: "Signalling Gateway", variant: "Signalling Gateway", category: "SCS" },
                    { sno: 18, product: "Softswitch", variant: "Softswitch", category: "SCS" },
                    { sno: 19, product: "Infiniband Switch", variant: "Infiniband Switch", category: "SCS" },
                    { sno: 20, product: "IP Multimedia Conferencing Equipment", variant: "IP Multimedia Conferencing Equipment", category: "SCS" },
                    { sno: 21, product: "Conferencing Equipment", variant: "Audio Conference Facility Device", category: "SCS" },
                    { sno: 22, product: "Conferencing Equipment", variant: "Multi Line Telephone System", category: "SCS" },
                    { sno: 23, product: "Optical Fibre Cable", variant: "Hybrid Cable - Optical and Metallic", category: "SCS" },
                    { sno: 24, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - ADSS on Aerial alignment", category: "SCS" },
                    { sno: 25, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - ADSS over Power line", category: "SCS" },
                    { sno: 26, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Direct Buried", category: "SCS" },
                    { sno: 27, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - DSA", category: "SCS" },
                    { sno: 28, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Duct", category: "SCS" },
                    { sno: 29, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - In home", category: "SCS" },
                    { sno: 30, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Indoor", category: "SCS" },
                    { sno: 31, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Indoor or Outdoor", category: "SCS" },
                    { sno: 32, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Lashed Aerial", category: "SCS" },
                    { sno: 33, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Micro-Duct", category: "SCS" },
                    { sno: 34, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Outdoor", category: "SCS" },
                    { sno: 35, product: "Optical Fibre Cable", variant: "Optical Fibre Cable - Riser", category: "SCS" },
                    { sno: 36, product: "Optical Fibre Cable", variant: "Optical Ground Wire - OPGW", category: "SCS" },
                    { sno: 37, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.652.D", category: "GCS" },
                    { sno: 38, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.655", category: "GCS" },
                    { sno: 39, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.656", category: "GCS" },
                    { sno: 40, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.657.A1", category: "GCS" },
                    { sno: 41, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.657.A2", category: "GCS" },
                    { sno: 42, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.657.B3", category: "GCS" },
                    { sno: 43, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.654.D", category: "GCS" },
                    { sno: 44, product: "Optical Fibre - Single Mode", variant: "Optical Fibre - G.654.E", category: "GCS" },
                    { sno: 45, product: "HF Radio", variant: "HF Base Station - Baseband plus Radio", category: "GCS" },
                    { sno: 46, product: "HF Radio", variant: "HF Base Station - Radio Only", category: "GCS" },
                    { sno: 47, product: "HF Radio", variant: "HF Baseband Equipment without Radio", category: "GCS" },
                    { sno: 48, product: "HF Radio", variant: "HF Fixed Station", category: "GCS" },
                    { sno: 49, product: "HF Radio", variant: "HF Handheld Portable Stations", category: "GCS" },
                    { sno: 50, product: "HF Radio", variant: "HF Mobile Stations", category: "GCS" },
                    { sno: 51, product: "Session Border Controller", variant: "Session Border Controller", category: "SCS" },
                    { sno: 52, product: "Mobile Radio Trunking System", variant: "MRTS Base Station - Baseband plus Radio", category: "GCS" },
                    { sno: 53, product: "Mobile Radio Trunking System", variant: "MRTS Base Station - Radio Only", category: "GCS" },
                    { sno: 54, product: "Mobile Radio Trunking System", variant: "MRTS Baseband Equipment without Radio", category: "GCS" },
                    { sno: 55, product: "Mobile Radio Trunking System", variant: "MRTS Fixed Station", category: "GCS" },
                    { sno: 56, product: "Mobile Radio Trunking System", variant: "MRTS Handheld Portable Station", category: "GCS" },
                    { sno: 57, product: "Mobile Radio Trunking System", variant: "MRTS Mobile Station", category: "GCS" },
                    { sno: 58, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Base Station - Baseband plus Radio", category: "GCS" },
                    { sno: 59, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Base Station - Radio Only", category: "GCS" },
                    { sno: 60, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Baseband Equipment without Radio", category: "GCS" },
                    { sno: 61, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Fixed Station", category: "GCS" },
                    { sno: 62, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Handheld Portable Stations", category: "GCS" },
                    { sno: 63, product: "VHF UHF Radio System Equipment", variant: "VHF UHF Mobile Stations", category: "GCS" },
                    { sno: 64, product: "PTP PMP Microwave Fixed Radio Systems", variant: "PTP or PMP Full Outdoor Microwave Systems", category: "GCS" },
                    { sno: 65, product: "PTP PMP Microwave Fixed Radio Systems", variant: "PTP or PMP Split MW Indoor Unit", category: "GCS" },
                    { sno: 66, product: "PTP PMP Microwave Fixed Radio Systems", variant: "PTP or PMP Split MW Outdoor Unit", category: "GCS" },
                    { sno: 67, product: "DSL Equipments", variant: "DSL NT Modem", category: "SCS" },
                    { sno: 68, product: "DSL Equipments", variant: "DSLAM COT", category: "SCS" },
                    { sno: 69, product: "DSL Equipments", variant: "OMSAN", category: "SCS" },
                    { sno: 70, product: "Satellite Communication Equipment", variant: "Satellite Amplifier", category: "GCS" },
                    { sno: 71, product: "Satellite Communication Equipment", variant: "Satellite Baseband Mod or Demod or Controller", category: "GCS" },
                    { sno: 72, product: "Satellite Communication Equipment", variant: "Satellite Baseband Modem", category: "GCS" },
                    { sno: 73, product: "Satellite Communication Equipment", variant: "Satellite Baseband Modem Controller", category: "GCS" },
                    { sno: 74, product: "Satellite Communication Equipment", variant: "Satellite BUC", category: "GCS" },
                    { sno: 75, product: "Satellite Communication Equipment", variant: "Satellite IF Transreceiver", category: "GCS" },
                    { sno: 76, product: "Satellite Communication Equipment", variant: "Satellite LNA", category: "GCS" },
                    { sno: 77, product: "Satellite Communication Equipment", variant: "Satellite LNB", category: "GCS" },
                    { sno: 78, product: "Satellite Communication Equipment", variant: "Satellite Optimisation Equipment", category: "GCS" },
                    { sno: 79, product: "Satellite Communication Equipment", variant: "Satellite Radio Frequency Transceiver", category: "GCS" },
                    { sno: 80, product: "Satellite Communication Equipment", variant: "VSAT Terminals", category: "GCS" },
                    { sno: 81, product: "Precision Timing Protocol Grand Master Equipment", variant: "Precision Timing Protocol Grand Master Equipment", category: "GCS" },
                    { sno: 82, product: "Mobile Management Entity", variant: "MME for 2G or 3G or 4G", category: "SCS" },
                    { sno: 83, product: "Mobile Management Entity", variant: "MME for LTE only", category: "SCS" },
                    { sno: 84, product: "Cell Broadcast Centre", variant: "CBC for GSM", category: "SCS" },
                    { sno: 85, product: "Cell Broadcast Centre", variant: "CBC for LTE or LTE-A", category: "SCS" },
                    { sno: 86, product: "Cell Broadcast Centre", variant: "CBC For UMTS", category: "SCS" },
                    { sno: 87, product: "BSC RNC", variant: "BSC for GSM", category: "GCS" },
                    { sno: 88, product: "BSC RNC", variant: "RNC for WCDMA", category: "GCS" },
                    { sno: 89, product: "SMLC or eSMLC", variant: "eSMLC for LTE", category: "SCS" },
                    { sno: 90, product: "SMLC or eSMLC", variant: "SMLC for GSM", category: "SCS" },
                    { sno: 91, product: "SMLC or eSMLC", variant: "SMLC for WCDMA", category: "SCS" },
                    { sno: 92, product: "SGSN or GGSN", variant: "GGSN", category: "SCS" },
                    { sno: 93, product: "SGSN or GGSN", variant: "SGSN For GSM", category: "SCS" },
                    { sno: 94, product: "SGSN or GGSN", variant: "SGSN For LTE", category: "SCS" },
                    { sno: 95, product: "SGSN or GGSN", variant: "SGSN For WCDMA", category: "SCS" },
                    { sno: 96, product: "HLR AUC HSS", variant: "HLR or AUC", category: "SCS" },
                    { sno: 97, product: "HLR AUC HSS", variant: "HSS", category: "SCS" },
                    { sno: 98, product: "MSC or MSC-S or GMSC or GMSC-S including VLR", variant: "MSC-S or GMSC-S", category: "SCS" },
                    { sno: 99, product: "MSC or MSC-S or GMSC or GMSC-S including VLR", variant: "MSC or GMSC including VLR for GSM", category: "SCS" },
                    { sno: 100, product: "MSC or MSC-S or GMSC or GMSC-S including VLR", variant: "MSC or GMSC including VLR for WCDMA", category: "SCS" },
                    { sno: 101, product: "OTA and DM or FOTA", variant: "DM or FOTA", category: "SCS" },
                    { sno: 102, product: "OTA and DM or FOTA", variant: "OTA", category: "SCS" },
                    { sno: 103, product: "SCP", variant: "SCP", category: "SCS" },
                    { sno: 104, product: "OMC or EMS or NMS or OSS", variant: "NMS", category: "SCS" },
                    { sno: 105, product: "OMC or EMS or NMS or OSS", variant: "OMC or EMS", category: "SCS" },
                    { sno: 106, product: "S-GW or P-GW", variant: "P-Gateway", category: "GCS" },
                    { sno: 107, product: "S-GW or P-GW", variant: "S-Gateway", category: "GCS" },
                    { sno: 108, product: "SMSC", variant: "SMSC", category: "SCS" },
                    { sno: 109, product: "GMLC", variant: "GMLC for GSM or WCDMA", category: "SCS" },
                    { sno: 110, product: "GMLC", variant: "GMLC for LTE or LTE-A", category: "SCS" },
                    { sno: 111, product: "EIR", variant: "EIR for GSM or WCDMA", category: "SCS" },
                    { sno: 112, product: "EIR", variant: "EIR for LTE", category: "SCS" },
                    { sno: 113, product: "SIM", variant: "CSIM", category: "GCS" },
                    { sno: 114, product: "SIM", variant: "eSIM", category: "GCS" },
                    { sno: 115, product: "SIM", variant: "eUICC", category: "GCS" },
                    { sno: 116, product: "SIM", variant: "RUIM", category: "GCS" },
                    { sno: 117, product: "SIM", variant: "SIM", category: "GCS" },
                    { sno: 118, product: "SIM", variant: "UICC based ISIM", category: "GCS" },
                    { sno: 119, product: "SIM", variant: "USIM", category: "GCS" },
                    { sno: 120, product: "Radio Broadcast Receiver RBR", variant: "All Motor vehicle RBRs requiring external power", category: "SCS" },
                    { sno: 121, product: "Radio Broadcast Receiver RBR", variant: "Radio Broadcast receivers driven with in-built power source.", category: "SCS" },
                    { sno: 122, product: "Radio Broadcast Receiver RBR", variant: "Other devices having radio broadcast receivers interfaces.", category: "SCS" },
                    { sno: 123, product: "Transmission Terminal Equipment - 2", variant: "DWDM Equipment", category: "GCS" },
                    { sno: 124, product: "Transmission Terminal Equipment - 2", variant: "Digital Cross Connect", category: "GCS" },
                    { sno: 125, product: "Base Station for Cellular Network for 5G", variant: "Base Station 5G NR Type 1C", category: "GCS" },
                    { sno: 126, product: "Base Station for Cellular Network for 5G", variant: "Base Station 5G NR Type 1O", category: "GCS" },
                    { sno: 127, product: "Base Station for Cellular Network for 5G", variant: "Active Antenna System - OTA", category: "GCS" },
                    { sno: 128, product: "Base Station for Cellular Network for 5G", variant: "BTS with Multi Standard Radio", category: "GCS" },
                    { sno: 129, product: "Base Station for Cellular Network for 5G", variant: "Base Station 5G NR Type 1H", category: "GCS" },
                    { sno: 130, product: "Base Station for Cellular Network for 5G", variant: "Base Station 5G NR Type 2O", category: "GCS" },
                    { sno: 131, product: "Base Station for Cellular Network for 5G", variant: "Hybrid Active Antenna System", category: "GCS" },
                  ].map((item) => (
                    <TableRow key={item.sno} className="hover:bg-gray-50">
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d] font-medium">
                        {item.sno}.
          ...
          <AccordionItem value="phase-5" className="border-none">
            ...
            <AccordionContent className="pt-3 pb-0">
              <p className="font-geist text-sm md:text-base text-[#42434d] tracking-wide text-left max-w-full leading-relaxed mb-4">
                In accordance with the Indian Telegraph (Amendment) Rules 2017,
                pertaining to the Mandatory Testing & Certification of Telecom
                Equipment (MTCTE) regime, the acceptance of applications for
                Phase-V on the MTCTE portal will commence from July 1, 2023.
                Furthermore, certification for Phase-V products (ERs) becomes
              ...
              <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
                ...
                <TableBody className="bg-white divide-y divide-gray-200">
                  {[
                    { sno: 1, product: "Base station for cellular network for 5G", variant: "BTS with Multi Standard Radio", category: "GCS" },
                    { sno: 2, product: "Base station for cellular network for 5G", variant: "Active Antenna System-OTA", category: "GCS" },
                    { sno: 3, product: "Base station for cellular network for 5G", variant: "Base Station 5G NR Type 1C", category: "GCS" },
                    { sno: 4, product: "Base station for cellular network for 5G", variant: "Base Station 5G NR Type 1H", category: "GCS" },
                    { sno: 5, product: "Base station for cellular network for 5G", variant: "Base Station 5G NR Type 1H", category: "GCS" },
                    { sno: 6, product: "Base station for cellular network for 5G", variant: "Base Station 5G NR Type 1O", category: "GCS" },
                    { sno: 7, product: "Base station for cellular network for 5G", variant: "Base Station 5G NR Type 2O", category: "GCS" },
                    { sno: 8, product: "Base station for cellular network for 5G", variant: "Hybrid Active Antenna System", category: "GCS" },
                    { sno: 9, product: "5G Core", variant: "AMF", category: "SCS" },
                    { sno: 10, product: "5G Core", variant: "AUSF", category: "SCS" },
                    { sno: 11, product: "5G Core", variant: "BSF", category: "SCS" },
                    { sno: 12, product: "5G Core", variant: "CHF", category: "SCS" },
                    { sno: 13, product: "5G Core", variant: "NEF", category: "SCS" },
                    { sno: 14, product: "5G Core", variant: "NSSF", category: "SCS" },
                    { sno: 15, product: "5G Core", variant: "PCF", category: "SCS" },
                    { sno: 16, product: "5G Core", variant: "SMF", category: "SCS" },
                    { sno: 17, product: "5G Core", variant: "SMSF", category: "SCS" },
                    { sno: 18, product: "5G Core", variant: "UDM", category: "SCS" },
                    { sno: 19, product: "5G Core", variant: "UDR", category: "SCS" },
                    { sno: 20, product: "5G Core", variant: "UPF", category: "SCS" },
                    { sno: 21, product: "Hypervisor", variant: "Hypervisor", category: "SCS" },
                    { sno: 22, product: "E-band Fixed Radio Relay System", variant: "E-Band MW Full Outdoor System", category: "GCS" },
                    { sno: 23, product: "E-band Fixed Radio Relay System", variant: "E-Band MW Outdoor System plus Indoor System", category: "GCS" },
                    { sno: 24, product: "Converged Multi service Application Access Equipment (C-MSAAE)", variant: "C-MSAAE", category: "SCS" },
                    { sno: 25, product: "IP Terminal", variant: "SIP Terminal", category: "SCS" },
                    { sno: 26, product: "Hybrid Set Top Box", variant: "Hybrid Set Top Box", category: "SCS" },
                  ].map((item) => (
                    <TableRow key={item.sno} className="hover:bg-gray-50">
                      <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d] font-medium">
                        {item.sno}.
