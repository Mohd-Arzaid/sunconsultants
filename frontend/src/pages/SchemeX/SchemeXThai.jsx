...
const SchemeXServiceFaq = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "ค่าใช้จ่ายของ Scheme X รวมถึงค่าธรรมเนียมการสมัคร ค่าธรรมเนียมการรับรอง ค่าทบทวนไฟล์ทางเทคนิค ค่าโรงงานตรวจสอบ และค่าทดสอบผลิตภัณฑ์ โดยเฉลี่ยเริ่มต้นที่ ₹2,000 สำหรับการสมัครและอาจสูงขึ้นตามความซับซ้อนของผลิตภัณฑ์ สำหรับรายละเอียดเพิ่มเติม ติดต่อเราที่ info@sunconsultants.co.in",
    },
    {
