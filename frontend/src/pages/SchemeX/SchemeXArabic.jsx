...
const SchemeXServiceFaq = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "تشمل تكلفة النظام X رسوم التقديم، ورسوم الشهادة، ورسوم مراجعة الملف الفني، وتكاليف تفتيش المصنع، ورسوم اختبار المنتج. في المتوسط، تبدأ من ₹2,000 للتقديم ويمكن أن ترتفع حسب تعقيد المنتج. للمزيد من التفاصيل اتصل بنا على admin@bis-certifications.com.",
    },
    {
