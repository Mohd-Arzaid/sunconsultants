...
const SchemeXArabicMetaTags = () => {
  ...
  return (
    <Helmet>
      {/* Basic Meta Tags */}
      <title>شهادة نظام X لـ BIS | سلامة الآلات والمعدات الكهربائية</title>
      <meta
        name="description"
        ...
        <div className="w-fit font-inter">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>شهادة BIS الهندية تحت النظام X</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
        ...
        <div className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
          ...
          <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
            تغطي شهادة نظام X لـ BIS الآلات، والمعدات الكهربائية، وتجميعات
            المكونات، والتجميعات الفرعية تحت اللائحة الفنية الشاملة (OTR).
          </p>
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "شكرًا لك على الاتصال بنا. سيعود فريقنا إليك قريبًا.",
      });
      ...
      toast({
        ...
        description: "حدث خطأ ما. يرجى التحقق من تفاصيلك وحاول مرة أخرى.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div className="w-full pb-12">
      <div className="max-w-[88rem] mx-auto px-4 md:px-12">
        ...
        <div className="relative mb-6">
          ...
          <input
            type="text"
            placeholder={"البحث حسب الوصف أو رمز HS..."}
            value={searchQuery}
...
const productDataTableThird = [
  ...
  },
  {
    ...
    title: "متطلبات سلامة آلات النسيج الجزء 6 آلات تصنيع الأقمشة",
  },
  {
    id: 9,
  ...
  },
  {
    ...
    title: "آلات البلاستيك والمطاط - آلات القولبة بالحقن - متطلبات السلامة",
  },
  {
    id: 13,
    description:
  ...
  },
  {
    ...
    title:
      "البند 7 من محولات أشباه الموصلات الجزء 1 المتطلبات العامة ومحولات التبديل بالخط القسم 1 مواصفات المتطلبات الأساسية",
  },
  {
    id: 19,
    description:
  ...
  return (
    <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
      <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
        النوع C (معايير السلامة للآلات تتعامل مع المتطلبات التفصيلية للسلامة
        لآلة معينة أو مجموعة من الآلات)
      </p>
...
const productDataTableSecond = [
  {
    ...
    title: "سلامة الآلات معدات كهربائية للآلات الجزء 1 المتطلبات العامة",
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: "سلامة الآلات-معدات كهربائية للآلات الجزء 32 متطلبات آلات الرفع",
  },
  {
    id: 21,
  ...
  },
  {
    ...
    title: "سلامة الآلات - الإشارة والعلامة والتشغيل الجزء 2 متطلبات العلامة",
  },
  {
    id: 25,
  ...
  },
  {
    ...
    title: "سلامة الآلات متطلبات النظافة لتصميم الآلات",
  },
  {
    id: 27,
  ...
  },
  {
    ...
    title: "سلامة الآلات الفجوات الدنيا لتجنب سحق أجزاء الجسم البشري",
  },
  {
    id: 39,
    isNumber: "IS 16817: 2020/ ISO 13851 : 2019",
    title: "سلامة الآلات أجهزة التحكم بيدين مبادئ التصميم والاختيار",
  },
  {
    id: 40,
  ...
  },
  {
    ...
    title: "سلامة الآلات المزلقات بالاتصال العرضي بالمنتج -- متطلبات النظافة",
  },
  {
    id: 42,
  ...
  },
  {
    ...
    title: "الإرگونوميا - نظام الإشارات السمعية والبصرية للخطر والمعلومات",
  },
  {
    id: 48,
...
const TypeBTable = ({ tableRef, searchQuery }) => {
  ...
  return (
    <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
      <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
        النوع B (المعايير العامة للسلامة تتعامل مع جانب سلامة واحد أو أكثر من
        نوع واحد من الحراسة يمكن استخدامها عبر مجموعة واسعة من الآلات)
      </p>
  ...
  const faqData = [
    {
      ...
      answer:
        "النظام X هو نظام تقييم الامتثال تم إدخاله بواسطة BIS الهندي للآلات والمعدات الكهربائية. يضمن الامتثال لمعايير السلامة والفنية الصارمة كما هو محدد في اللائحة الفنية الشاملة.",
    },
    {
      question: "2. هل النظام X مختلف عن شهادة علامة ISI؟",
      answer:
        "نعم. علامة ISI عادة للسلع الاستهلاكية والامتثال الأساسي للمنتج، بينما ينطبق النظام X على المنتجات المعقدة والصناعية التي تتطلب اختبارًا وشهادة متقدمة من خلال شهادة BIS أو رخصة BIS.",
    },
    {
      question: "3. من يحتاج إلى التقدم بطلب لشهادة النظام X؟",
      answer:
        "يجب على مصنعي ومستوردي الآلات والمعدات الكهربائية المدرجة تحت اللائحة الفنية الشاملة التقدم بطلب للنظام X والحصول على شهادة BIS صالحة لبيع أو توزيع منتجاتهم قانونيًا في الهند. يجب على المصنعين العالميين أو الأجانب الراغبين في بيع المنتج في الهند الامتثال لهذه اللوائح أيضًا.",
    },
    {
      question: "4. ما هو تكلفة شهادة نظام X لـ BIS؟",
      answer:
        "تشمل تكلفة النظام X رسوم التقديم، ورسوم الشهادة، ورسوم مراجعة الملف الفني، وتكاليف تفتيش المصنع، ورسوم اختبار المنتج. في المتوسط، تبدأ من ₹2,000 للتقديم ويمكن أن ترتفع حسب تعقيد المنتج. للمزيد من التفاصيل اتصل بنا على suncertificationsindia@gmail.com.",
    },
    {
      question: "5. كم من الوقت يستغرق الحصول على رخصة BIS تحت النظام X؟",
      answer:
        "يختلف الجدول الزمني حسب الوثائق، ومتطلبات الاختبار، وتفتيش المصنع. عادة، يستغرق 4-6 أسابيع من تاريخ تسجيل BIS الناجح وتقديم الطلب للمصنعين الهنديين و60-90 يومًا للمصنعين الأجانب.",
    },
    {
      question:
        "6. هل يمكن للمؤسسات الصغيرة والمتوسطة التقدم أيضًا لشهادة BIS تحت النظام X؟",
      answer:
        "بالتأكيد. في الواقع، يشجع BIS الهندي المؤسسات الصغيرة والمتوسطة على التقدم برخصة BIS أو شهادة الامتثال تحت النظام X لتعزيز الجودة والامتثال والتنافسية في القطاع الصناعي.",
    },
    {
      question: "7. هل شهادة BIS تحت النظام X إلزامية للصادرات؟",
      answer:
        "لا. المنتجات المصنعة حصريًا للتصدير معفاة تحت اللائحة الفنية الشاملة. ومع ذلك، يجب أن تكون المنتجات المقصودة للأسواق الهندية معتمدة تحت النظام X.",
    },
    {
      question: "8. ما هي صلاحية رخصة BIS تحت النظام X؟",
      answer:
        "رخصة BIS تحت النظام X صالحة عادة لمدة 3-6 سنوات ويجب تجديدها وفقًا لذلك. يتضمن التجديد دفع رسوم الشهادة السنوية لـ BIS وقد يتطلب إعادة التقييم حسب التغييرات في نطاق المنتج أو المعايير.",
    },
    {
      question: "9. هل يمكن للمصنعين الأجانب التقدم لشهادة النظام X؟",
      answer:
        "نعم، يمكن للمصنعين الأجانب التقدم لشهادة النظام X من خلال ممثل هندي مصرح. يتطلب BIS الهندي تفتيش مصنع، والذي قد يستغرق 3 أيام للمتقدمين الأجانب، بالإضافة إلى عمليات التسجيل والاختبار القياسية لـ BIS.",
    },
    {
      question: "10. ما هو الملف الفني ولماذا هو مطلوب؟",
      answer:
        "الملف الفني هو ملف امتثال مفصل مطلوب تحت النظام X. يشمل عمليات التصنيع، وتفاصيل المنتج، وتقارير الاختبار، ووثائق التحكم في الجودة. يدعم امتثال المنتج للمعايير الهندية ذات الصلة أثناء عملية شهادة BIS.",
    },
    {
      question: "11. كيف يرتبط النظام X باللائحة الفنية الشاملة؟",
      answer:
        "تفرض اللائحة الفنية الشاملة استخدام النظام X لفئات محددة من الآلات والمعدات الكهربائية في الهند. يجب على المنتجات المدرجة تحت اللائحة أن تكون معتمدة تحت النظام X للحصول على شهادة BIS صالحة أو رخصة BIS.",
    },
    {
      question: "12. هل يمكن إلغاء شهادة BIS تحت النظام X؟",
      answer:
        "نعم. يمكن لـ BIS الهندي تعليق أو إلغاء رخصة BIS أو شهادة تحت النظام X إذا تم العثور على عدم امتثال أثناء الرصد أو إذا فشل المنتج في الامتثال للمعايير الهندية المطلوبة.",
    },
    {
      question: "13. ما الفرق بين رخصة BIS وشهادة BIS تحت النظام X؟",
      answer:
        "تصدر رخصة BIS عادة للمصنعين الهنديين، بينما تصدر شهادة الامتثال (CoC) للمصنعين الأجانب أو للحالات المحددة. كلاهما يخدمان الغرض نفسه - ضمان امتثال المنتج تحت النظام X.",
    },
    {
      question: "14. هل يُسمح بعلامة ISI للمنتجات المعتمدة تحت النظام X؟",
      answer:
        "لا. المنتجات تحت النظام X لا تحمل علامة ISI. بدلاً من ذلك، تعرض علامة المعيار BIS ذات الصلة بالنظام الشهادة، كما هو محدد بواسطة BIS الهندي.",
    },
    {
      question: "كيف أعرف إذا كانت آلتي تتطلب شهادة النظام X؟",
      answer:
        "تحقق من القائمة الرسمية في اللائحة الفنية الشاملة أو استشر مستشار BIS للتحقق مما إذا كانت آلتك تخضع لمتطلبات شهادة النظام X الإلزامية.",
    },
  ];
...
const SchemeXMainContentLeftConclusionSection = () => {
  return (
    <div id="conclusion" className="flex flex-col scroll-mt-20">
      ...
      <h2 className="service-left-content-heading-two">الخاتمة</h2>

      <p className="service-left-content-paragraph">
        تظل شهادة نظام X لـ BIS حيوية في الحفاظ على السلامة، والموثوقية، وجودة
        المفاتيح المنخفضة الجهد ومعدات التحكم، والآلات والمعدات الكهربائية.
        بالنسبة لمصنعي أدوات الآلات القابلة لمعالجة الحجر، والسيراميك،
        والخرسانة، والأسمنت الأسبستي والزجاج المعدني، شهادة نظام X لـ BIS
        إلزامية.
      </p>

      <p className="service-left-content-paragraph">
        من خلال الوفاء بهذه الالتزامات، يضمن المصنعون امتثال المنتج، وتعزيز ثقة
        المستهلك، بالإضافة إلى تحسين مصداقيتهم في السوق. يضمن النظام X أن تكون
        الإنتاج سلسًا قدر الإمكان، وأن تلبي معايير السلامة حول العالم، وأن تحصل
...
const SchemeXMainContentLeftDocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        لتبسيط عملية شهادة BIS، يُطلب من المصنعين جمع وتقديم الوثائق التالية
        أثناء مرحلة التسجيل:
      </p>
        ...
        <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
          ...
          <TableBody className="bg-white divide-y divide-gray-200">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                عنوان البريد الإلكتروني، ورقم الهاتف المحمول، والخط الثابت
                للاتصالات الرسمية
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                تفاصيل الآلات والمعدات المشمولة تحت الجدول الأول من اللائحة
                الفنية الشاملة
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                جميع التفاصيل الفنية المتعلقة بالمنتج وتفاصيل وحدة التصنيع.
              </TableCell>
            </TableRow>
          </TableBody>
        </Table>
...
const SchemeXMainContentLeftProcessSection = () => {
  return (
    <div id="process" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        إصدار شهادة BIS تحت النظام X هو نشاط منهجي يهدف إلى ضمان أن يكون لدى
        المصنع السلامة، والجودة، و معايير الامتثال المطبقة ملباة. العملية
        كالتالي:
      </p>
      ...
      <p className="service-left-content-paragraph">
        يخدم هذا الملف كدليل فني وإحصائي على ادعاء المنتج الذي يدعم معايير
        السلامة.
      </p>

      <p className="service-left-content-paragraph">
        خلال فترة التفتيش، يُتوقع من مسؤولي BIS أن: يحللوا الملف الفني، يقيموا
        طرق التصنيع بالإضافة إلى أنظمة ضمان الجودة الداعمة، يراقبوا اختبار
        المنتج، يحددوا عدم الامتثال (إن وجد) ويعطوا خطوات علاجية. يُقدم تقرير
        مفصل عن التدقيق للمتقدم بعد الزيارة.
      </p>

      <p className="service-left-content-paragraph">
        تحافظ هذه الاستراتيجية على الامتثال لمعيار BIS وهي اعتراف بالامتثال
        الهندي والدولي، مما يجعل الصناعة تركز على ثقة المستهلك تجاه السلامة
        والجودة.
      </p>
      ...
      <p className="service-left-content-paragraph">
        يتبع المصنعون المحليون نهجًا مباشرًا من خلال الحصول على رخصة BIS تحت
        النظام X. تشمل الخطوات المباشرة التالية:
      </p>
      ...
      <p className="service-left-content-paragraph">
        بخلاف المصنعين المحليين، يُطلب من المصنعين الأجانب التقدم لشهادة BIS تحت
        النظام X الامتثال لعملية أكثر صرامة وخطوات إضافية. يُفصل الإجراء
        كالتالي.
      </p>
      ...
      <p className="service-left-content-paragraph">
        يشمل التدقيق: تقييم أنظمة ضمان الجودة وسير العمل في عمليات التصنيع،
        تقييم الامتثال والوثائق الفنية، اختيار عينة اختبار مستقلة.
      </p>

      <p className="service-left-content-paragraph">
        تستغرق العملية بأكملها، بناءً على ممارسات BIS، حوالي 6-7 أشهر.
      </p>
...
const SchemeXMainContentLeftOverviewSection = () => {
  ...
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        أطلقت مكتب المعايير الهندي، أو BIS باختصار، &ldquo;النظام X&rdquo; في 16
        مارس 2022، بهدف تحسين الامتثال لسلامة وجودة المنتج في الهند. يمكن
        للمصنعين الهنديين والأجانب التقدم بطلب لشهادة BIS للآلات والمعدات
        الكهربائية، والمكونات مثل التجميعات، والتجميعات الفرعية، والأدوات
        المحددة في الجدول II من النظام X وأخذ الشهادة قبل التصدير، أو البيع، أو
        التوزيع في الهند.
      </p>

      <p className="service-left-content-paragraph">
        تحت النظام X، يمكن للمصنعين التقدم بطلب لـ رخصة BIS أو شهادة امتثال
        (CoC) لمفاتيح الجهد المنخفض ومعدات التحكم والآلات، والمعدات الكهربائية.
        بمجرد اعتماد المصنعين، يُسمح لهم باستخدام علامة المعيار BIS، مما يشير
        إلى أن منتجاتهم تتوافق مع المعايير الموضوعة في الهند.
      </p>

      <p className="service-left-content-paragraph">
        تساعد الشهادة، بينما تعزز المنتج والامتثال للمعايير الهندية ولوائح
        الحكومة، في بناء ثقة وراحة البال لدى المستهلكين في المنتجات المعتمدة.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        2018 وبعد ذلك تم تبسيطه تحت لوائح تقييم الامتثال (التعديل) لـ BIS، 2022.
      </p>

      <p className="service-left-content-paragraph">
        الهدف الرئيسي هو جلب معايير السلامة والجودة الهندية إلى المعايير
        العالمية، خاصة فيما يتعلق بالآلات الصناعية و المعدات الكهربائية.
        المنتجات المصنعة في أو المستوردة إلى الهند تحت هذا النظام تخضع لفحص
        وتقييم صارم لإثبات الفنية، والسلامة، و معايير الأداء.
      </p>

      <p className="service-left-content-paragraph">
        تم تعديل الأحكام تحت النطاق الأصلي لشهادة النظام X وتوسيعها مع الأمر
        الصادر حديثًا بشأن سلامة الآلات والمعدات الكهربائية (اللائحة الفنية
        الشاملة)، 2024، والذي يخضع لاختصاص وزارة الصناعات الثقيلة وتم إحضاره إلى
        التنفيذ بواسطة BIS. يدخل الأمر حيز التنفيذ في 1 سبتمبر 2026، ويغطي طيفًا
        واسعًا من الآلات والمعدات الكهربائية مثل المضخات للتعامل مع السوائل،
        والضواغط، والرافعات، والآلات الكهربائية الدورانية، والمحولات، ومفاتيح
        التحكم ومعدات التحكم.
      </p>

      <p className="service-left-content-paragraph">
        التجميعات، والتجميعات الفرعية والمكونات لهذه الآلات أو المعدات جزء أيضًا
        من نطاق الشهادة وفقًا للقسم 16 من قانون مكتب المعايير الهندي، 2016.
      </p>

      <p className="service-left-content-paragraph">
        علاوة على ذلك، تحت قواعد CMVR 1989 (بناء وتصنيع لائحة الصمام)، البوثر
        والأنواع الأخرى من معدات البناء تحت اختصاص النظام X، يُضمن أن السوق لا
        يتعرض للمعدات التي تفتقر إلى المتطلبات الرئيسية للسلامة والمعايير
        الفنية.
      </p>
      ...
      <p className="service-left-content-paragraph">
        أصدرت وزارة الصناعات الثقيلة &ldquo;اللائحة الفنية الشاملة حول أوامر
        السلامة (سلامة الآلات والمعدات الكهربائية)&rdquo; عبر إخطار E-Gazette في
        28 أغسطس 2024. تهدف هذه اللائحة المبتكرة إلى تحسين - السلامة، والجودة
        وال الامتثال للآلات، والمعدات الكهربائية وتجميعاتها، والفرعية والمكونات،
        تحت النظام X من لائحة BIS، 2016.
      </p>

      <p className="service-left-content-paragraph">
        تحت OTR، تشمل جميع فئات الآلات والمعدات الكهربائية، و جميع أجزائها
        ومكوناتها. ومع ذلك، بعض الفئات مستثناة صراحة:
      </p>
      ...
      <p className="service-left-content-paragraph">
        تم إجراء هذه الاستثناءات لتسهيل الامتثال وتجنب التكرار غير الضروري
        للتنظيم من أجل تعزيز سهولة ممارسة الأعمال.
      </p>

      <p className="service-left-content-paragraph">
        تغطي اللائحة الفنية الشاملة، 2024 جميع الآلات وال المعدات الكهربائية،
        بما في ذلك مفاتيح الجهد المنخفض ومعدات التحكم المُخطرة بواسطة وزارة
        الصناعات الثقيلة، ستُعامل تحت إطار النظام X لشهادة BIS. سيدخل الأمر حيز
        التنفيذ في 1 سبتمبر 2026 حتى يتمكن المصنعون والمستوردون من تعديل
        عملياتهم وفقًا للأوامر الصادرة.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        والمعدات الكهربائية التي تشمل المضخات، والمضخات، والضواغط، والطرد
        المركزي، والرافعات، والمحولات، ومفاتيح التحكم التقدم بطلب لشهادة BIS تحت
        النظام X.
      </p>
      ...
      <p className="service-left-content-paragraph">
        المنتجات التي تحمل علامة المعيار BIS والتي هي علامة امتثال تُشهد وتضمن
        للمستخدمين أن المنتج آمن، موثوق، وذو جودة جيدة. إنها أيضًا علامة ثقة
        وأداء جيد حقًا.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        (MSMEs) الامتثال أيضًا للنظام X والحصول على شهادة BIS لآلاتهم والمعدات
        الكهربائية. بينما قد يبدو أن الامتثال للمتطلبات التنظيمية قد يكون صعبًا،
        فإن شهادة النظام X إضافة قيمة وميزة لـ MSMEs للأسباب التالية:
      </p>
      ...
      <p className="service-left-content-paragraph">
        تشير هذه العلامة إلى أن رخصة BIS قد صدرت بنجاح إلى المصنع. تسمح للمصنع
        بوضع علامة BIS و تضمن للمستهلكين أن المنتج أصلي وآمن.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        عقد صالح. يسمح العقد الصالح فقط للمالك باستخدام العلامة. استخدام العلامة
        بدون عقد صالح جريمة تحت الدستور الهندي وتساوي امتلاك علامة قانونية.
        يُوضع مالك العلامة تحت قيود ثقيلة لاستخدام رخصة CM/L-XXXXXXXXXX للمنتجات
      ...
      <p className="service-left-content-paragraph">
        يمتد هذا الإطار التنظيمي لحماية مصالح المستهلكين ورجال الأعمال، مما يعزز
        سوقًا يركز على السلامة، والشفافية، والثقة.
      </p>
      ...
      <h3 className="service-left-content-heading-three">النظام I</h3>
      ...
      <h3 className="service-left-content-heading-three">النظام X</h3>
        ...
        <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
          ...
          <TableBody className="bg-white divide-y divide-gray-200">
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                841340، 841350، 841360، 841370، 841381، 841382، 841391 و 841392
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
              <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  الحرارة و(أو)تجميعاتها /التجميعات الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  والغازات و(أو)تجميعاتها /التجميعات الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  والتعبئة أو اللف و(أو)تجميعاتها /التجميعات الفرعية/المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                842611، 842612، 842619، 842620، 842630، 842641، 842649، 842691 و
                84269990
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  إلى 8461 و(أو)تجميعاتها /التجميعات الفرعية/المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  والخرسانة، والأسمنت المحتوي على الأسبستوس أو زجاج المعادن
                  المشابه و (أو)تجميعاتها /التجميعات الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                8464 و 84669100
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  والآلات والأجهزة الميكانيكية ذات الوظائف الفردية، غير المحددة
                  أو المشمولة في مكان آخر في الفصل 84 و(أو)تجميعاتها/التجميعات
                  الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  وعناصر النقل الكروية أو الدورانية، وصناديق التروس و مغيرات
                  السرعة، بما في ذلك محولات العزم و (أو)تجميعاتها /التجميعات
                  الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                850421، 850422، 850423، 850431، 850432، 850433، 850434 و 850490
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
              <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  ...
                  فولت و (أو)تجميعاتها /التجميعات الفرعية /المكونات
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                8536، 8537 و 8538
      ...
      <p className="service-left-content-paragraph">
        أكثر من مجرد ضرورة قانونية، تقدم شهادة نظام X لـ BIS وعدًا بالسلامة،
        والجودة، والموثوقية. هذه الشهادة، التي تتضمن الالتزام الصارم بالمعايير
        الوطنية والدولية، تضمن أن الآلات والأجهزة الكهربائية المقدمة للمستخدمين
        آمنة، وصديقة للبيئة، وفنيًا سليمة.
      </p>

      <p className="service-left-content-paragraph">
        للشهادة تحت النظام X، يحتاج المصنعون إلى الامتثال للآتي المكونات
        الرئيسية للسلامة:
      </p>
      ...
      <p className="service-left-content-paragraph">
        يُطلب من المصنعين الامتثال للمعايير الهندية ذات الصلة والتي تتوافق مع
        المعايير الدولية، بما في ذلك:
      </p>

      <h3 className="service-left-content-heading-three">معايير النوع A:</h3>
      ...
      <h3 className="service-left-content-heading-three">معايير النوع B:</h3>
      ...
      <h3 className="service-left-content-heading-three">معايير النوع C:</h3>
