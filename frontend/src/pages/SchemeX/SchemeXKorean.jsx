...
const SchemeXServiceFaq = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "Scheme X 비용에는 신청 수수료, 인증 수수료, 기술 파일 검토 비용, 공장 검사 비용, 제품 테스트 비용이 포함됩니다. 평균적으로 신청은 ₹2,000부터 시작하며 제품 복잡성에 따라 증가할 수 있습니다. 자세한 내용은 suncertificationsindia@gmail.com으로 문의하세요.",
    },
    {
