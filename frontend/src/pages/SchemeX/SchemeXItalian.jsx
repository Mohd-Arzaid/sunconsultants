...
const SchemeXMetaTags = () => {
    ...
    return (
        <Helmet>
            {/* Basic Meta Tags */}
            <title>
                Certificazione BIS Scheme X | Sicurezza Macchinari e Attrezzature Elettriche
            </title>
            <meta
                name="description"
                ...
                <div className="w-fit font-inter">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Certificazione BIS Indiana sotto Scheme-X
                                </BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
            ...
            <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
                ...
                <div className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
                    ...
                    <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
                        La Certificazione BIS Scheme X copre Macchinari, Attrezzature Elettriche e Assiemi di Componenti, e Sotto-assiemi secondo il Regolamento Tecnico Omnibus (OTR).
                    </p>
            ...
            <div className="max-w-[88rem] mx-auto px-4 md:px-12">
                ...
                <div className="relative mb-6">
                    ...
                    <input
                        type="text"
                        placeholder={
                            "Cerca per descrizione o codice HS..."
                        }
                        value={searchQuery}
...
const productDataTableThird = [
    {
        id: 1,
        description: "Tutti i tipi di Pompe per la gestione di liquidi, ascensori per liquidi",
    ...
    },
    {
        ...
        title: "Requisiti di Sicurezza per Macchinari Tessili Parte 1 Requisiti Comuni",
    },
    {
        id: 10,
    ...
    return (
        <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
            <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
                TIPO C (Standard di Sicurezza per Macchine che trattano requisiti di sicurezza dettagliati per una macchina particolare o un gruppo di macchine)
            </p>
...
const productDataTableSecond = [
    ...
    },
    {
        ...
        title: "Macchinari per Movimenti Terra - Protezioni - Definizioni e Requisiti",
    },
    {
        id: 17,
    ...
    },
    {
        ...
        title: "Sicurezza di Macchinari Prevenzione Incendi e Protezione Antincendio",
    },
    {
        id: 26,
    ...
    },
    {
        ...
        title: "Sicurezza di Macchinari Funzione di Arresto di Emergenza Principi per la Progettazione",
    },
    {
        id: 41,
...
const TypeBTable = ({ tableRef, searchQuery }) => {
    ...
    return (
        <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
            <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
                TIPO B (Standard di Sicurezza Generici che trattano un aspetto di sicurezza o più di un tipo di salvaguardia che può essere utilizzato su un'ampia gamma di macchinari)
            </p>
    ...
    const faqData = [
        {
            ...
            answer: "Lo Scheme X è uno schema di valutazione della conformità introdotto dall'indiana BIS per macchinari e attrezzature elettriche. Garantisce la conformità a standard di sicurezza e tecnici rigorosi come specificato nel Regolamento Tecnico Omnibus."
        },
        {
            question: "2. Lo Scheme X è diverso dalla certificazione del marchio ISI?",
            answer: "Sì. Il marchio ISI è generalmente per beni di consumo e conformità di base del prodotto, mentre lo Scheme X si applica a prodotti complessi e di grado industriale che richiedono test e certificazione avanzati attraverso un certificato BIS o licenza BIS."
        },
        {
            question: "3. Chi deve richiedere la certificazione Scheme X?",
            answer: "Produttori e importatori di macchinari e attrezzature elettriche elencati sotto il Regolamento Tecnico Omnibus devono richiedere lo Scheme X e ottenere una certificazione BIS valida per vendere o distribuire legalmente i loro prodotti in India. I produttori globali o esteri intenzionati a vendere prodotti in India devono anche rispettare questi regolamenti."
        },
        {
            question: "4. Qual è il costo della certificazione BIS Scheme X?",
            answer: "Il costo dello Scheme X include tariffe di domanda, tariffe di certificazione, costi di revisione del file tecnico, costi di ispezione della fabbrica e costi di test del prodotto. In media, parte da ₹2.000 per la domanda e può aumentare a seconda della complessità del prodotto. Per maggiori dettagli contattaci all'indirizzo admin@bis-certifications.com."
        },
        {
            question: "5. Quanto tempo ci vuole per ottenere una licenza BIS sotto Scheme X?",
            answer: "La tempistica varia a seconda della documentazione, dei requisiti di test e delle ispezioni della fabbrica. Tipicamente, richiede 4–6 settimane dalla data di registrazione e invio della domanda BIS riuscita per i produttori indiani e 60-90 giorni per i produttori esteri."
        },
        {
            question: "6. Le PMI possono anche richiedere la certificazione BIS sotto Scheme X?",
            answer: "Assolutamente. Di fatto, l'indiana BIS incoraggia le PMI a richiedere una licenza BIS o certificato di conformità sotto lo Scheme X per aumentare qualità, conformità e competitività nel settore industriale."
        },
        {
            question: "7. La certificazione BIS sotto Scheme X è obbligatoria per le esportazioni?",
            answer: "No. I prodotti fabbricati esclusivamente per l'esportazione sono esenti sotto il Regolamento Tecnico Omnibus. Tuttavia, i prodotti destinati ai mercati indiani devono essere certificati sotto Scheme X."
        },
        {
            question: "8. Qual è la validità della licenza BIS sotto Scheme X?",
            answer: "Una licenza BIS sotto Scheme X è generalmente valida per 3-6 anni e deve essere rinnovata di conseguenza. Il rinnovo prevede il pagamento della tariffa annuale di certificazione BIS e potrebbe richiedere una rivalutazione a seconda dei cambiamenti nell'ambito del prodotto o negli standard."
        },
        {
            question: "9. I produttori esteri possono richiedere la certificazione Scheme X?",
            answer: "Sì, i produttori esteri possono richiedere la certificazione Scheme X attraverso un rappresentante indiano autorizzato. L'indiana BIS richiede un'ispezione della fabbrica, che potrebbe richiedere 3 giorni per i richiedenti esteri, insieme ai processi standard di registrazione BIS e test."
        },
        {
            question: "10. Cos'è un File Tecnico e perché è richiesto?",
            answer: "Un File Tecnico è un dossier dettagliato di conformità richiesto sotto Scheme X. Include processi di produzione, dettagli del prodotto, rapporti di test e documenti di controllo qualità. Supporta la conformità del prodotto agli standard indiani pertinenti durante il processo di certificazione BIS."
        },
        {
            question: "11. Come è correlato lo Scheme X al Regolamento Tecnico Omnibus?",
            answer: "Il Regolamento Tecnico Omnibus impone l'uso dello Scheme X per categorie specifiche di macchinari e attrezzature elettriche in India. I prodotti elencati nel regolamento devono essere certificati sotto Scheme X per ottenere un certificato BIS o licenza BIS valido."
        },
        {
            question: "12. Un certificato BIS sotto Scheme X può essere revocato?",
            answer: "Sì. L'indiana BIS può sospendere o annullare una licenza BIS o certificato sotto Scheme X se viene rilevata non conformità durante la sorveglianza o se il prodotto non soddisfa gli standard indiani richiesti."
        },
        {
            question: "13. Qual è la differenza tra licenza BIS e certificato BIS sotto Scheme X?",
            answer: "Una licenza BIS è tipicamente emessa a produttori indiani, mentre un certificato di conformità BIS (CoC) è spesso emesso a produttori esteri o per casi specifici. Entrambi servono lo stesso scopo: garantire la conformità del prodotto sotto Scheme X."
        },
        {
            question: "14. Il marchio ISI è consentito per i prodotti certificati sotto Scheme X?",
            answer: "No. I prodotti sotto Scheme X non portano il marchio ISI. Invece, visualizzano il marchio standard BIS rilevante per lo schema di certificazione, come governato dall'indiana BIS."
        },
        {
            question: "Come so se la mia macchina richiede la certificazione Scheme X?",
            answer: "Controlla l'elenco ufficiale nel Regolamento Tecnico Omnibus o consulta un consulente BIS per verificare se la tua macchina rientra nei requisiti obbligatori di certificazione Scheme X."
        }
    ];
    ...
    return (
        <div id="conclusion" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                ...
                l'affidabilità e la qualità degli interruttori a bassa tensione e apparecchiature di controllo,
                Macchinari e attrezzature elettriche. Per i produttori di macchine
                utensili applicabili alla lavorazione di pietra, ceramiche, calcestruzzo, cemento
                asfaltico e vetro minerale, la certificazione BIS Scheme-X è obbligatoria.
            </p>


            <p className="service-left-content-paragraph">
                Adempiendo a questi obblighi, i produttori garantiscono la conformità del prodotto,
                migliorano la fiducia dei consumatori, nonché migliorano la loro
                credibilità sul mercato. Lo Scheme-X assicura che la produzione sia il più
                fluida possibile, che gli standard di sicurezza in tutto il mondo siano soddisfatti e che i
                marchi riconosciuti guadagnino una reputazione positiva.
            </p>
    ...
    return (
        <div id="documents" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                ...
                a raccogliere e inviare i seguenti documenti durante la fase di registrazione:
            </p>
                    ...
                    <TableBody className="bg-white divide-y divide-gray-200">
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Nome legale completo e indirizzi fisici del sito di produzione
                                e ufficio
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Tipo, modello e varietà specifica per cui viene richiesta la licenza BIS
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                            <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
...
const SchemeXMainContentLeftProcessSection = () => {
    return (
        <div id="process" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                L'emissione del Certificato BIS sotto Scheme-X è un'attività sistematica volta a
                garantire che il produttore abbia soddisfatto gli standard di sicurezza, qualità e
                conformità applicabili. Il processo è il seguente:
            </p>
            ...
            <p className="service-left-content-paragraph">
                Questo file funge da prova tecnica e statistica della
                rivendicazione del prodotto che sostanziano gli standard di tracciabilità di sicurezza.
            </p>


            <p className="service-left-content-paragraph">
                Durante il periodo di ispezione, ci si aspetta che i funzionari BIS:
                Analizzino il file tecnico, Valutino i metodi di produzione insieme
                ai sistemi di assicurazione qualità di supporto, Osservino il test del
                prodotto, Determinino non conformità (se presenti) e forniscano passi remediali. Un
                rapporto dettagliato dell'audit è fornito al richiedente dopo la
                visita.
            </p>
            ...
            <p className="service-left-content-paragraph">
                ...
                riconoscimento della conformità indiana e internazionale, ponendo l'industria sulla fiducia dei consumatori verso sicurezza e qualità.
            </p>
            ...
            <p className="service-left-content-paragraph">
                I produttori domestici seguono un approccio diretto ottenendo la Licenza BIS
                sotto Scheme-X. I passi diretti da seguire includono:
            </p>
            ...
            <p className="service-left-content-paragraph">
                <strong>Tempistica Tipica:</strong> Vicino a 90 giorni lavorativi (secondo la pratica BIS)
                sono necessari. Questo è fornito che non ci siano non conformità chiave.
            </p>
            ...
            <p className="service-left-content-paragraph">
                A differenza dei produttori domestici, i produttori esteri che richiedono un Certificato BIS
                sotto Scheme-X sono tenuti a rispettare un processo più rigoroso
                e passi aggiuntivi. La procedura è dettagliata come segue.
            </p>
            ...
            <p className="service-left-content-paragraph">
                L'audit comprende: Valutazione dei sistemi di assicurazione qualità e dei
                flussi di lavoro nei processi di produzione, Valutazione della conformità
                e della documentazione tecnica, Selezione campione di test indipendente.
            </p>
    ...
    return (
        <div id="overview" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                ...
                &ldquo;Scheme X&rdquo; il 16 marzo 2022, mirato a migliorare la conformità
                sulla sicurezza e qualità del prodotto in India. Produttori indiani ed esteri
                possono richiedere la certificazione BIS per Macchine ed Attrezzature Elettriche,
                componenti Come assemblaggi, sotto-assemblaggi e, e Utensili specificati in
                Allegato-II dello Scheme-X e ottenere certificazione prima di esportare,
                vendere o distribuire in India.
            </p>


            <p className="service-left-content-paragraph">
                Sotto Scheme X, i produttori possono richiedere una Licenza BIS o un
                Certificato di Conformità (CoC) per interruttori a bassa tensione e apparecchiature di controllo,
                macchinari e attrezzature elettriche. Una volta certificati i produttori, sono autorizzati a utilizzare il Marchio Standard BIS, indicando
                che i loro prodotti sono conformi agli standard stabiliti in
                India.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Lo Scheme X è uno schema di certificazione prodotto sviluppato sotto il Regolamento di
                Valutazione della Conformità BIS, 2018 e successivamente semplificato sotto il
                Regolamento di Valutazione della Conformità BIS (Emendamento), 2022.
            </p>



            <p className="service-left-content-paragraph">
                L'obiettivo principale è portare gli standard indiani di sicurezza e qualità a
                standard globali, specialmente per quanto riguarda i macchinari industriali ed
                attrezzature elettriche. I prodotti fabbricati in o importati in India
                sotto questo schema sono sottoposti a scrutinio e valutazione rigorosi per
                dimostrare standard tecnici, di sicurezza, nonché di performance.
            </p>


            <p className="service-left-content-paragraph">
                Le disposizioni sotto l'ambito originale della Certificazione Scheme X sono state
                riviste e ampliate con il nuovo Ordine di Sicurezza Macchinari ed Attrezzature Elettriche
                (Regolamento Tecnico Omnibus), 2024, che è
                sotto la giurisdizione del Ministero delle Industrie Pesanti ed è stato
                portato in vigore dal BIS. L'ordine entra in vigore il 1°
                Settembre 2026, e copre un ampio spettro di macchinari ed attrezzature elettriche
                come pompe per la gestione di liquidi, compressori, gru,
                macchine elettriche rotanti, trasformatori e interruttori e apparecchiature di controllo.
            </p>


            <p className="service-left-content-paragraph">
                Assiemaggi, sotto-assiemaggi e componenti di tali macchinari o attrezzature
                fanno parte anche dell'ambito di certificazione secondo la Sezione 16 del Bureau
            ...
            <p className="service-left-content-paragraph">
                ...
                sotto la giurisdizione dello Scheme X, assicurano che il mercato non
                sia esposto ad attrezzature che mancano dei requisiti di sicurezza e
                standard tecnici.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Il Ministero delle Industrie Pesanti ha rilasciato il &ldquo;Regolamento Tecnico
                Omnibus sugli Ordini di Sicurezza (Sicurezza Macchinari ed Elettrici
                attrezzature)&rdquo; tramite notifica E-Gazette dell'28 agosto 2024. Questo
                regolamento innovativo intende migliorare - sicurezza, qualità e
                conformità di macchinari, attrezzature elettriche e i loro assemblaggi, sub
                assemblaggi e componenti, sotto Scheme X del Regolamento BIS, 2016.
            </p>


            <p className="service-left-content-paragraph">
                Sotto l'OTR, tutte le categorie di macchinari e attrezzature elettriche, e
                tutte le loro parti e componenti sono incluse. Tuttavia, alcune categorie
            ...
            <p className="service-left-content-paragraph">
                Queste eccezioni sono fatte per facilitare la conformità ed evitare duplicazioni
                non necessarie di regolamentazione al fine di promuovere la facilità di fare business.
            </p>
            ...
            <p className="service-left-content-paragraph">
                ...
                attrezzature elettriche, inclusi interruttori a bassa tensione e apparecchiature di controllo
                notificati dal Ministero delle Industrie Pesanti, saranno trattati sotto il
                framework Scheme X della Certificazione BIS. L'Ordine entrerà in vigore
                il 1° Settembre 2026 in modo che i produttori e importatori abbiano
                abbastanza tempo per modificare le loro operazioni secondo gli Ordini emessi.
            </p>
            ...
            <p className="service-left-content-paragraph">
                ...
                centrifughe, gru, trasformatori e interruttori devono richiedere la Certificazione BIS
                sotto Scheme X.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Prodotti che portano il Marchio Standard BIS che è un Marchio di Conformità
                che certifica e assicura agli utenti che il prodotto è sicuro,
                affidabile e di buona qualità. È anche un marchio di fiducia e davvero
                buone prestazioni.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Come in molti altri settori, Micro, Piccole e Medie Imprese (PMI)
                devono anche conformarsi a Scheme X e ottenere la Certificazione BIS per i loro
                macchinari e attrezzature elettriche. Sebbene possa sembrare che la conformità
                ai requisiti regolatori possa essere challenging, il certificato Scheme X
                è un valore aggiunto e un vantaggio per le PMI per i seguenti
                motivi:
            </p>
            ...
            <p className="service-left-content-paragraph">
                Il marchio standard BIS dello Scheme X forma un marchio di qualità e un principio
                di fiducia. Il Logo contiene:
            </p>
            ...
            <p className="service-left-content-paragraph">
                Questo marchio significa che una Licenza BIS è stata emessa con successo al
                produttore. Esenta il produttore a posizionare il Marchio BIS e
            ...
            <p className="service-left-content-paragraph">
                Il Marchio Standard BIS è un marchio di fiducia e qualità. Il marchio è disponibile solo
                dopo che un contratto valido è in atto. Solo un contratto valido
                permette al proprietario di usare il marchio. Usare il marchio senza un contratto valido
                è un reato secondo la costituzione indiana ed è uguale a
                avere un marchio legale. Il proprietario del marchio è posto sotto restrizioni pesanti
                per l'uso della licenza CM/L-XXXXXXXXXX per prodotti
                che non hanno certificazione BIS.
            </p>
                    ...
                    <TableBody className="bg-white divide-y divide-gray-200">
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                ...
                                >
                                    Tutti i tipi di Pompe per la gestione di liquidi, ascensori per liquidi e
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di compressori e(o)i loro assemblaggi /sotto-assemblaggi
                                    /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchinari per il trattamento dei materiali attraverso un processo
                                    che coinvolge un cambiamento di temperatura e(o)i loro assemblaggi
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di centrifughe, macchinari per filtraggio o purificazione per
                                    liquidi e gas e(o)i loro assemblaggi /sotto-assemblaggi
                                    /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchinari per riempimento, chiusura, sigillatura, etichettatura
                                    bottiglie, imballaggio o avvolgimento e(o)i loro
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchinari per costruzione, movimenti terra, Estrazione e
                                    (o)i loro assemblaggi /sotto-assemblaggi/componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchinari per la realizzazione di ricami e(o)i loro
                                    assemblaggi /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchine utensili per il taglio del metallo coperti sotto l'intestazione 8456 a 8461 e(o)i loro assemblaggi
                                    /sotto-assemblaggi/componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchine utensili per lavorare pietra, ceramiche,
                                    calcestruzzo, cemento amianto o simile vetro minerale e (o)i loro
                                    assemblaggi /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di Macchine inclusi i macchinari per lavori pubblici &
                                    edilizia e i macchinari & apparecchiature meccaniche con
                                    funzioni individuali, non specificate O incluse altrove in
                                    Capitolo 84 e(o)i loro assemblaggi/sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di ingranaggi e trasmissioni, ruote dentate, pignoni a catena,
                                    elementi di trasmissione viti a sfere o rulli, scatole degli ingranaggi e
                                    cambi di velocità, inclusi convertitori di coppia E (o)i loro
                                    assemblaggi /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di macchine elettriche rotanti come Generatore, ecc.
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di Convertitore a Semiconduttori di Potenza e (o)i loro
                                    assemblaggi /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Tutti i tipi di apparecchiature per interruttori e apparecchiature di controllo che operano a
                                    tensioni non superiori a 1000 volt e (o)i loro assemblaggi
                                    /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                ...
                                >
                                    Tutti i tipi di apparecchiature per interruttori e apparecchiature di controllo che operano a
                                    tensioni superiori a 1000 volt e (o) i loro assemblaggi
                                    /sotto-assemblaggi /componenti
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <p className="service-left-content-paragraph">
                ...
                internazionali, assicura che i macchinari e le apparecchiature elettriche
                offerti agli utenti siano sicuri, ecologici e tecnicamente
                solidi.
            </p>
