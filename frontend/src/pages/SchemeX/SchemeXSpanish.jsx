...
const SchemeXServiceFaq = () => {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "El costo de Scheme X incluye tarifas de solicitud, tarifas de certificación, cargos por revisión de archivo técnico, costos de inspección de fábrica y cargos por pruebas de productos. En promedio, comienza en ₹2,000 para la solicitud y puede aumentar dependiendo de la complejidad del producto. Para más detalles, contáctenos en suncertificationsindia@gmail.com.",
    },
    {
      question:
