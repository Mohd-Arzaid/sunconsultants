...
const SchemeXGermanMetaTags = () => {
    ...
    return (
        <Helmet>
            {/* Basic Meta Tags */}
            <title>
                BIS Schema X Zertifizierung | Sicherheit von Maschinen & Elektrischen Geräten
            </title>
            <meta
                name="description"
                ...
                <div className="w-fit font-inter">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbItem>
                                <BreadcrumbPage>Indische BIS-Zertifizierung nach Schema-X
                                </BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
    ...
    return (
        <div id="overview" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                Das Bureau of Indian Standards (BIS) führte am 16. März 2022 das &ldquo;Schema X&rdquo; ein, um die Einhaltung der Produkt sicherheit und -qualität in Indien zu verbessern. Indische und ausländische Hersteller können eine BIS-Zertifizierung für Maschinen und elektrische Geräte, Komponenten wie Baugruppen, Unterbaugruppen und Werkzeuge beantragen, die in Anhang II von Schema X aufgeführt sind, bevor sie nach Indien exportiert, verkauft oder dort vertrieben werden.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Die Zertifizierung fördert nicht nur das Produkt und die Einhaltung der indischen Standards und staatlichen Vorschriften, sondern trägt auch dazu bei, Vertrauen und Zuversicht der Verbraucher in die zertifizierten Produkte aufzubauen.
            </p>
            ...
            <p className="service-left-content-paragraph">
                Produkte mit dem BIS-Standardzeichen, das ein Konformitätszeichen ist, das den Benutzern zertifiziert und versichert, dass das Produkt sicher, zuverlässig und von guter Qualität ist. Es ist auch ein Zeichen für Vertrauen und wirklich gute Leistung.
            </p>
                    ...
                    <TableBody className="bg-white divide-y divide-gray-200">
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                ...
                                >
                                    Alle Arten von Pumpen zur Flüssigkeitshandhabung, Flüssigkeitshebevorrichtungen und
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Kompressoren und(oder) ihre Baugruppen /Unterbaugruppen
                                    /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Maschinen zur Behandlung von Material durch einen Prozess
                                    mit Temperaturänderung und(oder) ihre Baugruppen
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Zentrifugen, Filter- oder Reinigungsmaschinen für
                                    Flüssigkeit und Gas und(oder) ihre Baugruppen /Unterbaugruppen
                                    /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Maschinen zum Füllen, Verschließen, Versiegeln, Etikettieren
                                    von Flaschen, Verpacken oder Umwickeln und(oder) ihre
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Maschinen zur Stickereiherstellung und(oder) ihre
                                    Baugruppen /Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Werkzeugmaschinen zur Bearbeitung von Stein, Keramik,
                                    Beton, Asbestzement oder ähnlichem Mineralglas und (oder) ihre
                                    Baugruppen /Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Maschinen zur Bearbeitung von Gummi und Kunststoff und(oder)
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Maschinen einschließlich der Maschinen für öffentliche Arbeiten &
                                    Bauwesen und die Maschinen & mechanischen Geräte mit
                                    individuellen Funktionen, nicht spezifiziert oder anderweitig in
                                    Kapitel 84 enthalten und(oder) ihre Baugruppen/Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von Zahnrädern und Getrieben, Zahnrädern, Kettenrädern,
                                    Übertragungselementen Kugel- oder Rollschrauben, Getrieben und
                                    Geschwindigkeitswechslern, einschließlich Drehmomentwandlern Und (oder) ihre
                                    Baugruppen /Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                <Link
                                    ...
                                    className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                                >
                                    Alle Arten von rotierenden elektrischen Maschinen wie Generator usw.
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                ...
                                >
                                    ...
                                    Spannungen von nicht mehr als 1000 Volt betrieben werden und (oder) ihre Baugruppen
                                    /Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                ...
                                >
                                    Alle Arten von Schaltanlagen und Steuergeräten, die bei
                                    Spannungen von mehr als 1000 Volt betrieben werden und (oder) ihre Baugruppen
                                    /Unterbaugruppen /Komponenten
                                </Link>
                            </TableCell>
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <p className="service-left-content-paragraph">
                Hersteller müssen die relevanten indischen Standards einhalten, die mit den internationalen Standards übereinstimmen, einschließlich:
            </p>
...
const SchemeXGermanMainContentLeftProcessSection = () => {
    return (
        <div id="process" className="flex flex-col scroll-mt-20">
            ...
            <p className="service-left-content-paragraph">
                <strong>Typische Zeitlinie:</strong> Nahe 90 Arbeitstage (gemäß BIS-Praxis) werden benötigt. Dies setzt voraus, dass keine wesentlichen Nichtkonformitäten vorliegen.
            </p>
...
const SchemeXGermanMainContentLeftDocumentsSection = () => {
    return (
        <div id="documents" className="flex flex-col scroll-mt-20">
            ...
            <h2 className="service-left-content-heading-two">
                Hauptdokumente, die für die BIS Schema X Zertifizierung erforderlich sind
            </h2>
                ...
                <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
                    ...
                    <TableBody className="bg-white divide-y divide-gray-200">
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Vollständiger rechtlicher Name und physische Adressen des Produktionsstandorts
                                und Büros
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                        ...
                        <TableRow className="hover:bg-gray-50">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Namen, Rollen und IDs von Schlüsselverantwortlichen und bevollmächtigten Unterzeichnern
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                            <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Details zu Maschinen und Geräten, die unter das Erste Schedule der Omnibus-Technischen Verordnung fallen
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                            <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Spezifischer Typ, Modell und Sorte, für die eine BIS-Lizenz beantragt wird
                            </TableCell>
                        </TableRow>
                        <TableRow className="hover:bg-gray-50">
                            <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
                            ...
                            <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                                Alle technischen Details zum Produkt und Details
                                über die Produktionseinheit.
                            </TableCell>
                        </TableRow>
                    </TableBody>
                </Table>
    ...
    const faqData = [
        {
            ...
            answer: "Schema X ist ein Konformitätsbewertungssystem, das von der indischen BIS für Maschinen und elektrische Geräte eingeführt wurde. Es gewährleistet die Einhaltung strenger Sicherheits- und technischer Standards, wie in der Omnibus-Technischen Verordnung festgelegt."
        },
        {
            question: "2. Unterscheidet sich Schema X von der ISI-Zeichen-Zertifizierung?",
            answer: "Ja. Das ISI-Zeichen ist im Allgemeinen für Verbrauchsgüter und grundlegende Produktkonformität gedacht, während Schema X für komplexe und industrietaugliche Produkte gilt, die fortgeschrittene Tests und Zertifizierung durch ein BIS-Zertifikat oder eine BIS-Lizenz erfordern."
        },
        {
            question: "3. Wer muss eine Schema X Zertifizierung beantragen?",
            answer: "Hersteller und Importeure von Maschinen und elektrischen Geräten, die gemäß der Omnibus-Technischen Verordnung aufgeführt sind, müssen Schema X beantragen und eine gültige BIS-Zertifizierung erhalten, um ihre Produkte in Indien legal zu verkaufen oder zu vertreiben. Globale Hersteller oder ausländische Hersteller, die beabsichtigen, Produkte in Indien zu verkaufen, müssen ebenfalls diese Vorschriften einhalten."
        },
        {
            question: "4. Wie hoch sind die Kosten für die BIS Schema X Zertifizierung?",
            answer: "Die Kosten für Schema X umfassen Antragsgebühren, Zertifizierungsgebühren, Gebühren für die Überprüfung der technischen Akte, Kosten für Werksinspektionen und Produktprüfgebühren. Im Durchschnitt beginnt es bei ₹2.000 für den Antrag und kann je nach Produktkomplexität steigen. Für weitere Details kontaktieren Sie uns unter admin@bis-certifications.com."
        },
        {
            question: "5. Wie lange dauert es, eine BIS-Lizenz gemäß Schema X zu erhalten?",
            answer: "Die Zeitspanne variiert je nach Dokumentation, Testanforderungen und Werksinspektionen. Typischerweise dauert es 4-6 Wochen ab dem Datum der erfolgreichen BIS-Registrierung und Antragseinreichung für indische Hersteller und 60-90 Tage für ausländische Hersteller."
        },
        {
            question: "6. Können KMU auch eine BIS-Zertifizierung gemäß Schema X beantragen?",
            answer: "Absolut. Tatsächlich ermutigt die indische BIS KMU, eine BIS-Lizenz oder Konformitätserklärung gemäß Schema X zu beantragen, um Qualität, Compliance und Wettbewerbsfähigkeit im Industriesektor zu fördern."
        },
        {
            question: "7. Ist die BIS-Zertifizierung gemäß Schema X für Exporte obligatorisch?",
            answer: "Nein. Produkte, die ausschließlich für den Export hergestellt werden, sind gemäß der Omnibus-Technischen Verordnung ausgenommen. Produkte, die für indische Märkte bestimmt sind, müssen jedoch gemäß Schema X zertifiziert werden."
        },
        {
            question: "8. Was ist die Gültigkeit der BIS-Lizenz gemäß Schema X?",
            answer: "Eine BIS-Lizenz gemäß Schema X ist in der Regel 3-6 Jahre gültig und muss entsprechend erneuert werden. Die Erneuerung beinhaltet die Zahlung der jährlichen BIS-Zertifizierungsgebühr und kann je nach Änderungen im Produktumfang oder den Standards eine Neubewertung erfordern."
        },
        {
            question: "9. Können ausländische Hersteller eine Schema X Zertifizierung beantragen?",
            answer: "Ja, ausländische Hersteller können eine Schema X Zertifizierung über einen autorisierten indischen Vertreter beantragen. Die indische BIS erfordert eine Werksinspektion, die für ausländische Antragsteller 3 Tage dauern kann, zusammen mit Standard-BIS-Registrierungs- und Testverfahren."
        },
        {
            question: "10. Was ist eine technische Akte und warum ist sie erforderlich?",
            answer: "Eine technische Akte ist ein detailliertes Compliance-Dossier, das gemäß Schema X erforderlich ist. Sie umfasst Herstellungsprozesse, Produktdetails, Testberichte und Qualitätskontrolldokumente. Sie unterstützt die Konformität des Produkts mit relevanten indischen Standards während des BIS-Zertifizierungsprozesses."
        },
        {
            question: "11. Wie hängt Schema X mit der Omnibus-Technischen Verordnung zusammen?",
            answer: "Die Omnibus-Technische Verordnung schreibt die Verwendung von Schema X für bestimmte Kategorien von Maschinen und elektrischen Geräten in Indien vor. Produkte, die gemäß der Verordnung aufgeführt sind, müssen gemäß Schema X zertifiziert werden, um ein gültiges BIS-Zertifikat oder eine BIS-Lizenz zu erhalten."
        },
        {
            question: "12. Kann ein BIS-Zertifikat gemäß Schema X widerrufen werden?",
            answer: "Ja. Die indische BIS kann eine BIS-Lizenz oder ein Zertifikat gemäß Schema X aussetzen oder widerrufen, wenn während der Überwachung Nichtkonformität festgestellt wird oder wenn das Produkt die erforderlichen indischen Standards nicht erfüllt."
        },
        {
            question: "13. Was ist der Unterschied zwischen BIS-Lizenz und BIS-Zertifikat gemäß Schema X?",
            answer: "Eine BIS-Lizenz wird typischerweise an indische Hersteller ausgegeben, während eine BIS-Konformitätserklärung (CoC) häufig an ausländische Hersteller oder für bestimmte Fälle ausgegeben wird. Beide dienen demselben Zweck - die Gewährleistung der Produktkonformität gemäß Schema X."
        },
        {
            question: "14. Ist das ISI-Zeichen für Produkte zulässig, die gemäß Schema X zertifiziert sind?",
            answer: "Nein. Produkte gemäß Schema X tragen nicht das ISI-Zeichen. Stattdessen zeigen sie das BIS-Standardzeichen, das für das Zertifizierungssystem relevant ist, wie von der indischen BIS verwaltet."
        },
        {
            question: "15. Wie kann ich feststellen, ob meine Maschine eine Schema X Zertifizierung erfordert?",
            answer: "Überprüfen Sie die offizielle Liste in der Omnibus-Technischen Verordnung oder konsultieren Sie einen BIS-Berater, um zu überprüfen, ob Ihre Maschine unter die obligatorischen Schema X Zertifizierungsanforderungen fällt."
        }
    ];
    ...
    return (
        <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
            <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
                TYP B (Generische Sicherheitsstandards, die sich mit einem Sicherheitsaspekt oder mehr als einer Art von Schutzvorrichtung befassen, die in einer Vielzahl von Maschinen verwendet werden kann)
            </p>
...
const TypeCTableGerman = ({ searchQuery }) => {
    ...
    return (
        <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
            <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
                TYP C (Maschinensicherheitsstandards, die detaillierte Sicherheitsanforderungen für eine bestimmte Maschine oder Maschinengruppe behandeln)
            </p>
