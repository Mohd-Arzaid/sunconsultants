...
const SchemeXFrenchMetaTags = () => {
  ...
  return (
    <Helmet>
      {/* Basic Meta Tags */}
      <title>
        Certification BIS Schéma X | Sécurité des Machines et Équipements
        Électriques
      </title>
      <meta
        name="description"
        ...
        <div className="w-fit font-inter">
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage>
                  Certification BIS Indienne sous le Schéma-X
                </BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
      ...
      <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
        ...
        <div className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
          ...
          <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
            La certification BIS Schéma X couvre les machines, équipements
            électriques, assemblages de composants et sous-assemblages sous le
    ...
    <div className="w-full pb-12">
      <div className="max-w-[88rem] mx-auto px-4 md:px-12">
        ...
        <div className="relative mb-6">
          ...
          <input
            type="text"
            placeholder={"Rechercher par description ou code HS..."}
            value={searchQuery}
...
const productDataTableThird = [
  {
    id: 1,
    description:
      "Tous types de pompes pour la manipulation de liquides, élévateurs de liquides",
  ...
  },
  {
    ...
    title:
      "Exigences de Sécurité des Machines Textiles Partie 1 Exigences Communes",
  },
  {
    id: 10,
  ...
  },
  {
    id: 12,
    description:
      "Tous types de machines pour travailler le caoutchouc et les plastiques",
    hsCode: "8477",
  ...
  return (
    <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
      <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
        TYPE C (Normes de Sécurité des Machines traitant des exigences de
        sécurité détaillées pour une machine particulière ou un groupe de
        machines)
      </p>
...
const TypeBTableFrench = ({ tableRef, searchQuery }) => {
  ...
  return (
    <div className="max-w-[88rem] mx-auto px-4 md:px-12 mt-12">
      <p className="font-geist font-bold text-sm md:text-lg text-[#42434d] tracking-wide text-left max-w-full leading-none mb-6">
        TYPE B (Normes de Sécurité Génériques traitant d&apos;un aspect de
        sécurité ou plus d&apos;un type de protection qui peut être utilisé dans
  ...
  const faqData = [
    {
      ...
      answer:
        "Le Schéma X est un schéma d&apos;évaluation de la conformité introduit par le BIS indien pour les machines et équipements électriques. Il assure la conformité aux normes de sécurité et techniques strictes spécifiées dans le Règlement Technique Omnibus.",
    },
    {
      question:
        "2. Le Schéma X est-il différent de la certification marque ISI ?",
      answer:
        "Oui. La marque ISI est généralement pour les biens de consommation et la conformité de base des produits, tandis que le Schéma X s&apos;applique aux produits complexes et de qualité industrielle qui nécessitent des tests avancés et une certification par un certificat BIS ou une licence BIS.",
    },
    {
      question: "3. Qui doit demander la certification Schéma X ?",
      answer:
        "Les fabricants et importateurs de machines et équipements électriques listés sous le Règlement Technique Omnibus doivent demander le Schéma X et obtenir une certification BIS valide pour vendre ou distribuer légalement leurs produits en Inde. Les fabricants mondiaux ou étrangers ayant l&apos;intention de vendre des produits en Inde doivent également se conformer à ces règlements.",
    },
    {
      question: "4. Quel est le coût de la certification BIS Schéma X ?",
      answer:
        "Le coût du Schéma X inclut les frais de demande, les frais de certification, les frais de révision du dossier technique, les coûts d&apos;inspection d&apos;usine, et les frais de test de produits. En moyenne, cela commence à ₹2,000 pour la demande et peut augmenter selon la complexité du produit. Pour plus de détails, contactez-nous à suncertificationsindia@gmail.com.",
    },
    {
      question:
        "5. Combien de temps faut-il pour obtenir une licence BIS sous le Schéma X ?",
      answer:
        "Le calendrier varie selon la documentation, les exigences de test, et les inspections d&apos;usine. Typiquement, cela prend 4-6 semaines à partir de la date d&apos;enregistrement BIS réussi et de soumission de demande pour les fabricants indiens et 60-90 jours pour les fabricants étrangers.",
    },
    {
      question:
        "6. Les PME peuvent-elles également demander la certification BIS sous le Schéma X ?",
      answer:
        "Absolument. En fait, le BIS indien encourage les PME à demander une licence BIS ou un certificat de conformité sous le Schéma X pour améliorer la qualité, la conformité, et la compétitivité dans le secteur industriel.",
    },
    {
      question:
        "7. La certification BIS sous le Schéma X est-elle obligatoire pour les exportations ?",
      answer:
        "Non. Les produits fabriqués exclusivement pour l&apos;exportation sont exemptés sous le Règlement Technique Omnibus. Cependant, les produits destinés aux marchés indiens doivent être certifiés sous le Schéma X.",
    },
    {
      question:
        "8. Quelle est la validité de la licence BIS sous le Schéma X ?",
      answer:
        "Une licence BIS sous le Schéma X est généralement valide pour 3-6 ans et doit être renouvelée en conséquence. Le renouvellement implique le paiement des frais de certification BIS annuels et peut nécessiter une réévaluation selon les changements dans la portée du produit ou les normes.",
    },
    {
      question:
        "9. Les fabricants étrangers peuvent-ils demander la certification Schéma X ?",
      answer:
        "Oui, les fabricants étrangers peuvent demander la certification Schéma X par l&apos;intermédiaire d&apos;un représentant indien autorisé. Le BIS indien nécessite une inspection d&apos;usine, qui peut prendre 3 jours pour les demandeurs étrangers, ainsi que les processus d&apos;enregistrement BIS standard et de test.",
    },
    {
      question:
        "10. Qu&apos;est-ce qu&apos;un Dossier Technique et pourquoi est-il requis ?",
      answer:
        "Un Dossier Technique est un dossier de conformité détaillé requis sous le Schéma X. Il inclut les processus de fabrication, les détails du produit, les rapports de test, et les documents de contrôle qualité. Il soutient la conformité du produit aux Normes Indiennes pertinentes pendant le processus de certification BIS.",
    },
    {
      question:
        "11. Comment le Schéma X est-il lié au Règlement Technique Omnibus ?",
      answer:
        "Le Règlement Technique Omnibus mandate l&apos;utilisation du Schéma X pour des catégories spécifiques de machines et équipements électriques en Inde. Les produits listés sous le règlement doivent être certifiés sous le Schéma X pour obtenir un certificat BIS valide ou une licence BIS.",
    },
    {
      question: "12. Un certificat BIS sous le Schéma X peut-il être révoqué ?",
      answer:
        "Oui. Le BIS indien peut suspendre ou annuler une licence BIS ou un certificat sous le Schéma X si une non-conformité est trouvée pendant la surveillance ou si le produit ne répond pas aux Normes Indiennes requises.",
    },
    {
      question:
        "13. Quelle est la différence entre une licence BIS et un certificat BIS sous le Schéma X ?",
      answer:
        "Une licence BIS est typiquement délivrée aux fabricants indiens, tandis qu&apos;un certificat de conformité BIS (CoC) est souvent délivré aux fabricants étrangers ou pour des cas spécifiques. Les deux servent le même but—assurer la conformité du produit sous le Schéma X.",
    },
    {
      question:
        "14. La marque ISI est-elle autorisée pour les produits certifiés sous le Schéma X ?",
      answer:
        "Non. Les produits sous le Schéma X ne portent pas la marque ISI. Au lieu de cela, ils affichent la marque standard BIS pertinente au schéma de certification, tel que gouverné par le BIS indien.",
    },
    {
      question:
        "Comment savoir si ma machine nécessite la certification Schéma X ?",
      answer:
        "Vérifiez la liste officielle dans le Règlement Technique Omnibus ou consultez un consultant BIS pour vérifier si votre machine tombe sous les exigences de certification Schéma X obligatoires.",
    },
  ];
  ...
  return (
    <div id="conclusion" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        ...
        la fiabilité et la qualité des appareillages de commutation basse
        tension et des équipements de commande, des machines et équipements
        électriques. Pour les fabricants d&apos;outils de machine applicables au
        traitement de la pierre, de la céramique, du béton, du ciment
        asphaltique et du verre minéral, la certification BIS Schéma-X est
        obligatoire.
      </p>

      <p className="service-left-content-paragraph">
        En remplissant ces obligations, les fabricants garantissent la
        conformité des produits, améliorent la confiance des consommateurs,
        ainsi que leur crédibilité sur le marché. Le Schéma-X assure que la
        production soit aussi fluide que possible, que les normes de sécurité
        dans le monde soient respectées, et que les marques reconnues gagnent
...
const SchemeXFrenchMainContentLeftDocumentsSection = () => {
  return (
    <div id="documents" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        Pour rationaliser le processus de certification BIS, les fabricants sont
        tenus de rassembler et soumettre les documents suivants pendant la phase
        d&apos;enregistrement :
      </p>
        ...
        <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
          ...
          <TableBody className="bg-white divide-y divide-gray-200">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                Numéro de compte permanent (PAN) et détails
                d&apos;enregistrement GST
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
              <TableCell className="px-6 py-4 whitespace-nowrap text-sm md:text-base font-geist text-[#42434d]">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                Adresse e-mail, numéro de mobile et ligne fixe pour les
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                Noms, rôles et identifiants des cadres clés et du signataire
                autorisé
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                Type spécifique, modèle et variété pour lesquels la licence BIS
                est demandée
              </TableCell>
            </TableRow>
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                Tous les détails techniques liés au produit et les détails sur
...
const SchemeXFrenchMainContentLeftProcessSection = () => {
  return (
    <div id="process" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        La délivrance du Certificat BIS sous le Schéma-X est une activité
        systématique destinée à s&apos;assurer que le fabricant a rempli les
        normes de sécurité, qualité et conformité applicables. Le processus est
        le suivant :
      </p>
      ...
      <p className="service-left-content-paragraph">
        Ce dossier sert de preuve technique et statistique de la revendication
        du produit justifiant les normes de traçabilité de sécurité.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        que les systèmes d&apos;assurance qualité de soutien, Observer les tests
        du produit, Déterminer la non-conformité (le cas échéant) et donner des
        étapes correctives. Un rapport détaillé de l&apos;audit est fourni au
        demandeur après la visite.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        l&apos;industrie sur la confiance des consommateurs envers la sécurité
        et la qualité.
      </p>
      ...
      <p className="service-left-content-paragraph">
        <strong>Calendrier Typique :</strong> Près de 90 jours ouvrables (selon
        la pratique BIS) sont nécessaires. Ceci est fourni s&apos;il n&apos;y a
        pas de non-conformités clés.
      </p>
      ...
      <p className="service-left-content-paragraph">
        Contrairement aux fabricants nationaux, les fabricants étrangers
        demandant un certificat BIS sous le Schéma-X sont tenus de se conformer
        à un processus plus strict et des étapes supplémentaires. La procédure
        est élaborée comme suit.
      </p>
      ...
      <p className="service-left-content-paragraph">
        L&apos;audit comprend : Évaluation des systèmes d&apos;assurance qualité
        et des flux de travail dans les processus de fabrication, Évaluation de
        la conformité et de la documentation technique, Sélection
        d&apos;échantillons de test indépendants.
      </p>

      <p className="service-left-content-paragraph">
        L&apos;ensemble du processus prend, basé sur les pratiques de BIS,
        environ 6-7 mois.
      </p>
...
const SchemeXFrenchMainContentLeftOverviewSection = () => {
  ...
  return (
    <div id="overview" className="flex flex-col scroll-mt-20">
      ...
      <p className="service-left-content-paragraph">
        Le Bureau des Normes Indiennes, ou BIS en abrégé, a lancé le
        &ldquo;Schéma X&rdquo; le 16 mars 2022, visant à améliorer la conformité
        sur la sécurité et la qualité des produits en Inde. Les fabricants
        indiens et étrangers peuvent demander la certification BIS pour les
        machines et équipements électriques, les composants comme les
        assemblages, sous-assemblages et, et les outils spécifiés dans
        l&apos;Annexe-II du Schéma-X et obtenir la certification avant
        d&apos;exporter, vendre ou distribuer en Inde.
      </p>

      <p className="service-left-content-paragraph">
        Sous le Schéma X, les fabricants peuvent demander une Licence BIS ou un
        Certificat de Conformité (CoC) pour les appareillages de commutation
        basse tension et les équipements de commande, les machines et
        équipements électriques. Une fois que les fabricants sont certifiés, ils
        sont autorisés à utiliser la marque Standard BIS, indiquant que leurs
        produits sont conformes aux normes établies en Inde.
      </p>

      <p className="service-left-content-paragraph">
        La certification, tout en promouvant le produit et la conformité avec
        les Normes Indiennes et les Règlements Gouvernementaux, aide à
        développer la confiance et la confiance des consommateurs dans les
        produits certifiés.
      </p>
      ...
      <p className="service-left-content-paragraph">
        Le Schéma X est un schéma de certification de produit développé sous les
        Règlements d&apos;Évaluation de la Conformité BIS, 2018 et plus tard,
        simplifié sous les Règlements d&apos;Évaluation de la Conformité BIS
        (Amendement), 2024.
      </p>

      <p className="service-left-content-paragraph">
        L&apos;objectif principal est d&apos;amener les normes de sécurité et de
        qualité indiennes aux normes mondiales, en particulier en ce qui
        concerne les machines industrielles et les équipements électriques. Les
        produits fabriqués en Inde ou importés en Inde sous ce schéma sont
        soumis à un examen rigoureux et à une évaluation pour prouver les normes
        techniques, de sécurité, ainsi que de performance.
      </p>

      <p className="service-left-content-paragraph">
        Les dispositions sous la portée originale de la Certification Schéma X
        ont été révisées et étendues avec le nouvellement émis Ordre de Sécurité
        des Machines et Équipements Électriques (Règlement Technique Omnibus),
        2024, qui est sous la juridiction du Ministère des Industries Lourdes et
        a été mis en vigueur par BIS. L&apos;ordre entre en vigueur le 1er
        septembre 2026, et couvre un large spectre de machines et
        d&apos;équipements électriques tels que les pompes pour la manipulation
        de liquides, les compresseurs, les grues, les machines électriques
        rotatives, les transformateurs, et les appareillages de commutation et
        de commande.
      </p>

      <p className="service-left-content-paragraph">
        Les assemblages, sous-assemblages et composants de telles machines ou
        équipements font également partie de la portée de certification selon la
        Section 16 de la Loi du Bureau des Normes Indiennes, 2016.
      </p>

      <p className="service-left-content-paragraph">
        De plus, sous les Règles CMVR de 1989 (Construction et Fabrication de
        Règlement de Valve), Bowser et autres types d&apos;équipements de
        construction sous la juridiction du Schéma X, sont assurés que le marché
        n&apos;est pas exposé aux équipements qui manquent des exigences de
        sécurité et de normes techniques.
      </p>
      ...
      <p className="service-left-content-paragraph">
        Le Ministère des Industries Lourdes a publié le &ldquo;Règlement
        Technique Omnibus sur les Ordres de Sécurité (Sécurité des Machines et
        Équipements Électriques)&rdquo; via notification E-Gazette du 28 août
        2024. Ce règlement innovant vise à améliorer - la sécurité, la qualité
        et la conformité des machines, équipements électriques et leurs
        assemblages, sous assemblages et composants, sous le Schéma X du
        Règlement BIS, 2016.
      </p>

      <p className="service-left-content-paragraph">
        Sous le RTO, toutes les catégories de machines et d&apos;équipements
        électriques, et toutes leurs pièces et composants sont inclus.
        Cependant, quelques catégories sont spécifiquement exclues :
      </p>
      ...
      <p className="service-left-content-paragraph">
        Ces exceptions sont faites pour faciliter la conformité et éviter la
        duplication inutile de réglementation afin de promouvoir la facilité de
        faire des affaires.
      </p>

      <p className="service-left-content-paragraph">
        Le Règlement Technique Omnibus, 2024 couvre toutes les machines et
        équipements électriques, y compris les appareillages de commutation
        basse tension et les équipements de commande notifiés par le Ministère
        des Industries Lourdes, seront traités sous le cadre du Schéma X de
        Certification BIS. L&apos;Ordre entrera en vigueur le 1er septembre 2026
        afin que les fabricants et importateurs aient assez de temps pour
        modifier leurs opérations selon les Ordres émis.
      </p>
      ...
      <p className="service-left-content-paragraph">
        Selon le RTO 2024, les fabricants, ainsi que les importateurs, de
        machines et équipements électriques qui incluent les pompes, pompes,
        compresseurs, centrifugeuses, grues, transformateurs, et appareillages
        de commutation doivent demander la Certification BIS sous le Schéma X.
      </p>
      ...
      <p className="service-left-content-paragraph">
        Les produits portant la Marque Standard BIS qui est une Marque de
        Conformité qui certifie et assure aux utilisateurs que le produit est
        sûr, fiable, et de bonne qualité. C&apos;est aussi une marque de
      ...
      <p className="service-left-content-paragraph">
        ...
        Entreprises (PME) doivent également se conformer au Schéma X et obtenir
        la Certification BIS pour leurs machines et équipements électriques.
        Bien qu&apos;il puisse sembler que la conformité avec les exigences
        réglementaires puisse être difficile, le certificat Schéma X est un
        ajout de valeur et un avantage pour les PME pour les raisons suivantes :
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        principe de confiance. Le Logo contient :
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        marque n'est disponible qu'après qu'un contrat valide soit en place.
        Seul un contrat valide permet au propriétaire d'utiliser la marque.
        Utiliser la marque sans un contrat valide est une infraction sous la
        constitution indienne et équivaut à avoir une marque légale. Le
        propriétaire de la marque est soumis à de lourdes restrictions pour
        l'utilisation de la licence CM/L-XXXXXXXXXX pour les produits qui n'ont
        pas de certification BIS.
      </p>
      ...
      <p className="service-left-content-paragraph">
        ...
        consommateurs et des hommes d'affaires, favorisant un marché qui met
        l'accent sur la sécurité, l'ouverture et la confiance.
      </p>
      ...
      <h3 className="service-left-content-heading-three">Schéma-I</h3>
      ...
      <h3 className="service-left-content-heading-three">Schéma-X</h3>
      ...
      <p className="service-left-content-paragraph">
        ...
        sécurité et la performance, incluant :
      </p>
          ...
          <TableBody className="bg-white divide-y divide-gray-200">
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  Tous types de pompes pour la manipulation de liquides,
                  élévateurs de liquides et (ou) leurs assemblages /
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de compresseurs et (ou) leurs assemblages /
                  sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines pour le traitement de matériaux par un
                  processus impliquant un changement de température et (ou)
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de centrifugeuses, machines de filtrage ou de
                  purification pour liquides et gaz et (ou) leurs assemblages /
                  sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines pour le remplissage, fermeture,
                  scellage, étiquetage de bouteilles, emballage ou enveloppage
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines pour la construction, terrassement,
                  exploitation minière et (ou) leurs assemblages /
                  sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines à tisser (métiers à tisser) et (ou)
                  leurs assemblages / sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types d'outils de machines de coupe métallique couverts
                  sous les rubriques 8456 à 8461 et (ou) leurs assemblages /
                  sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines-outils pour travailler la pierre, la
                  céramique, le béton, le ciment d'amiante ou le verre minéral
                  similaire et (ou) leurs assemblages / sous-assemblages /
                  composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines pour travailler le caoutchouc et les
                  plastiques et (ou) leurs assemblages / sous-assemblages /
                  composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines incluant les machines pour les travaux
                  publics & la construction et les machines & appareils
                  mécaniques ayant des fonctions individuelles, non spécifiés ou
                  inclus ailleurs dans le Chapitre 84 et (ou) leurs assemblages
                  / sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types d'engrenages et de transmission, roues dentées,
                  pignons de chaîne, éléments de transmission, vis à billes ou à
                  rouleaux, boîtes de vitesses et changeurs de vitesse, incluant
                  les convertisseurs de couple et (ou) leurs assemblages /
                  sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de machines électriques rotatives telles que les
                  générateurs, etc. et (ou) leurs assemblages / sous-assemblages
                  / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types de convertisseurs semiconducteurs de puissance et
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                <Link
                  ...
                  className="text-[#1A8781] hover:text-[#156d68] hover:underline transition-colors duration-200"
                >
                  Tous types d'appareillage et d'équipement de commande
                  fonctionnant à des tensions n'excédant pas 1000 volts et (ou)
                  leurs assemblages / sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
            ...
            <TableRow className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                ...
                >
                  Tous types d'appareillage et d'équipement de commande
                  fonctionnant à des tensions dépassant 1000 volts et (ou) leurs
                  assemblages / sous-assemblages / composants
                </Link>
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
      ...
      <p className="service-left-content-paragraph">
        Plus qu&apos;une simple nécessité légale, la Certification BIS Schéma -
        X offre une promesse de sécurité, qualité et fiabilité. Cette
        Certification, qui implique une adhésion stricte aux normes nationales
        et internationales, assure que les machines et appareils électriques
        offerts aux utilisateurs sont sûrs, respectueux de l&apos;environnement,
        et techniquement solides.
      </p>

      <p className="service-left-content-paragraph">
        Pour certifier sous le Schéma - X, les fabricants doivent se conformer
        aux composants de sécurité majeurs suivants :
      </p>
      ...
      <p className="service-left-content-paragraph">
        Les fabricants sont tenus de se conformer aux Normes Indiennes
        Pertinentes qui sont alignées avec les Normes Internationales, incluant
        :
      </p>

      <h3 className="service-left-content-heading-three">Normes Type A :</h3>
      ...
      <h3 className="service-left-content-heading-three">Normes Type B :</h3>
      ...
      <h3 className="service-left-content-heading-three">Normes Type C :</h3>

      <PointsListWithoutHeading
        points={[
          "Décrites dans la Troisième Annexe de l&apos;Ordre RTO, 2024.",
        ]}
      />
