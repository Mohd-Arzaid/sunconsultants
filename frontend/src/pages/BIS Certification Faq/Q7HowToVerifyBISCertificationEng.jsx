...
const Q7HowToVerifyBISCertificationEng = () => {
  return (
    <div className="relative w-full">
      <Q7HowToVerifyBISCertificationMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <Services />
...
export default Q7HowToVerifyBISCertificationEng;

const Q7HowToVerifyBISCertificationMetaData = () => {
  const title =
    "How to verify BIS Certification? – Clear & Simple Answer Guide";

  const description =
    "Learn about How to verify BIS Certification. This guide explains How to verify BIS Certification, key requirements, steps, and tips to understand BIS Certification";
  ...
  const ogTitle =
    "How to verify BIS Certification | Complete Guide & Easy Explanation";
  ...
  const twitterTitle = "How to verify BIS Certification | Simple Guide";

  const twitterDescription = "Quick guide on How to verify BIS Certification.";
              ...
              <BreadcrumbList className="flex-nowrap">
                ...
                <BreadcrumbItem className="flex-shrink-0">
                  <BreadcrumbPage className="whitespace-nowrap">
                    How to verify BIS Certification?
                  </BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/7-how-to-verify-bis-certification.webp"
          alt="How to verify BIS Certification"
          title="How to verify BIS Certification"
          className="w-full h-auto mb-4 rounded-lg"
        />

        <p className="text-gray-600 text-base font-geist mb-4">
          How to verify bis certification is a frequent question for brands and
