...
const Q26BISAndISODifferenceEng = () => {
  return (
    <div className="relative w-full">
      <Q26BISAndISODifferenceMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q26BISAndISODifferenceEng;

const Q26BISAndISODifferenceMetaData = () => {
  const title = "Difference between BIS and ISO - Clear & Simple Answer Guide";

  const description =
    "What is the difference between BIS and ISO. This guide explains What is the difference between BIS and ISO";

  const keywords =
    "BIS Certification, Import License, BIS Certification in India, BIS license, BIS Mark, Cost of BIS License, BIS Hallmark";

  const canonicalUrl = "https://bis-certifications.com/bis-and-iso-difference";
  ...
  const ogTitle =
    "What is the difference between BIS and ISO | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers difference between BIS and ISO. Understand about BIS License, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle =
    "What is the difference between BIS and ISO | Simple Guide";

  const twitterDescription =
    "Quick guide on What is the difference between BIS and ISO.";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/26-bis-and-iso-difference.webp"
          alt="BIS And ISO Difference"
          title="BIS And ISO Difference"
          className="w-full h-auto mb-4 rounded-lg"
        />

        <p className="text-gray-600 text-base font-geist mb-4">
          BIS and ISO difference is a frequent question for brands and
        ...
        <FaqAuthorEng questionNumber={26} />
      </div>
    </div>
  );
};
