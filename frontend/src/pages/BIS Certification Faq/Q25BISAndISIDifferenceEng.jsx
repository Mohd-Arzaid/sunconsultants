...
const Q25BISAndISIDifferenceEng = () => {
  return (
    <div className="relative w-full">
      <Q25BISAndISIDifferenceMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q25BISAndISIDifferenceEng;

const Q25BISAndISIDifferenceMetaData = () => {
  const title = "Difference between BIS and ISI - Clear & Simple Answer Guide";

  const description =
    "What is the difference between BIS and ISI. This guide explains What is the difference between BIS and ISI";
  ...
  const ogTitle =
    "What is the difference between BIS and ISI | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers difference between BIS and ISI. Understand about BIS License, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle =
    "What is the difference between BIS and ISI | Simple Guide";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/25-bis-and-isi-difference.webp"
          alt="BIS And ISI Difference"
          title="BIS And ISI Difference"
          className="w-full h-auto mb-4 rounded-lg"
        />

        <p className="text-gray-600 text-base font-geist mb-4">
          BIS and ISI difference is a frequent question for brands and
