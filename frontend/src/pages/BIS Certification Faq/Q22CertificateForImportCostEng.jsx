...
const Q22CertificateForImportCostEng = () => {
  return (
    <div className="relative w-full">
      <Q22CertificateForImportCostMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
const Q22CertificateForImportCostMetaData = () => {
  ...
  const canonicalUrl =
    "https://bis-certifications.com/bis-certificate-for-import-cost/";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/22-bis-certificate-for-import-cost.webp"
          alt="BIS Certificate For Import Cost"
          title="BIS Certificate For Import Cost"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          audits/surveillance (for ISI), sample logistics, and optional
          professional support.
        </p>

        <p className="text-gray-600 text-base font-geist mb-4">
          Testing is usually the biggest driver. Fees vary with safety and EMC
          scope, the number of samples, and any re‑tests. Control costs by
          rationalizing variants (use representative models where permitted),
          performing a pre‑compliance gap analysis, and confirming the test plan
          with a BIS‑recognized lab. Finalize labeling early to avoid reprints
          and scrap.
        </p>

        <p className="text-gray-600 text-base font-geist mb-4">
          For ISI, add factory audit/surveillance to your budget; for CRS,
