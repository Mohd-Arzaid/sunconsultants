...
const Q15GetBISCertificateEng = () => {
  return (
    <div className="relative w-full">
      <Q15GetBISCertificateMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q15GetBISCertificateEng;

const Q15GetBISCertificateMetaData = () => {
  const title =
    "How to Get BIS Certificate in India? – Clear & Simple Answer Guide";

  const description =
    "How to Get BIS Certificate in India. This guide explains How to Get BIS Certificate ?";

  const keywords =
    "BIS Certification, Import License, BIS Certification in India, BIS license, BIS Mark";

  const canonicalUrl =
    "https://bis-certifications.com/how-to-get-bis-certificate";
  ...
  const ogTitle =
    "How to Get BIS Certificate? | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers How to Get BIS Certificate in simple steps. Understand about BIS Certificate, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle = "How to Get BIS Certificate | Simple Guide";

  const twitterDescription = "Quick guide on How to Get BIS Certificate.";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/15-how-to-get-bis-certificate.webp"
          alt="How to get BIS Certificate"
          title="How to get BIS Certificate"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Choose a BIS‑recognized laboratory experienced in your category. Align
          on sample quantities, test duration, and the reporting format. While
          testing proceeds, assemble your dossier: business documents, brand
          authorization (if any), labeling artwork with the IS reference,
          and—for foreign manufacturers—an Authorized Indian Representative
          (AIR) nomination.
        </p>
        ...
        <FaqAuthorEng questionNumber={15} />
      </div>
    </div>
  );
};
