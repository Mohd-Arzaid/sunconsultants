...
const Q6ApplyBISCertificationEng = () => {
  return (
    <div className="relative w-full">
      <Q6ApplyBISCertificationMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q6ApplyBISCertificationEng;

const Q6ApplyBISCertificationMetaData = () => {
  const title = "How to apply BIS Certification? – Clear & Simple Answer Guide";

  const description =
    "Learn about How to apply BIS Certification. This guide explains How to apply BIS Certification, key requirements, steps, and tips to understand BIS Certification";
  ...
  const ogTitle =
    "How to apply BIS Certification | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers How to apply BIS Certification in simple steps. Understand about BIS License, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle = "How to apply BIS Certification | Simple Guide";
              ...
              <BreadcrumbList className="flex-nowrap">
                ...
                <BreadcrumbItem className="flex-shrink-0">
                  <BreadcrumbPage className="whitespace-nowrap">
                    How to apply BIS Certification?
                  </BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/6-how-to-apply-bis-certification.webp"
          alt="How to apply BIS Certification "
          title="How to apply BIS Certification"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          the Compulsory Registration Scheme (CRS) used for electronics/IT. Build a
