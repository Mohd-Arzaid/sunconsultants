...
export default Q27BISVsISIEng;

const Q27BISVsISIMetaData = () => {
  const title = "BIS vs ISI - Clear & Simple Answer Guide";

  const description = "BIS vs ISI. This guide explains BIS vs ISI";
  ...
  const ogTitle = "BIS vs ISI | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers BIS vs ISI. Understand about BIS License, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle = "BIS vs ISI | Simple Guide";

  const twitterDescription = "Quick guide on BIS vs ISI.";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/27-bis-vs-isi.webp"
          alt="BIS Vs ISI"
          title="BIS Vs ISI"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Bis vs isi is a frequent question for brands and manufacturers
          ...
          falls under the ISI Scheme (license with surveillance) or the
        ...
        <FaqAuthorEng questionNumber={27} />
      </div>
    </div>
  );
};
