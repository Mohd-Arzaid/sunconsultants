...
const Q21CertificateWhoCanApplyEng = () => {
  return (
    <div className="relative w-full">
      <Q21CertificateWhoCanApplyMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q21CertificateWhoCanApplyEng;

const Q21CertificateWhoCanApplyMetaData = () => {
  const title = "BIS Certificate who can apply? - Clear & Simple Answer Guide";

  const description =
    "BIS Certification who can apply. This guide explains who can apply for BIS Certificate?";
  ...
  const ogTitle =
    "BIS Certificate who can apply? | Complete Guide & Easy Explanation";

  const ogDescription =
    "This guide covers BIS Certificate who can apply in simple steps. Understand about BIS Certificate, what details are required, and how to avoid errors or non-compliance.";

  const twitterTitle = "BIS Certificate who can apply | Simple Guide";

  const twitterDescription = "Quick guide on BIS Certificate who can apply.";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/21-bis-certificate-who-can-apply.webp"
          alt="BIS Certificate Who Can Apply"
          title="BIS Certificate Who Can Apply"
          className="w-full h-auto mb-4 rounded-lg"
        />

        <p className="text-gray-600 text-base font-geist mb-4">
          Bis certificate who can apply is a frequent question for brands and
        ...
        <FaqAuthorEng questionNumber={21} />
      </div>
    </div>
  );
};
