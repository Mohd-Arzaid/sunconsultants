...
const Q16CheckBISCertificateOnlineEng = () => {
  return (
    <div className="relative w-full">
      <Q16CheckBISCertificateOnlineMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q16CheckBISCertificateOnlineEng;
...
const Q16CheckBISCertificateOnlineMetaData = () => {
  ...
  const canonicalUrl =
    "https://bis-certifications.com/how-to-check-bis-certificate-online/";
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/16-how-to-check-bis-certificate-online.webp"
          alt="How to check BIS Certificate Online"
          title="How to check BIS Certificate Online"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          (active/suspended/expired). Match the online data with what's printed
          on the product or packaging: identical model ID, brand, and IS
