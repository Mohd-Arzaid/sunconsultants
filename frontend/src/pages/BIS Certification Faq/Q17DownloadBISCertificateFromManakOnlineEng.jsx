...
const Q17DownloadBISCertificateFromManakonlineEng = () => {
  return (
    <div className="relative w-full">
      <Q17DownloadBISCertificateFromManakonlineMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
...
export default Q17DownloadBISCertificateFromManakonlineEng;
              ...
              <BreadcrumbList className="flex-nowrap">
                ...
                <BreadcrumbItem className="flex-shrink-0">
                  <BreadcrumbPage className="whitespace-nowrap">
                    How to download BIS Certificate from Manakonline?
                  </BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/17-how-to-download-bis-certificate-from-manakonline.webp"
          alt="How to download BIS Certificate from Manakonline"
          title="How to download BIS Certificate from Manakonline"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          from Manakonline is a frequent
