...
const Q1CheckBISCertificationEng = () => {
  return (
    <div className="relative w-full">
      <CheckBISCertificationMetaData />
      <BreadcrumbContent />
      <MainContent />
      <Services />
      <VideoSection />
  ...
  return (
    <div className="flex-1 pt-2 px-2 -mt-2 -mx-2 md:sticky md:top-[128px] md:self-start">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <img
          src="/FAQImages/1-HOW-to-check-bis-certification.webp"
          alt="How To Check BIS Certification"
          title="How To Check BIS Certification"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          Cross‑check packaging/labeling with the database entry: the model
          string, brand, and IS reference should match exactly. For
          electronics/IT, CRS markings include the R‑number; for ISI, look for
          the ISI logo and CM/L number. Be wary of listings where the model or
          brand doesn&apos;t line up.
        </p>

        <p className="text-gray-600 text-base font-geist mb-4">
          When details don&apos;t match, request the vendor&apos;s copy of the
          license/registration and recent test reports for the exact variant.
          For procurement, validate a representative sample from each batch and
          keep screenshots of the verification results in your QA files.
          Re‑check approvals after scope updates or component changes to avoid
          compliance gaps.
        </p>
