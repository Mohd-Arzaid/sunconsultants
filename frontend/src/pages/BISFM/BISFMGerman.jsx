...
import FooterGerman from "@/components/manual/Footer/FooterGerman";
        ...
        <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
          ...
          <div className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
            ...
            <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
              Ausländische Hersteller benötigen das ISI-Mark für Exporte nach Indien. Umfasst
              über 600 obligatorische Produkte und über 20.000 freiwillige Produkte.
            </p>
        ...
        <div className="flex flex-col gap-[20px] md:gap-[40px]">
          <div className="flex flex-col gap-2">
            <h1 className="service-left-content-heading-two">
              Vollständige Informationen zur indischen BIS-Zertifizierung nach dem FMCS-Schema
            </h1>
            ...
            <p className="service-left-content-paragraph">
              Das Bureau of Indian Standards (BIS) ist Indiens nationale Normungsorganisation
              unter dem Ministerium für Verbraucherangelegenheiten, Lebensmittel und öffentliche
              Verteilung. Gegründet unter dem BIS-Gesetz von 1986 und überarbeitet im Jahr
              2016, spielt BIS eine zentrale Rolle bei der Standardisierung, Kennzeichnung und
              Qualitätszertifizierung von Waren. Es zielt darauf ab, die Qualität,
              Sicherheit und Zuverlässigkeit der indischen Verbrauchern angebotenen Produkte zu gewährleisten.
            </p>

            <p className="service-left-content-paragraph">
              BIS arbeitet über verschiedene Schemata, die Produktzertifizierung,
              Stempelung für Schmuck, Prüfdienstleistungen und
              Schulungsprogramme umfassen. Eines seiner international bedeutendsten
              Rahmenwerke ist jedoch das Zertifizierungsschema für ausländische Hersteller
              (FMCS).
            </p>
          </div>
  ...
  const OverviewSection = () => {
    return (
      <div id="overview" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Im Jahr 2000 eingeführt, ist FMCS ein Mechanismus, durch den ausländischen
          Herstellern eine BIS-Lizenz erteilt werden kann, um das ISI-Mark auf ihren
          Produkten zu verwenden, was die Konformität mit indischen Standards anzeigt. Der Zertifizierungsprozess
          FMCS ermöglicht es überseeischen Unternehmen, ihre Produkte legal in
          Indien zu verkaufen, ohne eine lokale Produktionseinheit zu gründen.
        </p>

        <p className="service-left-content-paragraph">
          Derzeit operieren mehr als 1.650 ausländische Hersteller in Indien
          unter dem BIS-Zertifizierungssystem durch FMCS.{" "}
        </p>
        ...
        <p className="service-left-content-paragraph">
          Die Erlangung eines BIS-Zertifikats ist mehr als eine gesetzliche Anforderung—es ist ein
          Tor zum riesigen indischen Verbrauchermarkt. Hier sind einige wichtige Gründe, warum
          es unerlässlich ist:
        </p>
        ...
        <p className="service-left-content-paragraph">
          BIS hat über 600 Produkte unter obligatorischer Zertifizierung aufgelistet, und über
          20.000 Artikel sind für ein freiwilliges BIS-Zertifikat berechtigt. Diese umfassen eine
        ...
        <p className="service-left-content-paragraph">
          Die wachsende Liste zeigt den zunehmenden Umfang und die Relevanz des BIS
          Zertifikats im globalen Handel.
        </p>
  ...
  const StandardizationSection = () => {
    return (
      <div id="standardization" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Das indische BIS ist das Gütezeichen für Qualität und Sicherheit, das vom
          Bureau of Indian Standards (BIS) ausgestellt wird. Heute wird das ISI-Zeichen
          ausschließlich zur Kennzeichnung von Produkten verwendet, die den indischen
          Standards unter dem offiziellen BIS-Zertifizierungsschema entsprechen.
        </p>

        <p className="service-left-content-paragraph">
          Damit ein Produkt das indische BIS- oder ISI-Zeichen tragen kann, muss es ein
          strenges BIS-Zertifizierungsverfahren durchlaufen, einschließlich Labortests,
          Fabrikinspektionen, Dokumentationsprüfungen und Konformitätsprüfungen gemäß
          den indischen BIS-Richtlinien.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Die BIS-Lizenz ist nicht nur ein Marketinginstrument—sie ist eine gesetzliche
          Anforderung für alle Produkte, die unter das obligatorische BIS-Zertifizierungsschema
          fallen.{" "}
        </p>
        ...
        <p className="service-left-content-heading-three">Die Platzierung muss sein:</p>
        ...
        <p className="service-left-content-paragraph">
          Mehr als 600 Produkte erfordern das ISI-Zeichen unter dem obligatorischen
          Registrierungsschema in Indien. Beispiele sind:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Jede Kategorie erfordert die Einhaltung des entsprechenden indischen Standards,
          der während des BIS-Zertifizierungsprozesses getestet wird. Die vollständige
          Liste der Produkte kann durch{" "}
          <span
        ...
        <p className="service-left-content-paragraph">
          Im Gegensatz zu UL (freiwillig) oder CE (regionsspezifisch) ist das ISI-Zeichen
          unter dem BIS-Registrierungsschema sowohl obligatorisch als auch lokal durchgesetzt.
        </p>

        <h2 className="service-left-content-heading-three">
          Ist die BIS-Zertifizierung oder BIS-Lizenz für den Import nach Indien obligatorisch?
        </h2>
        ...
        <p className="service-left-content-paragraph">
          Die indische Regierung hat es für bestimmte Produkte obligatorisch gemacht, vom
          Bureau of Indian Standards (BIS) zertifiziert zu werden, bevor sie in den indischen
          Markt importiert, verkauft oder vertrieben werden können. Diese Verpflichtung
          ergibt sich aus:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Wenn ein Produkt unter die obligatorische Anforderung des indischen BIS fällt, muss
          es ein BIS-Zertifikat haben und das ISI-Zeichen tragen, bevor es die indischen Zollbehörden
          passieren kann.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Egal, ob Sie sich in Indien oder im Ausland befinden, wenn Ihr Produkt auf der
          obligatorischen Liste steht, muss es eine BIS-Lizenz haben und das ISI-Zeichen tragen.
        </p>

        <p className="service-left-content-paragraph">
          Die indischen Zollbehörden verwenden jetzt fortschrittliche Datensysteme, um
          nicht konforme Sendungen automatisch zu kennzeichnen. Alle Waren unter regulierten
          Kategorien werden auf das Vorhandensein eines gültigen BIS-Zertifikats gescannt.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Die BIS-Zertifizierung ist in den meisten Fällen obligatorisch, aber Ausnahmen können
          unter bestimmten Szenarien gewährt werden:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Diese sind jedoch selten und erfordern formelle Ausnahmebriefe vom BIS oder
          verwandten Ministerien.
        </p>

        <h2 className="service-left-content-heading-three">
          Wie können Sie wissen, ob Ihr Produkt ein BIS-Zertifikat oder eine BIS-Lizenz benötigt?
        </h2>
        ...
        <p className="service-left-content-paragraph">
          ...
          Klicken Sie hier, um zu überprüfen, ob Ihr Produkt unter dem obligatorischen indischen
          BIS-Zertifizierungsschema abgedeckt ist.
        </p>
      </div>
    );
  };
  ...
  const RepresentationSection = () => {
    return (
      <div id="representation" className="flex flex-col scroll-mt-20">
        ...
        {/* Title */}
        <h2 className="service-left-content-heading-two">
          Rolle des autorisierten indischen Vertreters (AIR) bei der BIS-Zertifizierung
        </h2>
        ...
        <p className="service-left-content-paragraph">
          Ein autorisierter indischer Vertreter (AIR) ist ein wichtiger Vermittler,
          der von einem ausländischen Hersteller ernannt wird, der eine BIS-Zertifizierung
          unter dem FMCS-Registrierungsschema anstrebt. Der AIR dient als offizieller
          Verbindungsmann zwischen dem Bureau of Indian Standards (BIS) und dem Hersteller
          und gewährleistet reibungslose Kommunikation, Dokumentenbearbeitung und Koordination
        ...
        <p className="service-left-content-paragraph">
          ...
          registrierte Niederlassung in Indien hat, einen AIR ernennen. Diese Anforderung
          stellt sicher, dass das BIS einen zuverlässigen, zugänglichen Ansprechpartner
          innerhalb der indischen Gerichtsbarkeit hat.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Die Rolle des AIR erstreckt sich über den gesamten BIS-Zertifizierungsprozess,
          von der Dokumentation und Antragseinreichung bis zur Auditkoordination und
          der Einhaltung nach der Zertifizierung:
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Unterstützt beim Ausfüllen von Formularen, Zusammenstellen von Dokumenten
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Koordiniert Fabrikinspektionspläne und beantwortet Prüferanfragen
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Stellt sicher, dass alle Test- und Zertifizierungsaktivitäten den BIS-Normen entsprechen
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Überwacht die BIS-Lizenzverlängerung, Dokumentationsaktualisierungen und
                  Gebührenzahlungen
                </TableCell>
              </TableRow>
            </TableBody>
        ...
        <p className="service-left-content-paragraph">
          Der AIR gewährleistet Kontinuität und Verantwortlichkeit während des gesamten
          BIS-Zertifizierungsprozesses. Ohne einen AIR:
        </p>
  ...
  const DocumentSection = () => {
    return (
      <div id="document" className="flex flex-col scroll-mt-20">
        ...
        <h3 className="service-left-content-heading-three">
          Detaillierte Aufschlüsselung jedes für die indische BIS-Zertifizierung erforderlichen Dokuments
        </h3>
        ...
        <p className="service-left-content-paragraph">
          Dieses Dokument enthält allgemeine Details über den ausländischen Hersteller,
          einschließlich:
        </p>
        ...
        <h2 className="service-left-content-heading-three">
          Häufige Dokumentationsfehler, die bei der Beantragung eines BIS-Zertifikats
          oder indischen BIS vermieden werden sollten.
        </h2>
    ...
    return (
      <div id="process" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          Er stellt sicher, dass Produkte den geltenden indischen Standards entsprechen,
          Fertigungsprozesse robust sind und Tests genau sind.
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          Arbeitstage (ca. 3–4 Monate) ab dem Datum der korrekten Antragseinreichung.
          Verzögerungen treten häufig auf, wenn Dokumente unklar sind oder
          die Fabrik nicht auditbereit ist.
        </p>
      </div>
    );
  };
  ...
  const CostingSection = () => {
    return (
      <div id="costing" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Die Erlangung eines BIS-Zertifikats unter dem Foreign Manufacturers Certification
          Scheme (FMCS) umfasst verschiedene Arten von Kosten. Diese decken alles ab,
          von der Antragseinreichung und Prüfungen bis hin zu Produkttests und
          Zeichenverwendung.
        </p>

        <p className="service-left-content-paragraph">
          Ausländische Hersteller müssen angemessen budgetieren, um rechtzeitige Zahlungen
          sicherzustellen, da Zahlungsausfälle zur Ablehnung der BIS-Zertifizierung
          auf halbem Weg führen können.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Wird bei der Einreichung des FMCS-Antragsformulars zur
                  Erlangung des indischen BIS gezahlt
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Deckt BIS-Prüferreisen, Manntagessätze und damit verbundene Ausgaben ab
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Für Tests versiegelter Proben in BIS-anerkannten Labors in Indien
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Einmalige Gebühr, die bei Erteilung des BIS-Zertifikats gezahlt wird
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Jährliche Gebühr für die Verwendung des ISI-Zeichens auf zertifizierten Produkten
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Finanzielle Garantie, die über eine indische Bank hinterlegt wird, um
  ...
  const SurveillanceSection = () => {
    return (
      <div id="surveillance" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Sobald ein BIS-Zertifikat erteilt wurde, endet die Verantwortung nicht dort.
          Die BIS-Zertifizierung umfasst ein kontinuierliches Überwachungs- und Compliance-
          System, um die fortlaufende Einhaltung indischer Standards sicherzustellen. Diese
          Phase nach der Zertifizierung ist entscheidend für die Aufrechterhaltung Ihrer
          BIS-Lizenz, die Beibehaltung des Rechts zur Verwendung des ISI-Zeichens und die
          Vermeidung rechtlicher Sanktionen oder Aussetzungen.
        </p>

        <p className="service-left-content-paragraph">
          Wichtige Überwachungskomponenten nach Erhalt des BIS-Zertifikats Marktüberwachung:
          Zufällige Produktprobenahme vom indischen Markt für unabhängige Labortests. Wenn
          die Probe versagt, wird das BIS-Zertifikat ausgesetzt. Dies wird zweimal pro Jahr
          durchgeführt.
        </p>
      </div>
    );
    ...
    return (
      <div id="facilitator" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          hochtechnisch und zeitkritisch. Während es möglich ist, die Zertifizierung
          unabhängig zu verfolgen, verlassen sich die meisten erfolgreichen ausländischen
          Hersteller auf BIS-Berater, um den Prozess zu optimieren und Risiken zu minimieren.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Bereitet alle erforderlichen Dokumente vor, überprüft und formatiert sie
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Verwaltet die Versiegelung und den Versand von Proben nach Indien
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Steht in Kontakt mit Labors und hilft bei der Interpretation der Ergebnisse
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
        ...
        <p className="service-left-content-paragraph">
          Sie fungieren als Ihr strategischer Partner und übernehmen oft auch die Rolle
          Ihres autorisierten indischen Vertreters (AIR).
        </p>
      </div>
    );
  };
  ...
  export const ServiceFaq = () => {
    const faqs = [
      ...
      {
        question: "Ist die BIS-Zertifizierung für alle Importe nach Indien obligatorisch?",
        answer:
      ...
      {
        question: "Was passiert, wenn das Produkt während der BIS-Labortests versagt?",
        answer:
      ...
      {
        question: "Ist es notwendig, einen BIS-Zertifizierungsberater einzustellen?",
        answer:
      ...
      {
        question: "Welche Dokumente werden für den BIS-Zertifizierungsprozess benötigt?",
        answer:
      ...
      {
        question: "Wie weiß ich, ob mein Produkt eine BIS-Zertifizierung erfordert?",
        answer:
