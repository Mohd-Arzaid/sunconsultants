...
import ServicesRightSideContentVietnamese from "@/components/manual/ServicesRightSideContent/ServicesRightSideContentVietnamese";
        ...
        <div className="flex flex-col gap-[20px] md:gap-[40px]">
          <div className="flex flex-col gap-2">
            ...
            <p className="service-left-content-paragraph">
              ...
              theo Đạo luật BIS năm 1986 và được sửa đổi vào năm 2016, BIS đóng vai
              trò quan trọng trong việc tiêu chuẩn hóa, đánh dấu và chứng nhận chất
              lượng hàng hóa. Nó nhằm đảm bảo chất lượng, an toàn và độ tin cậy của
              các sản phẩm được cung cấp cho người tiêu dùng Ấn Độ.
            </p>

            <p className="service-left-content-paragraph">
              BIS hoạt động thông qua các chương trình khác nhau bao gồm chứng nhận
              sản phẩm, đánh dấu cho đồ trang sức, dịch vụ kiểm tra và chương trình
              đào tạo. Tuy nhiên, một trong những khuôn khổ có ý nghĩa quốc tế nhất
              của nó là Chương trình Chứng nhận Nhà sản xuất Nước ngoài (FMCS).
            </p>
          </div>
  ...
  const OverviewSection = () => {
    return (
      <div id="overview" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Được giới thiệu vào năm 2000, FMCS là một cơ chế mà các nhà sản xuất nước
          ngoài có thể được cấp giấy phép BIS để sử dụng dấu ISI trên sản phẩm của
          họ, cho thấy sự phù hợp với tiêu chuẩn Ấn Độ. Quy trình chứng nhận FMCS
          cho phép các thực thể ở nước ngoài bán hợp pháp sản phẩm của họ tại Ấn Độ
          mà không cần thành lập đơn vị sản xuất địa phương.
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          dẫn đến thị trường tiêu dùng rộng lớn của Ấn Độ. Dưới đây là một số lý do
          chính tại sao nó là cần thiết:
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          mặt hàng đủ điều kiện cho chứng chỉ BIS tự nguyện. Những sản phẩm này bao
    ...
    return (
      <div id="standardization" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          trong quá trình chứng nhận BIS, danh sách đầy đủ các sản phẩm có thể được
          truy cập bằng{" "}
          <span
        ...
        <p className="service-left-content-paragraph">
          Không giống như UL (tự nguyện) hoặc CE (theo khu vực), dấu ISI theo chương
          trình đăng ký BIS vừa bắt buộc vừa được thực thi tại địa phương.
        </p>

        <h2 className="service-left-content-heading-three">
          Chứng nhận BIS hoặc Giấy phép BIS có Bắt buộc cho Nhập khẩu vào Ấn Độ không?
        </h2>
        ...
        <p className="service-left-content-paragraph">
          Chính phủ Ấn Độ đã làm cho việc chứng nhận bởi Cục Tiêu chuẩn Ấn Độ (BIS)
          trở thành bắt buộc đối với một số sản phẩm nhất định trước khi chúng có
          thể được nhập khẩu, bán hoặc phân phối trên thị trường Ấn Độ. Nghĩa vụ này
          xuất phát từ:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Hải quan Ấn Độ hiện sử dụng hệ thống dữ liệu tiên tiến để tự động đánh dấu
          các lô hàng không tuân thủ. Tất cả hàng hóa thuộc các danh mục được quy
          định đều được quét để kiểm tra sự hiện diện của chứng chỉ BIS hợp lệ.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Chứng nhận BIS là bắt buộc trong hầu hết các trường hợp, nhưng có thể được
          miễn trừ trong các tình huống cụ thể:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Tuy nhiên, những trường hợp này rất hiếm và yêu cầu thư miễn trừ chính thức
          từ BIS hoặc các bộ liên quan.
        </p>

        <h2 className="service-left-content-heading-three">
          Làm thế nào để Biết Sản phẩm của Bạn có Cần Chứng chỉ BIS hoặc Giấy phép BIS không?
        </h2>
        ...
        <p className="service-left-content-paragraph">
          ...
          Nhấp vào đây để kiểm tra xem sản phẩm của bạn có được bao gồm trong chương
          trình chứng nhận BIS Ấn Độ bắt buộc không.
        </p>
      </div>
    );
  };
  ...
  const RepresentationSection = () => {
    return (
      <div id="representation" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Theo hướng dẫn BIS, bất kỳ nhà sản xuất nước ngoài nào không có văn phòng
          đăng ký tại Ấn Độ phải bổ nhiệm một AIR. Yêu cầu này đảm bảo rằng BIS có
          một điểm liên hệ đáng tin cậy, có thể tiếp cận trong phạm vi quyền tài
          phán Ấn Độ.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Vai trò của AIR bao trùm toàn bộ quy trình chứng nhận BIS, từ tài liệu và
          nộp đơn đến phối hợp kiểm tra và tuân thủ sau chứng nhận:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Một AIR chủ động và có kinh nghiệm làm tăng đáng kể cơ hội chứng nhận BIS
          thành công.
        </p>
      </div>
    );
  ...
  const DocumentSection = () => {
    return (
      <div id="document" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Tài liệu này cung cấp thông tin chung về nhà sản xuất nước ngoài, bao gồm:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Được phát hành bởi ngân hàng Ấn Độ được RBI phê duyệt, Bảo lãnh Ngân hàng
          Hiệu suất (PBG) bao gồm trách nhiệm trong trường hợp không tuân thủ. Tài
          liệu này phải:
        </p>
        ...
        <div className="service-left-content-heading-three">
          Các lỗi tài liệu phổ biến cần tránh khi đăng ký chứng chỉ BIS hoặc BIS Ấn
          Độ.
        </div>
    ...
    return (
      <div id="process" className="flex flex-col scroll-mt-20">
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Kiểm tra Mẫu Niêm phong tại Phòng thí nghiệm được BIS Phê duyệt ở Ấn Độ
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
        ...
        <p className="service-left-content-paragraph">
          ...
          (khoảng 3–4 tháng) từ ngày nộp đơn đăng ký đúng. Sự chậm trễ thường xảy ra
          khi tài liệu không rõ ràng hoặc nếu nhà máy chưa sẵn sàng cho kiểm tra.
        </p>
      </div>
    );
  };
  ...
  const CostingSection = () => {
    return (
      <div id="costing" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Việc có được chứng chỉ BIS theo Chương trình Chứng nhận Nhà sản xuất Nước
          ngoài (FMCS) liên quan đến nhiều loại chi phí. Những chi phí này bao gồm
          mọi thứ từ nộp đơn đăng ký và kiểm tra đến kiểm tra sản phẩm và sử dụng
          dấu.
        </p>

        <p className="service-left-content-paragraph">
          Nhà sản xuất nước ngoài phải lập ngân sách đầy đủ để đảm bảo thanh toán
          kịp thời, vì việc không thanh toán có thể dẫn đến việc từ chối chứng nhận
          BIS giữa chừng.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Để kiểm tra mẫu niêm phong tại các phòng thí nghiệm được BIS công
                  nhận ở Ấn Độ
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Phí hàng năm cho việc sử dụng dấu ISI trên sản phẩm được chứng nhận
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Đảm bảo tài chính được gửi qua ngân hàng Ấn Độ để đảm bảo tuân thủ
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
  ...
  const SurveillanceSection = () => {
    return (
      <div id="surveillance" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Một khi chứng chỉ BIS được cấp, trách nhiệm không kết thúc ở đó. Chứng nhận
          BIS bao gồm một hệ thống giám sát và tuân thủ liên tục để đảm bảo tuân thủ
          liên tục các tiêu chuẩn Ấn Độ. Giai đoạn sau chứng nhận này rất quan trọng
          để duy trì giấy phép BIS của bạn, giữ quyền sử dụng dấu ISI và tránh các
          hình phạt pháp lý hoặc đình chỉ.
        </p>

        <p className="service-left-content-paragraph">
          Các Thành phần Giám sát Chính sau khi có được chứng chỉ BIS Giám sát Thị
          trường: Lấy mẫu sản phẩm ngẫu nhiên từ thị trường Ấn Độ để kiểm tra phòng
          thí nghiệm độc lập, nếu mẫu thất bại thì chứng chỉ BIS sẽ bị đình chỉ. Nó
          được thực hiện hai lần mỗi năm.
        </p>
      </div>
    );
  };
    ...
    return (
      <div id="facilitator" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          cao và nhạy cảm về thời gian. Mặc dù có thể theo đuổi chứng nhận độc lập,
          hầu hết các nhà sản xuất nước ngoài thành công đều dựa vào các tư vấn viên
          BIS để đơn giản hóa hành trình và giảm thiểu rủi ro.
        </p>
  ...
  export const ServiceFaq = () => {
    const faqs = [
      ...
      {
        question: "Chứng nhận BIS có bắt buộc cho tất cả hàng nhập khẩu vào Ấn Độ không?",
        answer:
      ...
      {
        question: "Điều gì xảy ra nếu sản phẩm thất bại trong quá trình kiểm tra phòng thí nghiệm BIS?",
        answer:
      ...
      {
        question: "Làm thế nào để biết sản phẩm của tôi có cần chứng nhận BIS không?",
        answer:
