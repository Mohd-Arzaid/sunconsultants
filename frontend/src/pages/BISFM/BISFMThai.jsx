...
const FAQSchemaInjector = () => {
  const faqSchema = useMemo(
    () => ({
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "การรับรอง BIS คืออะไร และเหตุใดจึงสำคัญที่ผู้ผลิตต่างชาติต้องได้รับ BIS ของอินเดีย?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "การรับรอง BIS เป็นกระบวนการกำกับดูแลที่ดำเนินการโดยสำนักงานมาตรฐานอินเดียเพื่อให้แน่ใจว่าผลิตภัณฑ์เป็นไปตามมาตรฐานอินเดีย เป็นสิ่งจำเป็นสำหรับผู้ผลิตต่างชาติในการเข้าถึงตลาด การผ่านพิธีศุลกากร และความไว้วางใจของผู้บริโภคในอินเดีย",
          },
        },
        {
          "@type": "Question",
          name: "เครื่องหมาย ISI หมายถึงอะไร?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "เครื่องหมาย ISI บ่งบอกถึงความสอดคล้องกับมาตรฐานอินเดียเฉพาะ เป็นข้อบังคับสำหรับผลิตภัณฑ์ภายใต้การรับรอง BIS และต้องพิมพ์บนบรรจุภัณฑ์และผลิตภัณฑ์",
          },
        },
        {
          "@type": "Question",
          name: "การรับรอง BIS เป็นข้อบังคับสำหรับสินค้านำเข้าทั้งหมดไปยังอินเดียหรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ไม่ การรับรอง BIS เป็นข้อบังคับสำหรับผลิตภัณฑ์ที่ระบุไว้ภายใต้โครงการรับรอง BIS บังคับของอินเดียเท่านั้น อย่างไรก็ตาม การรับรองโดยสมัครใจมีให้สำหรับผลิตภัณฑ์อื่น ๆ",
          },
        },
        {
          "@type": "Question",
          name: "ใครสามารถสมัครขอการรับรอง BIS ภายใต้ FMCS ได้?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "เฉพาะผู้ผลิตต่างชาติที่แท้จริง (ไม่ใช่ผู้นำเข้าหรือผู้ค้า) เท่านั้นที่สามารถสมัครได้ ตัวแทนอินเดียที่ได้รับอนุญาต (AIR) เป็นข้อบังคับในการเป็นตัวแทนของพวกเขาในอินเดีย",
          },
        },
        {
          "@type": "Question",
          name: "ใช้เวลานานเท่าใดในการได้รับใบรับรอง BIS?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "กระบวนการรับรอง BIS ภายใต้ FMCS โดยเฉลี่ยใช้เวลา 120 วัน ขึ้นอยู่กับความพร้อมของเอกสาร การกำหนดการตรวจสอบ และระยะเวลาการทดสอบ",
          },
        },
        {
          "@type": "Question",
          name: "ค่าใช้จ่ายหลักที่เกี่ยวข้องกับการรับรอง BIS มีอะไรบ้าง?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ค่าใช้จ่ายรวมถึงค่าธรรมเนียมการสมัคร ค่าตรวจสอบ ค่าทดสอบในห้องปฏิบัติการ ค่าธรรมเนียมใบอนุญาตและเครื่องหมาย และหนังสือค้ำประกันผลงานจากธนาคาร (PBG) จากธนาคารอินเดียที่ได้รับอนุมัติจาก RBI",
          },
        },
        {
          "@type": "Question",
          name: "ใบอนุญาต BIS สามารถต่ออายุได้หรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ได้ ใบอนุญาต BIS โดยทั่วไปมีอายุ 1-2 ปี และสามารถต่ออายุได้เมื่อปฏิบัติตามข้อกำหนดด้านการปฏิบัติตามกฎระเบียบและการอัปเดตเอกสาร",
          },
        },
        {
          "@type": "Question",
          name: "จะเกิดอะไรขึ้นหากผลิตภัณฑ์ไม่ผ่านการทดสอบในห้องปฏิบัติการ BIS?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "หากผลิตภัณฑ์ไม่ผ่าน BIS อาจอนุญาตให้ดำเนินการแก้ไขและทดสอบซ้ำ การไม่ผ่านอย่างต่อเนื่องอาจส่งผลให้คำขอถูกปฏิเสธ",
          },
        },
        {
          "@type": "Question",
          name: "จำเป็นต้องจ้างที่ปรึกษาการรับรอง BIS หรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ไม่บังคับแต่แนะนำอย่างยิ่ง ที่ปรึกษาช่วยลดความล่าช้า จัดการการปฏิบัติตามกฎระเบียบ และเพิ่มโอกาสในการอนุมัติโดยรับรองว่าสอดคล้องกับโปรโตคอลของ BIS อย่างสมบูรณ์",
          },
        },
        {
          "@type": "Question",
          name: "ใบอนุญาต BIS สามารถถูกระงับหรือยกเลิกได้หรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ได้ BIS อาจระงับหรือยกเลิกใบอนุญาตเนื่องจากการไม่ปฏิบัติตามกฎระเบียบ ผลิตภัณฑ์ไม่ผ่าน การใช้โลโก้ ISI ในทางที่ผิด หรือความคลาดเคลื่อนในการตรวจสอบ",
          },
        },
        {
          "@type": "Question",
          name: "เอกสารใดบ้างที่จำเป็นสำหรับกระบวนการรับรอง BIS?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "เอกสารประกอบด้วยแบบฟอร์มสมัคร FMCS รายงานการทดสอบ รายการอุปกรณ์ ใบรับรองการสอบเทียบ แผนผังโรงงาน จดหมายแต่งตั้ง AIR และหลักฐานการชำระค่าธรรมเนียม",
          },
        },
        {
          "@type": "Question",
          name: "AIR หนึ่งคนสามารถเป็นตัวแทนคำขอ BIS หลายรายการได้หรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ได้ โดยมีเงื่อนไขว่าพวกเขาได้รับอนุญาตสำหรับแต่ละโครงการและมีความสามารถในการจัดการเอกสาร การตรวจสอบ และการสื่อสารสำหรับแต่ละการรับรอง",
          },
        },
        {
          "@type": "Question",
          name: "บทบาทของหนังสือค้ำประกันผลงานจากธนาคารคืออะไร?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "PBG รับรองต่อ BIS ว่าผู้ผลิตจะปฏิบัติตามมาตรฐานอินเดีย สามารถขอคืนได้เมื่อยกเลิกใบอนุญาต และเป็นข้อบังคับสำหรับคำขอ FMCS ทั้งหมดในการขอรับ BIS ของอินเดีย",
          },
        },
        {
          "@type": "Question",
          name: "การรับรอง BIS ได้รับการยอมรับนอกอินเดียหรือไม่?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "แม้ว่าใบรับรอง BIS จะเป็นมาตรฐานอินเดีย แต่ได้รับความเคารพในบริบทการค้าในหลายภูมิภาคที่ยอมรับการปฏิบัติตามกฎระเบียบของอินเดีย โดยเฉพาะในเอเชียและแอฟริกา",
          },
        },
        {
          "@type": "Question",
          name: "ฉันจะรู้ได้อย่างไรว่าผลิตภัณฑ์ของฉันต้องมีการรับรอง BIS?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "ตรวจสอบรายการที่อัปเดตบนเว็บไซต์อย่างเป็นทางการของ BIS หรือปรึกษากับที่ปรึกษา BIS เพื่อยืนยันว่าผลิตภัณฑ์ของคุณอยู่ภายใต้การรับรองบังคับหรือไม่",
          },
        },
      ],
    }),
  ...
  useEffect(() => {
    ...
    script.id = "bisfm-faq-schema-th";
    script.textContent = JSON.stringify(faqSchema);
    document.head.appendChild(script);
    return () => {
      const el = document.getElementById("bisfm-faq-schema-th");
      if (el) el.remove();
    };
  }, [faqSchema]);
