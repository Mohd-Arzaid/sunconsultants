...
import ServiceAuthorDutch from "@/components/manual/ServiceAuthor/ServiceAuthorDutch";
        ...
        <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
          ...
          <div className="relative flex flex-col gap-6 md:gap-8 w-full md:w-[533px] items-start">
            ...
            <p className="font-poppins text-[18px] md:text-[20px] z-[10] leading-[1.6] md:leading-[40px] text-[#332156] max-w-[490px] -mt-2">
              Buitenlandse fabrikanten hebben ISI mark nodig voor export naar India. Dekking van
              600+ verplichte producten en 20.000+ vrijwillige producten.
            </p>
        ...
        <div className="flex flex-col gap-[20px] md:gap-[40px]">
          <div className="flex flex-col gap-2">
            <h1 className="service-left-content-heading-two">
              Volledige informatie over Indiaas BIS certificering onder FMCS Regeling
            </h1>
            ...
            <p className="service-left-content-paragraph">
              Het Bureau of Indian Standards (BIS) is India's nationale normeninstituut
              onder het Ministerie van Consumentenzaken, Voedsel en Openbare
              Distributie. Opgericht onder de BIS Act 1986, en herzien in
              2016, speelt BIS een cruciale rol in standaardisatie, markering en
              kwaliteitscertificering van goederen. Het streeft ernaar de kwaliteit,
              veiligheid en betrouwbaarheid van producten die aan Indiase consumenten worden aangeboden te waarborgen.
            </p>

            <p className="service-left-content-paragraph">
              BIS opereert via verschillende regelingen die productcertificering,
              keurmerken voor sieraden, testdiensten en
              trainingsprogramma's omvatten. Een van de meest internationaal
              significante kaders is echter het Foreign Manufacturers Certification
              Scheme (FMCS).
            </p>
          </div>
  ...
  const OverviewSection = () => {
    return (
      <div id="overview" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Geïntroduceerd in het jaar 2000, is FMCS een mechanisme waarmee buitenlandse
          fabrikanten een BIS licentie kunnen krijgen om het ISI merkteken op hun
          producten te gebruiken, wat overeenstemming met Indiase normen aangeeft. Het certificeringsproces
          FMCS stelt buitenlandse entiteiten in staat om hun producten legaal te verkopen in
          India zonder een lokale productie-eenheid op te richten.
        </p>
        ...
        <p className="service-left-content-paragraph">
          Het verkrijgen van een BIS certificaat is meer dan een wettelijke vereiste—het is een
          toegangspoort tot India's enorme consumentenmarkt. Hier zijn enkele belangrijke redenen waarom
          het essentieel is:
        </p>
        ...
        <p className="service-left-content-paragraph">
          BIS heeft meer dan 600 producten opgenomen onder verplichte certificering, en meer dan
          20.000 items komen in aanmerking voor vrijwillige BIS certificering. Deze omvatten een
        ...
        <h2 className="service-left-content-heading-three">
          Doelstellingen of voordelen van BIS Certificering voor Buitenlandse Fabrikanten
          onder FMCS
        </h2>
        ...
        <h2 className="service-left-content-heading-three">
          Belangrijkste Kenmerken van BIS certificaat voor buitenlandse fabrikanten
        </h2>
  ...
  const StandardizationSection = () => {
    return (
      <div id="standardization" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Het Indiaas BIS is het keurmerk van kwaliteit en veiligheid uitgegeven door het
          Bureau of Indian Standards (BIS). Tegenwoordig wordt het ISI merkteken uitsluitend gebruikt
          om producten aan te duiden die voldoen aan Indiase normen onder
          het officiële BIS certificeringsregime.
        </p>

        <p className="service-left-content-paragraph">
          Om het Indiaas BIS of ISI merkteken te dragen, moet een product een
          rigoureus BIS certificeringsproces doorlopen, inclusief laboratoriumtests, fabrieksinspectie,
          documentatieaudits en nalevingscontroles met Indiase BIS
          richtlijnen.
        </p>
        ...
        <p className="service-left-content-paragraph">
          BIS licentie is niet alleen een marketinginstrument—het is een wettelijke vereiste
          voor alle producten die onder het verplichte BIS certificeringsregime vallen.{" "}
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          die wordt getest tijdens het BIS certificeringsproces, de volledige lijst van
          de producten kan worden bereikt door{" "}
          <span
        ...
        <p className="service-left-content-paragraph">
          Laten we het ISI merkteken vergelijken met andere internationale symbolen:
        </p>
        ...
        <p className="service-left-content-paragraph">
          In tegenstelling tot UL (vrijwillig) of CE (regiospecifiek), is het ISI merkteken onder het
          BIS registratieregime zowel verplicht als lokaal gehandhaafd.
        </p>
        ...
        <p className="service-left-content-paragraph">
          De Indiase regering heeft het verplicht gemaakt voor bepaalde producten om te worden
          gecertificeerd door het Bureau of Indian Standards (BIS) voordat ze kunnen worden
          geïmporteerd, verkocht of gedistribueerd op de Indiase markt. Deze verplichting
          komt voort uit:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Als een product onder de verplichte vereiste van Indiaas BIS valt, moet het
          een BIS certificaat hebben en het ISI merkteken dragen voordat het kan worden
          vrijgegeven bij de Indiase douane.
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          verplichte lijst staat, moet het een BIS licentie hebben en het ISI merkteken dragen.
        </p>

        <p className="service-left-content-paragraph">
          De Indiase douane gebruikt nu geavanceerde datasystemen om niet-conforme
          zendingen automatisch te markeren. Alle goederen onder gereguleerde categorieën worden
          gescand op de aanwezigheid van een geldig BIS certificaat.
        </p>
        ...
        <p className="service-left-content-paragraph">
          BIS certificering is in de meeste gevallen verplicht, maar uitzonderingen kunnen worden
          verleend onder specifieke scenario's:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Deze zijn echter zeldzaam en vereisen formele vrijstellingsbrieven van BIS of
        ...
        <p className="service-left-content-paragraph">
          ...
          Klik hier om te controleren of uw product valt onder het verplichte Indiaas BIS
          certificeringsregime.
        </p>
      </div>
    );
  };
  ...
  const RepresentationSection = () => {
    return (
      <div id="representation" className="flex flex-col scroll-mt-20">
        ...
        {/* Title */}
        <h2 className="service-left-content-heading-two">
          Rol van Geautoriseerde Indiase Vertegenwoordiger (AIR) in BIS Certificering
        </h2>
        ...
        <p className="service-left-content-paragraph">
          Een Geautoriseerde Indiase Vertegenwoordiger (AIR) is een cruciale tussenpersoon
          aangesteld door een buitenlandse fabrikant die BIS certificering zoekt onder het
          FMCS registratieregime. De AIR dient als officiële liaison tussen
          het Bureau of Indian Standards (BIS) en de fabrikant, waardoor
          soepele communicatie, documentafhandeling en coördinatie van het
          certificeringsproces worden gewaarborgd.
        </p>
        ...
        <p className="service-left-content-paragraph">
          ...
          geregistreerd kantoor in India heeft, een AIR aanstellen. Deze vereiste zorgt ervoor
          dat BIS een betrouwbaar, toegankelijk contactpunt heeft binnen de Indiase
          jurisdictie.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Helpt bij het invullen van formulieren, samenstellen van documenten en indienen van
                  de aanvraag
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Zorgt ervoor dat alle test- en certificeringsactiviteiten voldoen aan BIS normen
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Beheert BIS licentieverlenging, documentupdates en
                  betalingen
                </TableCell>
              </TableRow>
            </TableBody>
        ...
        <p className="service-left-content-paragraph">
          De AIR zorgt voor continuïteit en verantwoording gedurende het gehele BIS
          certificeringsproces. Zonder een AIR:
        </p>
        ...
        <p className="service-left-content-paragraph">
          Een proactieve en ervaren AIR verhoogt de kans op
          succesvolle BIS certificering aanzienlijk.
        </p>
      </div>
    );
  };
  ...
  const DocumentSection = () => {
    return (
      <div id="document" className="flex flex-col scroll-mt-20">
        ...
        <h3 className="service-left-content-heading-three">
          Gedetailleerde Uitsplitsing van Elk Document Vereist voor Indiaas BIS Certificering
        </h3>
        ...
        <p className="service-left-content-paragraph">
          Uitgegeven door een RBI-goedgekeurde Indiase bank, dekt de Prestatie Bankgarantie
          (PBG) aansprakelijkheid in geval van niet-naleving. Dit document moet:
        </p>
        ...
        <div className="service-left-content-heading-three">
          Veelvoorkomende documentatiefouten om te vermijden bij het aanvragen van BIS
          certificaat of Indiaas BIS.
        </div>
    ...
    return (
      <div id="process" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          Certification Scheme (FMCS) is methodisch, gestructureerd en meervoudig gefaseerd.
          Het zorgt ervoor dat producten voldoen aan toepasselijke Indiase normen,
          productieprocessen robuust zijn en testen nauwkeurig zijn.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Testen van Verzegelde Monsters in BIS-Goedgekeurde Laboratoria in India
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
        ...
        <p className="service-left-content-paragraph">
          Het BIS certificeringsproces onder FMCS duurt over het algemeen ongeveer 120
          werkdagen (ongeveer 3-4 maanden) vanaf de datum van correcte
          aanvraagindiening. Vertragingen treden vaak op wanneer documenten onduidelijk zijn of
          als de fabriek niet auditklaar is.
        </p>
      </div>
    );
  };
  ...
  const CostingSection = () => {
    return (
      <div id="costing" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Het verkrijgen van een BIS certificaat onder het Foreign Manufacturers Certification
          Scheme (FMCS) omvat verschillende soorten kosten. Deze dekken alles
          van aanvraagindiening en audits tot producttesten en merkteken
          gebruik.
        </p>

        <p className="service-left-content-paragraph">
          Buitenlandse fabrikanten moeten adequaat budgetteren om tijdige betalingen te waarborgen,
          omdat het niet betalen kan leiden tot afwijzing van BIS certificering halverwege.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Dekken BIS auditor reizen, man-dag tarieven en gerelateerde kosten
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Voor testen van verzegelde monsters in BIS-erkende laboratoria in India
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Jaarlijkse kosten voor gebruik van het ISI merkteken op gecertificeerde producten
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Financiële garantie gestort via Indiase bank om
  ...
  const SurveillanceSection = () => {
    return (
      <div id="surveillance" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          Zodra een BIS certificaat is verleend, eindigt de verantwoordelijkheid daar niet.
          De BIS certificering omvat een continu toezicht- en nalevingssysteem
          om continue naleving van Indiase normen te waarborgen. Deze
          post-certificeringsfase is cruciaal voor het behouden van uw BIS licentie,
          het behouden van het recht om het ISI merkteken te gebruiken, en het vermijden van wettelijke boetes of
          schorsingen.
        </p>

        <p className="service-left-content-paragraph">
          Belangrijkste Toezichtscomponenten na het verkrijgen van BIS certificaat Markt
          Toezicht: Willekeurige productmonsters uit de Indiase markt voor
          onafhankelijke laboratoriumtests, als het monster faalt wordt het BIS certificaat
          opgeschort. Dit wordt tweemaal per jaar gedaan.
        </p>
      </div>
    );
  };
    ...
    return (
      <div id="facilitator" className="flex flex-col scroll-mt-20">
        ...
        <p className="service-left-content-paragraph">
          ...
          zeer technisch en tijdgevoelig. Hoewel het mogelijk is om
          certificering onafhankelijk na te streven, vertrouwen de meeste succesvolle buitenlandse fabrikanten op
          BIS consultants om het traject te stroomlijnen en risico's te minimaliseren.
        </p>
          ...
          <Table className="min-w-full border border-gray-200 rounded-lg overflow-hidden">
            ...
            <TableBody>
              ...
              <TableRow className="hover:bg-gray-50 transition-colors">
                ...
                <TableCell className="font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 text-[#42434d]">
                  Onderhoudt contact met laboratoria en helpt resultaten interpreteren
                </TableCell>
              </TableRow>
              <TableRow className="hover:bg-gray-50 transition-colors">
                <TableCell className="font-medium font-geist text-sm md:text-base px-4 md:px-6 py-3 md:py-4 border-r border-gray-200 text-[#42434d]">
  ...
  export const ServiceFaq = () => {
    const faqs = [
      ...
      {
        question: "Wat zijn de belangrijkste kosten verbonden aan BIS certificering?",
        answer:
      ...
      {
        question: "Wat gebeurt er als het product faalt tijdens BIS laboratoriumtests?",
        answer:
      ...
      {
        question: "Is het noodzakelijk om een BIS certificeringsconsultant in te huren?",
        answer:
      ...
      {
        question: "Welke documenten zijn nodig voor het BIS certificeringsproces?",
        answer:
