...
const WPC_PRODUCTS = [
  ...
  { name: "Wireless Microphone", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2-vL3n0SxN5mgFHwj5HB06cwriB9ZczoJlw&s", slug: "wireless-microphone.php" },
  { name: "RFID Reader", img: "https://cdn.labtag.com/wp-content/uploads/RFD40-TC22-US-use2-V2.jpg", slug: "passport-reader.php" },
  { name: "Wireless Mouse", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRptaV3gRn6cpAYPwdQq24Hab3E7j6ZvjVTSg&s", slug: "wireless-mouse.php" },
  { name: "WiFi Router", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSi15Ah0ff2fGxvvIUt6cGj8b5CkHh5eX1I5A&s", slug: "wifi-router.php" },
  { name: "Wireless Keyboard", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxAqsqO8Rc_M3yBv-Z9uSyz7Godw-ZnVxYwg&s", slug: "wireless-keyboard.php" },
  { name: "Wireless Music Player", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIiR4KFLZeUKVV9rJUlvFEbBVq5toMshZ48A&s", slug: "wireless-music-players.php" },
  { name: "Wireless POS Terminal", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoNB8-JOfrr5NWqS2Hsyj3k3MQisVE1MlOjw&s", slug: "wireless-pos-terminal.php" },
  { name: "Wireless Speaker", img: "https://tiimg.tistatic.com/fp/1/008/295/49-5x19-5x25-5-cm-20-watt-waterproof-wireless-bluetooth-speaker-527.jpg", slug: "bluetooth-speakers.php" },
  { name: "Wireless Terminal", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTidERRAdGR-6LFGCnmtGLpMxhQGNiVExZtwg&s", slug: "wireless-terminals.php" },
  { name: "Wireless Transmitters", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToenlGVN2kdx_aJ04luqDIAR5PEXharMfzsQ&s", slug: "wireless-transmitters.php" },
  { name: "Gigabit Dual Band Wireless Router", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZxgaqTciFRuElnTXO70jOAzkA7j_9kwT0BA&s", slug: "gigabit-dual-band-wireless-router.php" },
  { name: "Bluetooth Speaker", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPOf9NrtIV3gOxLc3HCGZB3IYoshzX7yz0ZQ&s", slug: "bluetooth-speaker.php" },
  { name: "Bluetooth Headphone", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQa-mYGPArBKj1iIJyfbWKWKUsersRGlww_pA&s", slug: "bluetooth-headphone.php" },
  { name: "Bluetooth Earphone", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqMfH2m0xD_CfcCYmuyKj2ocSxNfti2QHgOw&s", slug: "bluetooth-earphone.php" },
  { name: "Tablet", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBAkgv6Vsm9g_1d33afJ-bhvS-lOfiAkupXA&s", slug: "tablet.php" },
  { name: "RFID Reader", img: "https://cdn.labtag.com/wp-content/uploads/RFD40-TC22-US-use2-V2.jpg", slug: "rfid-reader.php" },
  { name: "RFID Antenna", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRtutXLuDSaQfVwMfl377VyZAllTJXNnN0WMQ&s", slug: "rfid-antenna.php" },
  { name: "Wireless Transmitter And Receiver", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJwRvanFq54jUAUtY8osdyj0hb3GarSM5s5w&s", slug: "wireless-transmitter-and-receiver.php" },
  { name: "Smart Meter", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWjsr3Rn7v_DHfNn2lIwIQtPoSXKVo8LNQ4g&s", slug: "smart-meter.php" },
  { name: "Smartwatch", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxhrfPrS8R061Ux0WaxIs-sAKyBQ5vyN4pYA&s", slug: "smartwatch.php" },
  { name: "Digital Lock", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdr1STDwM3c90syWYaI9f2XRcYUUHjiNFYpw&s", slug: "digital-lock.php" },
  { name: "Water Meter", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQgS7PcwECJPSLiBFMRICly40xL0q0fNakDdQ&s", slug: "water-meter.php" },
  { name: "True Wireless Earphones (TWS)", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSjIEawMrxpWjCN_s_q9X2pH21nO5DbaxLMng&s", slug: "true-wireless-earphones.php" },
  { name: "Wireless Barcode Scanner", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsMSSQfVdDMSHBMq2vw3_hOUsi29EoE_FCPg&s", slug: "wireless-barcode-scanner.php" },
  { name: "Wireless Access Point", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQeZ5Ysl3OxR2eloAb8VwOepIBnEVtpV3pY_w&s", slug: "wireless-access-point.php" },
  { name: "LoRaWAN Gateway", img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqeuMgnLPG7MtbJGnNU5-wk2E1D5V1hyn1XQ&s", slug: "lorawan-gateway.php" },
];
