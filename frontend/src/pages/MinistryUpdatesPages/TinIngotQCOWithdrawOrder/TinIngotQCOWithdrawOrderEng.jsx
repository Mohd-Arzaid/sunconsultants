...
const TinIngotQCOWithdrawOrderEng = () => {
  return (
...
export default TinIngotQCOWithdrawOrderEng;

const MetaTags = () => {
  const title =
    "Tin Ingot (Quality Control) Order 2024 Withdrawn: No Mandatory BIS Certificate Required";
  const ogTitle = "Government Cancels Tin Ingot BIS Certification Order 2025";
  const twitterTitle =
    "Government Cancels Tin Ingot BIS Certification Order 2025";
  const metaDescription =
    "The Government of India has withdrawn the Tin Ingot (Quality Control) Order, 2025, removing the BIS certification requirement under IS 26:2024. Know the reasons and industry impact.";
  const ogDescription =
    "India has officially rescinded the Tin Ingot QCO 2024, eliminating the mandatory BIS certification under IS 26:2024. Learn why the order was withdrawn and what this means for manufacturers, importers, and downstream industries.";
  const twitterDescription =
    "India has officially rescinded the Tin Ingot QCO 2024, eliminating the mandatory BIS certification under IS 26:2024. Learn why the order was withdrawn and what this means for manufacturers, importers, and downstream industries.";
  const metaKeywords =
    "Tin Ingot QCO, Tin Ingot BIS certification, IS 26:2024, BIS update, Tin Ingot Industry India";
  const websiteUrl =
    "https://bis-certifications.com/ministry-updates/tin-ingot-qco-withdraw-order";
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <div className="mb-6">
          <img
            src="/ministryUpdatesBlogsImages/TinIngotQCOWithdraw.webp"
            title="Withdraw QCO for Tin Ingot"
            alt="Govt. Withdraw QCO for Tin Ingot under IS 26:2024"
            className="w-full h-auto rounded-lg shadow-md"
          />
        </div>

        <p className="text-gray-600 text-base font-geist mb-4">
          The Government of India has officially withdrawn the &quot;Tin Ingot
          (Quality Control) Order, 2025&quot; even before it came into force.
          Through notification S.O. 5167(E), the Ministry has rescinded the
          earlier order S.O. 1769(E) dated 17th April 2025, which had mandated
          compulsory BIS certification for Tin Ingot under Indian Standard IS
          26:2024.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          tin ingot, this withdrawal brings relief, clarity, and stability.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          The original QCO stated that Tin Ingot could not be manufactured,
          sold, stored, distributed, or imported in India without mandatory BIS
          certification as per IS 26:2024 (Tin Ingot – Specification).
        </p>
        ...
        <ul className="list-disc ml-6 mb-4 space-y-2 text-gray-600 text-base font-geist">
          <li>All manufacturers had to obtain a BIS licence for Tin Ingot.</li>
          <li>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            The government might be reviewing IS 26:2024 or planning a revised
        ...
        <ul className="list-disc ml-6 mb-4 space-y-2 text-gray-600 text-base font-geist">
          <li>BIS certification under IS 26:2024 is no longer mandatory.</li>
          <li>
            Manufacturers can continue regular production without the new
            compliance requirement.
          </li>
          <li>Importers can source Tin Ingot globally without BIS approval.</li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          The withdrawal of the Tin Ingot (Quality Control) Order, 2025 before
          its enforcement date reflects the government&apos;s practical and
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          mandatory BIS licensing for Tin Ingot. However, businesses should
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          If your business deals with Tin Ingot—whether in manufacturing,
      ...
      <div className="mt-8 rounded-xl overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        <iframe
          src="/pdf/sun-certification-tin-ingot-qco.pdf"
