...
const RefinedZincQCOWithdrawOrderEng = () => {
  return (
    <div className="relative w-full">
      <RefinedZincQCOWithdrawOrderMetaTags />
      <RefinedZincQCOWithdrawOrderBreadcrumb />
      <RefinedZincQCOWithdrawOrderMainContent />
      <Services />
      <VideoSection />
      <FooterEng />
    </div>
...
const RefinedZincQCOWithdrawOrderMetaTags = () => {
  const title =
  ...
  const ogImage =
    "https://bis-certifications.com/images/refined-zinc-qco-og.jpg"; // Add this
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image" content={ogImage} /> {/* Add this */}
      {/* Twitter Card Tags */}
      <meta name="twitter:card" content="summary_large_image" />{" "}
      {/* Add this */}
      <meta name="twitter:title" content={ogTitle} />
      <meta name="twitter:description" content={ogDescription} />
      <meta name="twitter:image" content={ogImage} /> {/* Add this */}
      <link rel="canonical" href={canonicalUrl} />
    </Helmet>
  );
};

const RefinedZincQCOWithdrawOrderBreadcrumb = () => {
  return (
...
const RefinedZincQCOWithdrawOrderMainContent = () => {
  return (
    <div className="max-w-[88rem] mx-auto px-4 py-8 md:px-12 md:py-12 pt-[60px] md:pt-[75px]">
      <div className="flex flex-col md:flex-row gap-6 md:gap-[48px] w-full">
        {/* Left Side Content */}
        <RefinedZincQCOWithdrawOrderMainContentLeft />
...
const RefinedZincQCOWithdrawOrderMainContentLeft = () => {
  return (
