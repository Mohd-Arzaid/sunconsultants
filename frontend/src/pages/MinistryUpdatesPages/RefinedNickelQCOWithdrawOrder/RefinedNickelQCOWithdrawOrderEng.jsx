...
const RefinedNickelQCOWithdrawOrderEng = () => {
  return (
...
export default RefinedNickelQCOWithdrawOrderEng;

const MetaTags = () => {
  const title =
    "Refined Nickel (Quality Control) Order 2023 Withdrawn: No Mandatory BIS Certificate Required";
  const ogTitle =
    "Government Cancels Refined Nickel BIS Certification Order 2025";
  const twitterTitle =
    "Government Cancels Refined Nickel BIS Certification Order 2025";
  const metaDescription =
    "The Government of India has withdrawn the Refined Nickel (Quality Control) Order, 2023, removing the BIS certification requirement under IS 2782:2023. Know the reasons and industry impact.";
  const ogDescription =
    "India has officially rescinded the Refined Nickel QCO 2023, eliminating the mandatory BIS certification under IS 2782:2023. Learn why the order was withdrawn and what this means for manufacturers, importers, and downstream industries.";
  const twitterDescription =
    "India has officially rescinded the Refined Nickel QCO 2023, eliminating the mandatory BIS certification under IS 2782:2023. Learn why the order was withdrawn and what this means for manufacturers, importers, and downstream industries.";
  const metaKeywords =
    "Refined Nickel QCO, Refined Nickel BIS certification, IS 2782:2023, BIS update, Nickel Industry India";
  const websiteUrl =
    "https://bis-certifications.com/ministry-updates/refined-nickel-qco-withdraw-order";
              ...
              <BreadcrumbList className="flex-nowrap">
                ...
                <BreadcrumbItem className="flex-shrink-0">
                  <BreadcrumbPage className="whitespace-nowrap">
                    Withdrawn QCO for Refined Nickel IS 2782:2023
                  </BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2  -mt-2 -mx-2 ">
      ...
      <div className="p-6 mb-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        ...
        <div className="mb-6">
          <img
            src="/ministryUpdatesBlogsImages/RefinedNickelQCOWithdraw.webp"
            title="Withdraw QCO for Refined Nickel"
            alt="Govt. Withdraw QCO for Refined Nickel under IS 2782:2023"
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          Nickel (Quality Control) Order, 2025&quot; even before it came into
          force. Through notification S.O. 5168(E), the Ministry has rescinded
          the earlier order S.O. 1766(E) dated 17th April 2025, which had
          mandated compulsory BIS certification for refined nickel under Indian
          Standard IS 2782:2023.
        </p>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          The original QCO stated that Refined nickel could not be manufactured,
          sold, stored, distributed, or imported in India without mandatory BIS
          certification as per IS 2782:2023 (Refined Nickel – Specification).
        </p>
        ...
        <ul className="list-disc ml-6 mb-4 space-y-2 text-gray-600 text-base font-geist">
          <li>
            All manufacturers had to obtain a BIS licence for refined nickel.
          </li>
          <li>
          ...
          <li>
            Only IS 2782:2023–compliant material could legally enter the market.
          </li>
        </ul>
        ...
        <div className="mb-4">
          ...
          <p className="text-gray-600 text-base font-geist mb-4">
            The government might be reviewing IS 2782:2023 or planning a revised
        ...
        <p className="text-gray-600 text-base font-geist mb-3">
          With the withdrawal of the Refined Nickel QCO, the immediate effects
          are:
        </p>

        <ul className="list-disc ml-6 mb-4 space-y-2 text-gray-600 text-base font-geist">
          <li>BIS certification under IS 2782:2023 is no longer mandatory.</li>
          <li>
            Manufacturers can continue regular production without the new
            compliance requirement.
          </li>
          <li>
            Importers can source refined nickel globally without BIS approval.
          </li>
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          The withdrawal of the Refined Nickel (Quality Control) Order, 2025
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          ...
          mandatory BIS licensing for refined nickel. However, businesses should
        ...
        <p className="text-gray-600 text-base font-geist mb-4">
          If your business deals with refined nickel—whether in manufacturing,
      ...
      <div className="mt-8 rounded-xl overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 shadow-[0_1px_5px_-4px_rgba(19,19,22,0.7),0_4px_8px_rgba(32,42,54,0.05)] ring-1 ring-gray-900/[0.075] transition-shadow hover:shadow-[0_1px_7px_-4px_rgba(19,19,22,0.8),0_4px_11px_rgba(32,42,54,0.05)] hover:ring-gray-900/[0.125]">
        <iframe
          src="/pdf/sun-certification-refined-nickel-withdrawal-qco.pdf"
          title="Refined Nickel QCO Withdrawal Order PDF"
