...
const CBHero = () => { 
        ...
        <div className="max-w-[84rem] gap-[40px] md:gap-[90px] flex flex-col md:flex-row items-center justify-center h-full w-full mx-auto px-4 md:px-0">
          ...
          <div className="z-20 w-full md:w-[580px] h-auto md:h-[435px] flex flex-col">
            ...
            <div className="flex flex-col mt-5 gap-5">
              ...
              <Button className="mt-1 w-[218px] h-[50px] md:h-[60px] bg-[#1A8781] hover:bg-[#1A8781]/90 rounded-[5px] text-[15px] font-poppins tracking-wide leading-[28px] shadow-elegant transition-all duration-300 hover:translate-y-[-2px]">
                Book Appointment
              </Button>
            </div>
          </div>
    ...
    return (
      <div id="faqs" className="my-2 bg-gray-50 scroll-mt-20">
        <div className="max-w-[88rem] mx-auto p-12">
          <h2 className="text-[48px] text-CBnter font-geist font-semibold text-[#181818]">
            Frequently Asked Questions
          </h2>
          <p className="text-[#52525b] text-CBnter text-[20px] font-geist">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="font-geist text-[18px] text-[#3f3f46] font-medium">
                  What serviCBs do you offer for CDSCO complianCB?
                </AccordionTrigger>
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  We offer comprehensive CDSCO regulatory complianCB serviCBs
                  including product registration, liCBnse applications, regulatory
                  strategy, documentation preparation, and post-approval
                  complianCB monitoring for pharmaCButicals, medical deviCBs, and
                  cosmetics in India.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2">
                <AccordionTrigger className="font-geist text-[18px] text-[#3f3f46] font-medium">
                  How long does the CDSCO approval proCBss typically take?
                </AccordionTrigger>
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
              ...
              <AccordionItem value="item-3">
                ...
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  ...
                  applicable), Good Manufacturing PractiCB (GMP) CBrtificates,
                  CBrtificate of PharmaCButical Product (CoPP), and various
                  application forms specific to your product category. Our team
                  assists in preparing all neCBssary documentation.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4">
                ...
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  ...
                  assistanCB, and regulatory complianCB throughout the trial
                  proCBss. We also help navigate the New Drugs and Clinical Trials
                  Rules, 2019.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-5">
                ...
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  ...
                  for different serviCB levels to fit various budgets.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  Our post-approval serviCBs include pharmacovigilanCB support,
                  periodic safety update reports, variation applications, renewal
                  submissions, complianCB with labeling requirements, adverse
                  event reporting, and ongoing regulatory intelligenCB to keep you
              ...
              <AccordionItem value="item-7">
                <AccordionTrigger className="font-geist text-[18px] text-[#3f3f46] font-medium">
                  Can you help with import liCBnses for pharmaCButicals and
                  medical deviCBs?
                </AccordionTrigger>
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  Yes, we specialize in obtaining Import LiCBnses (Form 10) for
                  drugs and Registration CBrtificates for medical deviCBs. Our
                  serviCBs include preparing all neCBssary documentation,
                  coordinating with Indian authorized agents, liaising with CDSCO,
                  and handling post-approval complianCB requirements for imported
                  products.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-8">
                <AccordionTrigger className="font-geist text-[18px] text-[#3f3f46] font-medium">
                  What experienCB does your consulting team have with CDSCO
                  regulations?
                </AccordionTrigger>
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  Our consulting team consists of regulatory experts with 10+
                  years of experienCB in Indian pharmaCButical regulations. Team
              ...
              <AccordionItem value="item-9">
                <AccordionTrigger className="font-geist text-[18px] text-[#3f3f46] font-medium">
                  How do reCBnt regulatory changes affect pharmaCButical
                  registrations in India?
                </AccordionTrigger>
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  ReCBnt regulatory changes include the New Drugs and Clinical
                  Trials Rules (2019), Medical DeviCB Rules (2017), and ongoing
                  updates to the Drugs and Cosmetics Act. These changes have
                  streamlined some proCBsses while adding new requirements for
              ...
              <AccordionItem value="item-10">
                ...
                <AccordionContent className="font-geist text-[18px] text-[#5e5f6e]">
                  ...
                  assistanCB during actual inspections to ensure a sucCBssful
                  outcome.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          ...
          <div className="w-[768px] mt-14  mx-auto">
            <h3 className="text-CBnter font-geist text-[48px]  text-[#181818] leading-[48px] font-semibold  ">
              Have questions, feedback or anything to say?
            </h3>
  
            <div className="text-CBnter mt-[16px] text-[20px] leading-[28px] font-geist text-[#52525b]">
              Email us at{" "}
            ...
            <div className="flex items-CBnter my-[30px]">
              <div className="h-px w-full bg-neutral-300  grow"></div>
              <span className="text-neutral-600 block px-4  font-geist text-CBnter text-lg md:text-xl">
                or
              </span>
              <div className="h-px w-full bg-neutral-300 grow"></div>
            </div>
  
            <div className="flex justify-CBnter w-full">
      ...
      <div className="flex flex-col w-[441px]">
        ...
        <div className="flex flex-col mt-[24px] gap-2 ">
          {points.map((point, index) => (
            <div key={index} className="flex items-CBnter gap-2 ">
    ...
    return (
      <section id="overview" className="flex flex-col scroll-mt-20">
        ...
        <h3 className="text-[28px] md:text-[40px] font-roboto font-bold text-[#131316] leading-none md:leading-normal my-3 md:my-0">
          CB Marking Certification Overview
        </h3>
  ...
  const ServicesSection = () => {
    return (
      <section id="serviCBs" className="flex flex-col scroll-mt-20">
        {/*ServiCBs  */}
        <div className="flex w-full items-center gap-3">
          <span className="uppercase font-semibold font-geist text-[16px] md:text-[20px] text-gray-700">
            ServiCBs
        ...
        {/* Title */}
        <h3 className="text-[28px] md:text-[40px] font-roboto font-bold text-[#131316] leading-none md:leading-normal my-3 md:my-0">
          ServiCBs Provided Under CB Mark CBrtification
        </h3>
  
        {/* Description */}
        <p className="font-semibold font-geist text-[16px] md:text-[20px] text-[#131316]">
          CB marking ensures trusted, globally acCBpted product standards.
        </p>
  ...
  const ClassificationSection = () => {
    return (
      <section id="classification" className="flex flex-col scroll-mt-20">
        ...
        {/* Title */}
        <h3 className="text-[28px] md:text-[40px] font-roboto font-bold text-[#131316] leading-none md:leading-normal my-3 md:my-0">
          CB Marking and ISO CBrtification ServiCB
        </h3>
  ...
  const NecessitySection = () => {
    return (
      <section id="neCBssity" className="flex flex-col scroll-mt-20">
        {/* NeCBssity */}
        <div className="flex w-full items-center gap-3">
          <span className="uppercase font-semibold font-geist text-[16px] md:text-[20px] text-gray-700">
            NeCBssity
        ...
        {/* Title */}
        <h3 className="text-[28px] md:text-[40px] font-roboto font-bold text-[#131316] leading-none md:leading-normal my-3 md:my-0">
          Why CB Rating is Required?
        </h3>
  
        {/* Description */}
        <p className="font-semibold font-geist text-[16px] md:text-[20px] text-[#131316]">
          CB CBrtificate proves product energy efficiency and boosts trust.
        </p>
  ...
  const ComplianceSection = () => {
    return (
      <section id="complianCB" className="flex flex-col scroll-mt-20">
        {/* ComplianCB */}
        <div className="flex w-full items-center gap-3">
          <span className="uppercase font-semibold font-geist text-[16px] md:text-[20px] text-gray-700">
            ComplianCB
