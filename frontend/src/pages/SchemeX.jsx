  ...
  return (
    <div className="flex-1 overflow-y-auto pt-2 px-2 -mt-2 -mx-2">
      <div className="flex flex-col gap-[20px] md:gap-[40px]">
        {/* Overview Section */}
        <SchemeXOverviewSection />
        {/* Divider */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-500 to-transparent" />

        {/* Process Section */}
        <SchemeXProcessSection />
        {/* Divider */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-500 to-transparent" />

        {/* Documents Section */}
        <SchemeXDocumentsSection />
        {/* Divider */}
        <div className="h-px w-full bg-gradient-to-r from-transparent via-gray-500 to-transparent" />

        {/* Conclusion Section */}
        <SchemeXConclusionSection />
      </div>
    </div>
  );
};
...
const SchemeXOverviewSection = () => {
  ...
  return (
    <section id="overview" className="flex flex-col scroll-mt-20">
      ...
      <h3 className="mt-[16px] md:mt-[20px] font-semibold font-geist text-[14px] md:text-[16px] text-[#131316]">
        Scheme-I
      </h3>
...
const SchemeXConclusionSection = () => {
  return (
  ...
  return (
    <div className="mt-[16px] md:mt-[24px]">
      ...
      <Table className="min-w-full divide-y divide-gray-200 shadow-sm rounded-lg">
        ...
        <TableBody className="bg-white divide-y divide-gray-200">
          {productDataTableSecond.map((row) => (
        ...
        <TableBody className="bg-white divide-y divide-gray-200">
          {productDataTableThird.map((row) => (
            <TableRow key={row.id} className="hover:bg-gray-50">
              ...
              <TableCell className="px-6 py-4 text-xs md:text-sm font-mono text-[#42434d]">
                {row.hsCode}
              </TableCell>
              <TableCell className="px-6 py-4 text-sm md:text-base font-geist text-[#42434d]">
                {row.indianStandard}
