            ...
            <div className="max-w-[88rem] mx-auto px-4 md:px-12 pt-10 md:pt-10 pb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
                    {sitemapSections.map((section, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-lg p-6 shadow-md border border-black/40 hover:shadow-lg transition-shadow duration-200"
                        >
                            <h2 className="text-xl md:text-2xl font-geist font-semibold text-neutral-800 mb-6">
                                {section.title}
                            </h2>
                            <ul className="space-y-3">
                                {section.pages.map((page, pageIndex) => (
                                    <li key={pageIndex}>
                                        <a
                                            href={page.path}
                                            className="text-neutral-600 hover:text-neutral-700 font-geist text-base md:text-lg transition-colors duration-200 flex items-center group"
                                        >
                                            <span className="w-1.5 h-1.5 rounded-full bg-slate-900 mr-3 group-hover:scale-150 transition-transform duration-200"></span>
                                            {page.name}
                                        </a>
                                    </li>
                                ))}
