...
import { productTableData } from "@/data/productTableData/productTableDutch.js";

const BISFMProductTableDutch = () => {
    ...
    <div className="max-w-[88rem] mx-auto px-4 md:px-12 py-6">
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Zoeken op productnaam, IS-nummer, meldingsdetails..."
            value={searchTerm}
        ...
        {searchTerm ? (
          <>
            <span className="text-[#1A8781] font-semibold">
              {totalEntries} resultaat{totalEntries !== 1 ? "en" : ""} gevonden
            </span>
            {totalEntries > 0 && (
              <>
                {" "}
                - Toont {currentStart} tot {currentEnd}
            ...
            {totalEntries === 0 && (
              <span className="ml-2 text-gray-500">
                voor &ldquo;{searchTerm}&rdquo; - probeer andere zoekwoorden
              </span>
            )}
          </>
        ) : (
          <>
            Toont {currentStart} tot {currentEnd} van {totalEntries} items
          </>
        )}
      </div>
          ...
          <TableBody>
            {currentData.length === 0 ? (
              <TableRow>
                ...
                >
                  Geen items gevonden die overeenkomen met uw zoekcriteria.
                </TableCell>
              </TableRow>
            ) : (
                      ...
                      <>
                        ...
                        {item.isDeNotified && (
                          <span className="text-red-600 ml-2">
                            Gedeclareerd van verplichte BIS certificering
                          </span>
                        )}
                      </>
                    )}
...
export default BISFMProductTableDutch;
