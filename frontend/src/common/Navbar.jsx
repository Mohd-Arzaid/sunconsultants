...
<div className="sticky top-0 backdrop-blur-lg border-b-2 border-white/10 shadow-sm">
<nav className=" max-w-[88rem] mx-auto px-8 flex h-20 items-center justify-between">
      ...
      <div className="flex items-center justify-center">
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              <Link to="/">
                <Button variant="link" className="text-base text-black duration-150">
                  Services
                </Button>
              </Link>
            </NavigationMenuItem>
