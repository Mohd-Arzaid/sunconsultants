...
const MULTILANG_PAGE_MAPPINGS = {
  // German translations
  "leitfaden-zur-bis-zertifizierung-fuer-auslaendische-hersteller-indisches-bis": "BIS-Zertifizierung für ausländische Hersteller",
  ...
  "leitfaden-zur-bis-zertifizierung-indisches-bis": "Leitfaden zur BIS-Zertifizierung",
  "indische-bis-zertifizierung-nach-schema-x": "Indische BIS-Zertifizierung nach Schema X",
  
  // Spanish translations
  "guia-certificacion-bis-para-fabricantes-extranjeros-bis-indio": "Certificación BIS para Fabricantes Extranjeros",
  ...
  "certificacion-bis-india-bajo-esquema-x": "Certificación BIS India bajo Esquema X",
  
  // French translations
  "guide-certification-bis-pour-fabricants-etrangers-bis-inde": "Certification BIS pour Fabricants Étrangers",
  "quest-ce-que-le-certificat-bis-indien": "Qu'est-ce que le Certificat BIS",
  "quest-ce-que-le-crs-bis-ou-lenregistrement-crs": "Qu'est-ce que le CRS BIS ou l'Enregistrement CRS",
  "guide-certification-bis-bis-indien": "Guide de Certification BIS",
  "certification-bis-indienne-selon-schema-x": "Certification BIS Indienne selon Schéma X",
  
  // Indonesian translations
  "panduan-sertifikasi-bis-untuk-produsen-asing-bis-india": "Sertifikasi BIS untuk Produsen Asing",
  ...
  "sertifikasi-bis-india-di-bawah-skema-x": "Sertifikasi BIS India di bawah Skema X",
  
  // Italian translations
  "guida-alla-certificazione-bis-per-produttori-stranieri-bis-indiano": "Certificazione BIS per Produttori Stranieri",
  ...
  "certificazione-bis-indiana-secondo-schema-x": "Certificazione BIS Indiana secondo Schema X",
  
  // Japanese translations
  "bis-nintei-gaikoku-seizousha-no-tame-no-gaido-india-no-bis": "外国メーカー向けBIS認定",
  ...
  // Korean translations
  "indo-bis-waeoe-jejo-eopeul-wihan-bis-injeung-gaideu": "외국 제조업체를 위한 BIS 인증",
  ...
  // Dutch translations
  "gids-voor-bis-certificering-voor-buitenlandse-fabrikanten-indiaas-bis": "BIS Certificering voor Buitenlandse Fabrikanten",
  ...
  "indiaas-bis-certificaat-volgens-schema-x": "Indiaans BIS Certificaat volgens Schema X",
  
  // Thai translations
  "khumanam-kanraprong-bis-samrab-puuphlit-thangchat-bis-india": "การรับรองBISสำหรับผู้ผลิตต่างชาติ",
  ...
  "bis-prathiap-india-taem-dai-tae-skema-x": "การรับรองBISอินเดียแต่มได้แต่สกีมาX",
  
  // Vietnamese translations
  "huong-dan-chung-nhan-bis-cho-nha-san-xuat-nuoc-ngoai-bis-an-do": "Chứng nhận BIS cho Nhà sản xuất Nước ngoài",
